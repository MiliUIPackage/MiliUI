...
另有 `hideSated` 勾選（預設開、首領框不給）把 `ns.SATED_DEBUFFS` 七個疲勞 ID
併進同一張 excludeSpellIDs。✅ 七個 ID（57723／57724／80354／95809／160455／264689／390435）
實測 secrecy 全是 0。⚠ 還沒實機驗：勾選後在戰鬥中友方玩家框上疲勞真的消失。
