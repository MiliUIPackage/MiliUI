...
L.NEWS_UPDATE					= "|h|c11ff1111更新說明|r|h: 此更新更改了模組結構，因此經典版和正式版現在使用統一的（相同）模組。這意味著經典版、燃燒的遠征、巫妖王之怒以及浩劫與重生現在分別安裝並使用與正式版相同的插件包。 讀取更多訊息在|Hgarrmission:DBM:news|h|cff3588ff[此處]|r|h"
