...
DBM_CORE_ARROW_SUMMONED				= "箭頭已被啟用。 如果您沒有手動執行此操作，則會為您配置第三方插件以啟用它"
...
DBM_CORE_MOD_AVAILABLE				= "%s在此區域/首領有模組可用。你可以在Curse/WoWI或deadlybossmods.com下載。"
...
DBM_CORE_BONUS_SKIPPED				= "DBM已經自動關閉額外戰利品擲骰框架。如果你需要恢復此框架，在三分鐘內輸入/dbmbonusroll"
DBM_CORE_BONUS_EXPIRED				= "您已嘗試使用/ dbmbonusroll來顯示額外戰利品擲骰視窗，但目前沒有可用的額外戰利品擲骰。"
...
DBM_CORE_INFOFRAME_ALT				= "替代："--Alternate Power
...
DBM_NO_DEBUFF						= "沒有%s"
DBM_ALLY									= "隊友"
DBM_ADD								= "小怪"--A fight Add as in "boss spawned extra adds"
DBM_ADDS							= "小怪"
DBM_CORE_ROOM_EDGE		= "房間邊緣"
DBM_CORE_FAR_AWAY			= "遠離"
DBM_CORE_BREAK_LOS					= "打破LOS"
DBM_CORE_SAFE						= "安全"
DBM_CORE_SHIELD					= "護盾"
DBM_INCOMING						= "%s 來了"
--Common Locals end
