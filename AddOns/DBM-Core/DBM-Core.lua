...
DBM.Revision = parseCurseDate("20260423062843")
...
---@param revision number|string Either a number in the format "202101010000" (year, month, day, hour, minute) or string "20260423004143" to be auto set by packager
