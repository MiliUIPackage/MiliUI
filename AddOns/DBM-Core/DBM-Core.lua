...
_G.DBM = DBM
DBM.Revision = parseCurseDate("20241230031809")
...
---@param revision number|string Either a number in the format "202101010000" (year, month, day, hour, minute) or string "20241230020002" to be auto set by packager
