...
DBM.Revision = parseCurseDate("20260424055251")
...
---@param revision number|string Either a number in the format "202101010000" (year, month, day, hour, minute) or string "20260424043937" to be auto set by packager
