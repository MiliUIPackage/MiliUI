...
DBM = {
	Revision = parseCurseDate("20231020080940"),
}
...
elseif isBCC then
	DBM.DisplayVersion = "2.6.0"--When TBC returns (and it will one day). It'll probably be game version 2.6
