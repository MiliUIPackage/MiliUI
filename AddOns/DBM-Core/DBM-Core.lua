...
_G.DBM = DBM
DBM.Revision = parseCurseDate("20240920081756")
...
---@param revision number|string Either a number in the format "202101010000" (year, month, day, hour, minute) or string "20240920081108" to be auto set by packager
