...
L["Preview"] = "預覽"
L["Preview %d"] = "預覽 %d"
L["Preview frame fixed size"] = "預覽框固定大小"
L["Preview frame UI panel behaviour"] = "預覽框UI面板的特性"
L["Rename set"] = "重新命名套裝"
L["Results"] = "結果"
...
L["Shift-click to add to off hand"] = "按住Shift鍵單擊添加到副手"
...
L["Sort wishlist sets alphabetically"] = "願望清單設定為按字母順序排列"
L["Sorting"] = "排序"
L["Source"] = "來源"
...
L["This will close all your currently open previews."] = "這將關閉您的所有當前打開的預覽。"
...
L["URL"] = "URL"
L["URL website"] = "URL網站"
L["Use a single preview frame"] = "使用單一的預覽框"
L["Use custom model"] = "使用自訂模組"
L["Use preview frame to dress up"] = "使用預覽框來試衣"
