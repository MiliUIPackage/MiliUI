...
TRADE_LIST_SCALE = "視窗大小"
TRADE_LIST_SCALE_DESC = "交易的詳細內容視窗大小"
...
TRADE_LIST_COMPLETE_TOOLTIP = "點一下左鍵查看交易的詳細內容";

TRADE_LIST_CLEAR_CONFIRM = "今天以外的記錄都將被清除!";

TBT_MINIMAP_TOOLTIP1 = "交易記錄"
TBT_MINIMAP_TOOLTIP2 = "點一下顯示交易記錄"
