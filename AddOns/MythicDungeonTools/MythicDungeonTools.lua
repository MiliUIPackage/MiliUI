...
local LDB = LibStub("LibDataBroker-1.1"):NewDataObject("MythicDungeonTools", {
	...
	OnTooltipShow = function(tooltip)
		...
		tooltip:AddLine(mythicColor .."傳奇地城工具|r")
...
function MDT:MakeTopBottomTextures(frame)
	...
	if frame.topPanel == nil then
		...
		frame.topPanelString:SetText("傳奇地城工具")
...
function MDT:MakeSidePanel(frame)
	...
	frame.sidePanelString:SetFont("Fonts\\bLEI00D.ttf", 12)
...
function initFrames()
    ...
    do
        ...
        tooltip.String:SetFont(tooltip.String:GetFont(),12)
	...
	do
        ...
        MDT.pullTooltip.topString:SetFont(MDT.pullTooltip.topString:GetFont(),12)
