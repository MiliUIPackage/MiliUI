...
L["Load Time:"] = "載入時間："
L["seconds."] = "秒。"
L["Click on Summary to see statistics and a saved list of quests on other characters."] = "點一下總結瀏覽統計資料和其他角色所儲存的任務清單。"
L["Ignore Argus"] = "忽略阿古斯"
L["World quets on Argus map will always be shown."] = "總是顯示阿古斯的世界任務。"
L["Small Text Size"] = "文字 - 小"
L["Medium Text Size"] = "文字 - 中"
L["Large Text Size"] = "文字 - 大"
L["Scale - Small"] = "縮放 - 小"
L["Scale - Medium"] = "縮放 - 中"
L["Scale - Big"] = "縮放 - 大"
L["Scale - Very Big"] = "縮放 - 非常大"
L["Small Quest Icons"] = "任務圖示 - 小"
L["Medium Quest Icons"] = "任務圖示 - 中"
L["Large Quest Icons"] = "任務圖示 - 大"
L["Very Large Quest Icons"] = "任務圖示 - 非常大"
L["Only Tracked"] = "只顯示已追蹤的任務"
L["World Quest Tracker"] = "世界任務追蹤"
L["A blue star indicates all party members have this quest as well (if they have world quest tracker installed)."] = "藍色星星表示所有隊伍成員也都有這些任務 (當他們有安裝世界任務追蹤插件時)。"
L["Options are here, show all quests or only those being tracked"] = "選擇要顯示所有任務或只有已追蹤的任務。"
L["Disable Icons on World Map"] = "停用世界地圖上的圖示"
L["Avoid PVP Servers"] = "避免加入 PVP 伺服器"
L["Kick AFKs"] = "踢掉暫離的"
L["Doing world quest "] = "做世界任務："
L[". Group created with World Quest Tracker. #ID"] = "。使用世界任務追蹤插件 World Quest Tracker 快速建立和加入隊伍 @ID"
L["Doing rare encounter against "] = "擊殺稀有怪 - "
L[". Group created with World Quest Tracker #NPCID"] = "。使用由世界任務追蹤插件 World Quest Tracker 快速建立和加入隊伍 #NPCID"
L["Doing Argus World Boss against "] = "擊殺阿古斯世界首領 - "
L[" Group created with World Quest Tracker #NPCID"] = " 。使用由世界任務追蹤插件 World Quest Tracker 快速建立和加入隊伍 #NPCID"
L["Doing Invasion Point boss encounter against "] = "擊殺入侵點首領 - "
L["Volume: 100%"] = "音量: 100%"
L["Volume: 50%"] = "音量: 50%"
L["Volume: 30%"] = "音量: 30%"
L["Hover Over Me: Options Menu"] = "滑鼠指向這裡: 設定選項"
L["Reset Position"] = "重置位置"
L["World quests aren't shown because you're below level 110."] = "沒有顯示世界任務是因為等級尚未達到110。"
L["|cFFFFAA00World Quest Tracker: framework not found, if you just installed or updated the addon, please restart your client.|r"] = "|cFFFFAA00世界任務追蹤|r：無法找到程式框架，如果你是剛安裝好或剛更新完插件，請重新啟動遊戲。|r"
L["|cFFFFAA00World Quest Tracker|r: Reopen your client to finish updating the addon.|r"] = "|cFFFFAA00世界任務追蹤|r：請重新啟動遊戲以完成更新插件。|r"
L["|cFFFFAA00World Quest Tracker|r: libwindow not found, did you just updated the addon? try reopening the client.|r"] = "|cFFFFAA00世界任務追蹤|r：無法找到 libwindow，你是否剛更新完插件? 請試著重新開啟遊戲。|r"
L["Toggle World Quests"] = "切換顯示世界任務"
L["click to kick an AFK player"] = "點一下把暫離的玩家踢掉"
L["nop, you are in queue..."] = "不，你正在等候佇列中..."
L["World Quest Tracker: "] = "世界任務追蹤: "
L["Reputation"] = "聲望"
L["Use this button to toggle quests in the World Map. Faction icons switch to Kul'Tiras, Zandalar or Broken Isles map."] = "使用這個按鈕切換在世界地圖上顯示任務。點一下陣營圖示切換成庫爾提拉斯、贊達拉或破碎海岸地圖。"
L["Tracked quests are shown here!"] = "已追蹤的任務會顯示在這裡!"
L["right click to close this window"] = "點一下右鍵關閉這個視窗"
L["Enter the QuestID: "] = "輸入任務ID: "
L["Quest Name:"] = "任務名稱:"
L["Quest ID:"] = "任務ID:"
L["Group is full."] = "隊伍已滿。"
L["Inviting "] = "邀請 "
L["[World Quest Tracker]: Invite for World Quest '"] = "[世界任務追蹤]: 邀請一起做世界任務 '"
L["Invite for World Quest"] = "邀請一起做世界任務"
L["Invite Nearby Players"] = "邀請附近玩家"
L["Don't Show Popups for the Quest: "] = "這個任務不要顯示彈出視窗: "
L["Quest "] = "任務 "
L[" added to ignore list."] = " 已加入忽略清單。"
L["Ignore Quest"] = "忽略任務"
L["Send Invite Whispers"] = "傳送邀請密語"
L["Don't Show if Already in Group"] = "已有隊伍時不顯示"
L["LeaveGroup"] = "離開隊伍"
L["== Move Me =="] = "== 移動我 =="
L["Lock Window"] = "鎖定視窗"
L["Search for a Group in Group Finder"] = "在隊伍搜尋器中尋找隊伍"
