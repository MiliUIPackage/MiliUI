...
filterFrame.header:SetText('管理過濾器')
...
infoFrame.subText:SetText("在過濾名稱上點擊來將其設置為預設過濾。")
...
function filterFrame:drawFilters()
    ...
    filterFrame.header:SetText('管理過濾器 ('..#EasyScrap.saveData.customFilters..')')
end
...
filterFrame.createNewButton:SetText('建立過濾')
