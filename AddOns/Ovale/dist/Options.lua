...
local OvaleOptionsClass = __class(OvaleOptionsBase, {
    OnInitialize = function(self)
        ...
        AceConfigDialog:AddToBlizOptions(ovale, L["Ovale"])
        AceConfigDialog:AddToBlizOptions(ovale .. " Profiles", L["Profiles"], L["Ovale"])
    ...
    ToggleConfig = function(self)
        ...
        if Ovale.db.profile.standaloneOptions then
            ...
            InterfaceOptionsFrame_OpenToCategory(L["Ovale"])
            InterfaceOptionsFrame_OpenToCategory(L["Ovale"])
        end
    end,
