...
L.TotemsOthers = "1(Others)"
L.TotemsShaman = "4(Shaman)"
...
--L.PluginShortDescription_BURNING_SOUL_SHARD = "Soul shard for destruction"
--L.PluginDescription_BURNING_SOUL_SHARD = "Display bars with current soul shard value for destruction warlock"
