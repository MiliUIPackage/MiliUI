    ...
    unit = {
        player = {
            ...
            raidIcon    = { enable = true, filter = "none" },
                ...
                classSpecAndName = { enable = false, color = "ffffff", wildcard = "%s", filter = "none" },
                ...
                { "levelValue", "factionName", "gender", "raceName", "className", "classSpecAndName", "isPlayer", "role", "moveSpeed", },
                { "mount" },
                { "mplusScore" },
                { "itemLevel" },
                { "achievementPoints" },
