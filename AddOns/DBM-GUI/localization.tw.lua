...
L.Tools_GearCheck					= "裝備檢查"
L.Tools_BreakTimer					= "開始休息計時"
L.Tools_PizzaTimer					= "開始一般計時"
L.Tools_BrezArea					= "戰鬥復活計時"
L.Tools_ShowBrezFrame				= "在首領遭遇戰和傳奇+地下城期間顯示戰鬥復活消耗"
L.Tools_ShowKeystoneOnComplete		= "當一個傳奇鑰石完成時自動顯示鑰石框架"
...
L.RenameSpellButton				= "重新命名"
L.RenameSpellHeader				= "設定%s的自訂名稱"
L.GTFOAbilityTitle					= "GTFO"
L.GTFOAbilityDescription			= "任何你應該要移動遠離可造成傷害的技能"
...
L.Area_CombatAlertsRetail			= "戰鬥提醒選項 (戶外限定)"
...
L.AnnounceConsumables				= "在戰鬥開始時通告消耗品檢查"
L.Area_Invite						= "邀請選項"
...
L.Area_ImportExportSpellRenames	    = "匯入/匯出法術重命名"
L.ImportExportSpellRenamesInfo	    = "匯入將覆蓋您目前的法術重命名，請自行承擔風險。"
L.ButtonImportSpellRenames			= "匯入法術重命名"
L.ButtonExportSpellRenames			= "匯出法術重命名"
L.ExportSpellRenamesFailed			= "無法匯出法術重命名字串。資料可能無效/損壞或格式不受支援。"
L.ImportSpellRenamesFailed			= "無法匯入法術重命名字串。資料可能無效/損壞或格式不受支援。"
L.ImportSpellRenamesWrongType		= "無法匯入法術重命名字串。此匯出類型不是法術重命名。"
L.ImportSpellRenamesUnsupportedVersion	= "無法匯入法術重命名字串。不支援此匯出版本。"
L.SpellRenamesImported				= "法術重命名已匯入。"
...
L.ShortTextSpellname				= "提示文字使用法術重命名"
...
L.ShowSecondCoTank					= "顯示第二個副坦克"--checkbox
L.RIGHT								= "右"
L.LEFT								= "左"
L.UP								= "上"
L.DOWN								= "下"
...
L.CountdownStartTime				= "設定暴雪計時器的倒數開始時間"
L.CountStart						= "剩餘 %d 秒"
...
L.BarBackgroundColor				= "背景顏色"
L.BarBackgroundOpacity				= "背景透明度: %0.2f"
L.EnableBarBorder					= "啟用條邊框"
L.BarBorderSize						= "邊框大小: %0.1f"
L.BarBorderColor					= "邊框顏色"
L.Slider_TextOffSetX				= "文字水平偏移: %d"
L.Slider_TextOffSetY				= "文字垂直偏移: %d"
...
L.SAOne								= "語音包 / 特別警告音效 1"
L.SATwo								= "語音包 / 特別警告音效 2"
L.SAThree							= "語音包 / 特別警告音效 3"
L.SAFour							= "語音包 / 特別警告音效 4"
L.PrivateAuraSoundCombatLockdown	= "私人光環音效無法在戰鬥中變更。"
