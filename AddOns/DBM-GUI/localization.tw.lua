...
L.Button_ResetInfoRange		= "重設訊息/距離框架"
...
L.ShowDefeatMessage 		= "在聊天視窗顯示擊殺/滅團訊息"
L.ShowGuildMessages 		= "在聊天視窗顯示公會的開戰/擊殺/滅團的訊息"
...
L.BarStartColorInterrupt	= "開始顏色(打斷)"
L.BarEndColorInterrupt		= "結束顏色(打斷)"
L.BarStartColorRole			= "開始顏色(角色對應)"
L.BarEndColorRole			= "結束顏色(角色對應)"
...
L.Bar7ForceLarge			= "總是使用大型計時條"
L.Bar7CustomInline			= "使用自訂 '!' 內置圖標"
L.Bar7Footer				= "(Dummy計時條不會即時更新)"

-- Tab: Timers
L.AreaTitle_BarColors		= "根據計時器類型著色"
...
L.BarSort					= "依剩餘時間排序"
L.BarColorByType			= "根據類型著色"
L.BarInlineIcons			= "顯示內置圖標"
L.ShortTimerText			= "使用短計時器文字 (如果可用)"
...
L.SpecialWarnSound			= "設定作用於你或你的行為的特別警告音效"
...
L.SpamBlockNoYells			= "不發送大喊至頻道"
L.SpamBlockNoNoteSync		= "不接受分享的註記"
...
L.BlockVersionUpdateNotice	= "更常顯示「過期」通知在聊天視窗而非彈出提示。"
...
L.FilterInterruptNoteName	= "過濾可中斷技能的警告(包含次數)如果警告的自訂註記中不包含您的名字"
...
L.PT_Threshold				= "不要顯示高於%d秒以上的休息/戰鬥/開戰倒數計時器文字"
...
L.LFDEnhance				= "使用主要或對話聲音頻道播放準備確認音效以及閃爍應用程式圖標給角色確認和戰場/隨機團隊進場(I.E. 即使因為被關閉了也會發出音效而且很大聲!)"
L.WorldBossNearAlert		= "當你需要的世界首領在你附近開戰播放準備確認音效以及閃爍應用程式圖標。"
L.RLReadyCheckSound			= "從主要或對話音效頻道播放準備確認音效以及閃爍應用程式圖標"
L.AFKHealthWarning			= "播放警告聲音以及閃爍應用程式圖標假如你在暫離時被攻擊"
L.AutoReplySound			= "當收到DBM自動回覆的密語時播放警告聲音以及閃爍應用程式圖標"
--
L.TimerGeneral 				= "計時器選項"
L.SKT_Enabled				= "顯示當前戰鬥最快戰勝紀錄計時如果可用"
...
L.LogOnlyRaidBosses			= "只記錄當前資料片團隊首領的戰鬥(除了隨機團隊/隨機隊伍/隨機事件/老內容)"
