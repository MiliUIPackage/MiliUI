...
L.UpscaleDurationText				= "圖示上的上層持續時間文字較大"
...
L.RaidDiffChangedRaidOnly	= "只在團隊中時顯示團隊難度改變警告 (警告：如果尚未轉換為團隊，它不會報告加入難度)"
...
L.DisableBuiltInMusic			= "停用內建事件聲音音樂並只載入第3方音樂包"
...
L.EnableVarianceBar 			= "延長計時器條以顯示技能的最大佇列時間"
...
L.BarIconLeft 					= "圖示在左側"
L.BarIconRight 					= "圖示在右側"
L.BarIconPosition				= "圖示位置"
...
L.BarSkin						= "計時條外觀"
L.InlineIconsDropdown			= "日誌圖示樣式"
L.SingleLargeIcon				= "單個大圖示"
L.DoubleLargeIcons				= "雙個大圖示"
L.DoubleInlineIcons				= "全部都大圖示"
L.StackedMiniIcons				= "堆疊的小圖示"
...
L.Area_Global_Toggles				= "功能全局切換"
L.NoWarnings						= "完全停用DBM通告"
L.NoTimers							= "完全停用DBM計時器"

L.Area_SpamFilter_SpecFeatures		= "通告功能（僅適用於上述未完全禁用的情況）"
