...
L:SetOptionLocalization({
	...
	SetLighting		= "開戰後自動調整打光品質為低，戰鬥結束後恢復設定值。",
	InterruptBehavior	= "為團隊設置中斷行為（需要團隊領隊）",
	Three			= "3人輪流 ",--Default
	Four			= "4人輪流 ",
	Five			= "5人輪流 ",
	IgnoreFirstKick		= "啟用此選項的話，剛接觸的第一次打斷將不算進迴圈（需要團隊領隊）"
})
