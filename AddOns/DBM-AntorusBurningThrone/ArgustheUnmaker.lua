...
local yellSargRage					= mod:NewShortYell(257869, L.Fury)
local specWarnSargFear				= mod:NewSpecialWarningMoveTo(257931, nil, nil, nil, 3, 2)
local yellSargFear					= mod:NewShortYell(257931, L.Fear)
local yellSargFearCombo				= mod:NewComboYell(257931, L.Combo)
