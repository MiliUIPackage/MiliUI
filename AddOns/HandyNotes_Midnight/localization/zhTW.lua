...
L['void_shielded_tomb_note'] = '飲用旁邊桌子上的 {object:解離藥水}，然後跑到對面的建築，拾取 {item:251519} 後用它解鎖寶箱。\n\n' .. ns.color.Red('需要90級')
...
L['exaliburn_note'] = '飲用旁邊的 {object:毋庸置疑的強力藥水} 後拔出劍。'
L['voidhoarders_corpse'] = '虛無囤積者的屍體'
L['blackcore_note'] = '擊殺標記範圍內的 {npc:248462} 或 {npc:248483} 獲得3個 {item:248680}，然後和 {object:奇點棱鏡} 互動召喚稀有。'
...
L['gulf_of_memory_chest_note'] = '沿著樹根往上走就可以到達寶藏。'
