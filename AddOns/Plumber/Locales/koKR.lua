...
--Tooltip RichSoil
L["ModuleName TooltipRichSoil"] = "빠른 슬롯: 회복력 있는 씨앗";
...
L["LootUI Option Hide Window Tooltip"] = "Plumber 전리품 알림창을 숨깁니다. 창을 숨겨도 백그라운드에서 강제 자동 획득과 같은 기능은 계속 작동합니다.";
...
L["LootUI Option Show Reputation Tooltip"] = "전리품 창에 평판 획득 정보를 표시합니다.\n\n전투 중이나 PvP 인스턴스에서 획득한 평판은 전투 종료 후 한꺼번에 표시됩니다.";
...
L["BreakTime Cancel Button Tooltip Format 1"] = "좌클릭: 이번 주기의 타이머를 취소합니다. 다음 타이머는 %d분 후에 작동합니다.";
