...
constants.defaults = {
    profile = {
        icon_scale_auctioneer = 1.5,
        icon_alpha_auctioneer = 1,
        icon_scale_banker = 1.5,
        icon_alpha_banker = 1,
        icon_scale_barber = 1.5,
        icon_alpha_barber = 1,
        icon_scale_craftingorders = 1.5,
        icon_alpha_craftingorders = 1,
        icon_scale_flightmaster = 1.5,
        icon_alpha_flightmaster = 1,
        icon_scale_guildvault = 1.5,
        icon_alpha_guildvault = 1,
        icon_scale_innkeeper = 1.5,
        icon_alpha_innkeeper = 1,
        icon_scale_mail = 1.5,
        icon_alpha_mail = 1,
        icon_scale_portal = 1.6,
        icon_alpha_portal = 1,
        icon_scale_portaltrainer = 1.5,
        icon_alpha_portaltrainer = 1,
        icon_scale_reforge = 1.5,
        icon_alpha_reforge = 1,
        icon_scale_rostrum = 1.5,
        icon_alpha_rostrum = 1,
        icon_scale_stablemaster = 1.5,
        icon_alpha_stablemaster = 1,
        icon_scale_tpplatform = 1.6,
        icon_alpha_tpplatform = 1,
        icon_scale_trainer = 1.5,
        icon_alpha_trainer = 1,
        icon_scale_transmogrifier = 1.5,
        icon_alpha_transmogrifier = 1,
        icon_scale_vendor = 1.5,
        icon_alpha_vendor = 1,
        icon_scale_void = 1.5,
        icon_alpha_void = 1,
