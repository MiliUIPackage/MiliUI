local function skin_AlertFrames()
	...
	local function miirgui_HonorAwardedAlertSystem(self)
		self.Background:ClearAllPoints()
		self.Background:SetPoint("CENTER",self,0,0.5)
		self.Background:SetSize(512,64)
		self.Background:SetTexCoord(0,1,1,0)
	...
	hooksecurefunc(HonorAwardedAlertSystem,"setUpFunction",miirgui_HonorAwardedAlertSystem)
	...
	local function miirgui_InvasionAlertSystem(self)
		local _,_,ScenarioLegionInvasionAlertFrameCompleted = self:GetRegions()
		local background = self:GetRegions()
		...
		background:SetSize(512,64)
		background:SetTexCoord(0,1,1,0)
		m_SetTexture(background,"Interface\\Achievementframe\\miirgui_ach.tga")
	...
	hooksecurefunc(InvasionAlertSystem,"setUpFunction",miirgui_InvasionAlertSystem)
	...
	local function miirgui_StandardRewardAlertFrame_AdjustRewardAnchors(frame)
	...
	hooksecurefunc("StandardRewardAlertFrame_AdjustRewardAnchors",miirgui_StandardRewardAlertFrame_AdjustRewardAnchors)
	...
	local function miirgui_NewPetAlertFrameMixin(self,petID)
		self.Label:ClearAllPoints()
		self.Label:SetPoint("TOP",self,0,-24)
		self.Label:SetJustifyH("CENTER")
		self.Name:ClearAllPoints()
		self.Name:SetPoint("CENTER",self.Label,0,-16)
		self.Name:SetJustifyH("CENTER")
		...
		self.IconBorder:ClearAllPoints()
		self.IconBorder:SetPoint("CENTER",self.Icon,0,0)
		local _, _, _, _, rarity = C_PetJournal.GetPetStats(petID);
		local itemQuality = rarity - 1;
		self.IconBorder:SetVertexColor(GetItemQualityColor(itemQuality))
	end
	
	hooksecurefunc(NewPetAlertFrameMixin,"SetUp",miirgui_NewPetAlertFrameMixin)

	
	
function miirgui_NewMountAlertFrameMixin(self)
		self.Label:ClearAllPoints()
		self.Label:SetPoint("TOP",self,0,-24)
		self.Label:SetJustifyH("CENTER")
		self.Name:ClearAllPoints()
	...
	hooksecurefunc(NewMountAlertFrameMixin,"SetUp",miirgui_NewMountAlertFrameMixin)
...
m_catch:SetScript("OnEvent", skin_AlertFrames)