local function skin_LFDQueueFrame()

	PVPReadyDialogFiligree:Hide()
	PVPReadyDialogBottomArt:Hide()
	PVPReadyDialogBackground:Hide()
	local hideit =  LFGDungeonReadyDialogInstanceInfoFrame:GetRegions()
	hideit:Hide()
	...
	local ScenarioBG = ScenarioQueueFrame:GetRegions()
	ScenarioBG:Hide()
	local RaidFinderFrameNoRaidsCoverBG = RaidFinderFrame.NoRaidsCover:GetRegions()
...
m_catch:SetScript("OnEvent", skin_LFDQueueFrame)