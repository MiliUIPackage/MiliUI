local function skin_LootRolls()
	...
	local function miirgui_BonusRollFrame_StartBonusRoll()
		...
		frame.PromptFrame.EncounterJournalLinkButton:ClearAllPoints()
		frame.PromptFrame.EncounterJournalLinkButton:SetPoint("CENTER",frame.PromptFrame.Timer)
	end
...
m_catch:SetScript("OnEvent", skin_LootRolls)