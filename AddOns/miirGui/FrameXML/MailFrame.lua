local function skin_MailFrame()
	...
	local function miirgui_SendMailFrame_Update()
		for i=1,12 do
	...
	hooksecurefunc("SendMailFrame_Update",miirgui_SendMailFrame_Update)
	...
	function frame:OnEvent(event)
		...
		if event == "ITEM_TEXT_READY" then
			...
			if(material == "ParchmentLarge") then
				...
				ItemTextPageText:SetTextColor("H1",miirguiDB.color.r,miirguiDB.color.g,miirguiDB.color.b)
				ItemTextPageText:SetTextColor("H2",miirguiDB.color.r,miirguiDB.color.g,miirguiDB.color.b)
				ItemTextPageText:SetTextColor("H3",miirguiDB.color.r,miirguiDB.color.g,miirguiDB.color.b)
				...
				if spacer and spacer:GetTexture() == 1368285 then
					spacer:SetVertexColor(miirguiDB.color.r,miirguiDB.color.g,miirguiDB.color.b)
				end
...
m_catch:SetScript("OnEvent", skin_MailFrame)