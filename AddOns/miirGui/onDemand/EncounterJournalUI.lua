local function skin_Blizzard_EncounterJournal()
	...
	m_fontify(EncounterJournalEncounterFrameInfoLootScrollFrameSlotFilterToggle:GetFontString(),"white")
	m_fontify(EncounterJournalEncounterFrameInfoLootScrollFrameClassFilterClearFrame.text,"white")
	...
	m_border(EncounterJournalEncounterFrameInstanceFrame,340,264,"CENTER",3.5,35,12,"MEDIUM")
