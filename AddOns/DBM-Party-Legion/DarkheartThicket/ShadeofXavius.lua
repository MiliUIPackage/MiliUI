...
mod:SetRevision("20231031063344")
...
local timerFeedOnTheWeakCD			= mod:NewCDCountTimer(30.3, 200238, nil, nil, nil, 5, nil, DBM_COMMON_L.HEALER_ICON)
...
function mod:OnCombatStart(delay)
	...
	timerParanoiaCD:Start(27.5-delay, 1)
end
