...
L["EJ Icon Scale"] = "Échelle icônes codex"
L["Enable Coordinates"] = "Activer coordonnées"
L["Enable FogClear"] = "Activer antibrouillard"
L["Faded Alpha"] = "Transparence de fondu"
L["FogClear"] = "Antibrouillard"
L["Font Size"] = "Taille de la police"
L["Font Size on the normal map."] = "Taille de la police sur la carte normale."
...
L["Scale of the Encounter Journal Icons on the Map."] = "Échelle des icônes du codex des donjons sur la carte."
...
L["The map will fade out to the configured Fade Alpha level when you start moving."] = "La carte s'estompera au niveau de transparence de fondu configuré quand vous commencez à vous déplacer."
L["The transparency of the big map."] = "Définit la transparence de la grande carte."
L["The transparency of the map while you are moving and the map is faded."] = "La transparence de la carte quand vous vous déplacez et que la carte est estompée."
