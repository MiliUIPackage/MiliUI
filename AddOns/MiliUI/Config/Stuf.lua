...
function MiliUI_BuildStufDefaults()
    ...
    return {
        ...
        focus={
            ...
            text4={ hide=false, pattern="[curmp]/[maxmp]", x=0, y=-41, w=120, h=10, fontsize=10, justifyH="CENTER", justifyV="CENTER", framelevel = 6, },
            buffgroup={ x=0, y=-50, w=12, h=12, count=10, rows=1, cols=10, growth="LRTB", spacing=1, vspacing=1, },
            debuffgroup={ x=0, y=-50, w=12, h=12, count=10, rows=1, cols=10, growth="LRTB", push="v", spacing=1, vspacing=1, },
            auratimers={ hide=true, x=0, y=-24, w=50, h=12, count=4, rows=4, cols=1, growth="TBLR", push="v", },
            statusicon={ hide=true, x=-6, y=-20, w=10, h=10, },
            dispellicon={ hide=true, x=57, y=-1, w=22, h=22, },
            pvpicon={ hide=true, x=-8, y=-5, w=16, h=16, },
            raidtargeticon={ x=52, y=10, w=16, h=16, framelevel=6},
            infoicon={ hide=true, x=0, y=0, w=12, h=12, },
            ...
            castbar={
                hide=false, x=0, y=0, w=120, h=40, alpha=0.8,
                baralpha=1, bgcolor={ r=0, g=0, b=0, a=0.5, },
                spellx=25, spelly=-10, spellw=120, spellh=20,
                ...
                iconx=5, icony=-12, iconw=15, iconh=15,
        ...
        focustarget={
            ...
            mpbar={ x=0, y=-40, w=70, h=10, hide=false, barcolormethod="power", bgcolormethod="powerdark", bgalpha=0.6, baralpha=1, bartexture = "TukTex", border="Square Outline", bordercolor = {r=0, g=0, b=0, a=1, }, },
            text1={ pattern="[name]", x=0, y=10, w=70, h=50, fontsize=10, fontflags="OUTLINE", justifyH="CENTER", justifyV="CENTER", },
            text2={ pattern="[perchp]%", x=0, y=-4, w=70, h=50, fontsize=8, justifyH="CENTER", justifyV="CENTER", fontflags="OUTLINE", },
            text3={ hide=true, pattern="", x=0, y=0, w=10, h=10, fontsize=10, },
            text4={ hide=false, pattern="[curmp]/[maxmp]", x=0, y=-41, w=70, h=10, fontsize=8, justifyH="CENTER", justifyV="CENTER", framelevel = 6, },
