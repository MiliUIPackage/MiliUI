...
function MiliUI_BuildStufDefaults()
    ...
    return {
        ...
        player={
            ...
            castbar={
                hide=false, x=0, y=0, w=200, h=52, alpha=1,
                baralpha=1, bgcolor={ r=0, g=0, b=0, a=0.8, },
                ...
                spellfontcolor={ r=1, g=1, b=1, a=1, }, spellfontflags="OUTLINE",
        ...
        target={
            ...
            buffgroup={
                x=-10, y=-62, w=25, h=25,
                count=16, rows=2, cols=8, growth="LRTB", showpie=true, spacing=1, vspacing=1,
                counttx=5, countty=-5, counttfontflags="OUTLINE", counttfontsize=10,
            },
            debuffgroup={
                x=0, y=8, w=25, h=25,
                count=16, rows=2, cols=8, growth="LRBT", showpie=true, spacing=1, vspacing=1,
                counttx=5, countty=-5, counttfontflags="OUTLINE", counttfontsize=10,
            },
            auratimers={
                x=0, y=-52, w=70, h=13,
        ...
        targettarget={
            ...
            buffgroup={ x=0, y=-32, w=20, h=20, count=12, rows=2, cols=6, spacing=1, vspacing=1, },
            debuffgroup={ x=0, y=5, w=20, h=20, count=12, rows=2, cols=6, growth = "LRBT", spacing=1, vspacing=1, },
            statusicon={ hide=true, x=-6, y=-20, w=10, h=10, },
            dispellicon={ hide=true, x=54, y=-1, w=22, h=22, },
            pvpicon={ hide=true, x=-8, y=-5, w=16, h=16, },
            raidtargeticon={ hide=false, x=54, y=10, w=15, h=15, },
        ...
        focus={
            frame={ x=targetx, y=playery+100, w=120, h=30, },
            portrait={ x=0, y=0, w=120, h=40, show3d=true, hide=true, framelevel = 2, },
            hpbar={
                x=0, y=0, w=120, h=20,
                barcolormethod="classreaction", bgcolormethod="classreactiondark",
                bgalpha=0.6, baralpha = 1,
                framelevel = 5,
                bartexture = "TukTex",
                border="Square Outline",
                bordercolor = {r=0, g=0, b=0, a=1, },
            ...
            mpbar={
                x=0, y=-20, w=120, h=10, barcolormethod="power", bgcolormethod="powerdark", bgalpha=1,
                bartexture = "TukTex",
                border="Square Outline",
                bordercolor = {r=0, g=0, b=0, a=1, },
                framelevel = 5,
            },
            text1={ pattern="[name]", x=0, y=-4, w=120, h=12, fontsize=12, justifyH="CENTER", justifyV="TOP", shadowx=0, shadowy=0, fontflags="OUTLINE", framelevel = 5, },
            text2={ hide=true, pattern="[level] [class:creaturetype]", x=37, y=4, w=108, h=10, fontsize=10, justifyH="LEFT", justifyV="TOP", shadowx=-1, shadowy=-1, framelevel = 5, },
            text3={ pattern="[perchp]%", x=44, y=6, w=120, h=10, fontsize=11, justifyH="CENTER", justifyV="CENTER", fontflags="OUTLINE", framelevel = 6, },
            text4={ hide=false, pattern="[curmp]/[maxmp]", x=0, y=-21, w=120, h=10, fontsize=10, justifyH="CENTER", justifyV="CENTER", framelevel = 6, },
            buffgroup={ hide=true, x=0, y=-50, w=12, h=12, count=10, rows=1, cols=10, growth="LRTB", spacing=1, vspacing=1, },
            debuffgroup={ hide=true, x=0, y=-50, w=12, h=12, count=10, rows=1, cols=10, growth="LRTB", push="v", spacing=1, vspacing=1, },
            auratimers={ hide=true, x=0, y=-24, w=50, h=12, count=4, rows=4, cols=1, growth="TBLR", push="v", },
            statusicon={ hide=true, x=-6, y=-20, w=10, h=10, },
            dispellicon={ hide=true, x=57, y=-1, w=22, h=22, },
            pvpicon={ hide=true, x=-8, y=-5, w=16, h=16, },
            raidtargeticon={ x=52, y=12, w=16, h=16, framelevel=6},
            infoicon={ hide=true, x=0, y=0, w=12, h=12, },
            ...
            castbar={
                hide=false, x=-20, y=20, w=160, h=10, alpha=1,
                baralpha=1, bgcolor={ r=0, g=0, b=0, a=1, },
                spellx=12, spelly=7, spellw=160, spellh=0,
                spellfontsize=10, spelljustifyH="LEFT", spelljustifyV="TOP", spellshadowx=0, spellshadowy=0,
                spellfontcolor={ r=1, g=1, b=1, a=1, },
                timex=0, timey=5, timew=160, timeh=10,
                timefontsize=8, timejustifyH="RIGHT", timejustifyV="TOP",
                timefontcolor={ r=1, g=1, b=1, a=1, },
                timeformat="remaindurationdelay",
                iconx=0, icony=0, iconw=10, iconh=10,
            ...
            rangetext={ x=0, y=6, w=120, h=10, fontsize=11, justifyH="LEFT", framelevel=6, fontflags="OUTLINE", },
        },
        focustarget={
            frame={ x=targetx+125, y=playery+100, w=70, h=30, },
            portrait={ x=0, y=0, w=12, h=12, hide=true, },
            hpbar={ x=0, y=0, w=70, h=20, barcolormethod="classreaction", bgcolormethod="classreactiondark", bgalpha=0.6, baralpha=0.4, bartexture = "TukTex", border="Square Outline", bordercolor = {r=0, g=0, b=0, a=1, }, },
            mpbar={ x=0, y=-20, w=70, h=10, hide=false, barcolormethod="power", bgcolormethod="powerdark", bgalpha=0.6, baralpha=1, bartexture = "TukTex", border="Square Outline", bordercolor = {r=0, g=0, b=0, a=1, }, },
            text1={ pattern="[name]", x=0, y=14, w=70, h=50, fontsize=10, fontflags="OUTLINE", justifyH="CENTER", justifyV="CENTER", },
            text2={ pattern="[perchp]%", x=17, y=14, w=70, h=50, fontsize=8, justifyH="RIGHT", justifyV="CENTER", fontflags="OUTLINE", },
            text3={ hide=true, pattern="", x=0, y=0, w=10, h=10, fontsize=10, },
            text4={ hide=false, pattern="[curmp]/[maxmp]", x=0, y=-21, w=70, h=10, fontsize=8, justifyH="CENTER", justifyV="CENTER", framelevel = 6, },
            raidtargeticon={ x=27, y=10, w=16, h=16, framelevel=6, },
            buffgroup={ hide=true, x=0, y=-12, w=6, h=6, count=6, rows=1, cols=6, },
            debuffgroup={ hide=true, x=0, y=-12, w=6, h=6, count=6, rows=1, cols=6, push="v", },
            infoicon={ hide=true, x=0, y=0, w=12, h=12, },
        },
        pet={
            ...
            buffgroup={ x=0, y=-52, w=20, h=20, count=12, rows=2, cols=6, spacing=1, vspacing=1, },
            debuffgroup={ x=0, y=5, w=20, h=20, count=12, rows=2, cols=6, growth = "LRBT", spacing=1, vspacing=1, },
            statusicon={ hide=true, x=-6, y=-20, w=10, h=10, },
            dispellicon={ hide=true, x=54, y=-1, w=22, h=22, },
            pvpicon={ hide=true, x=-8, y=-5, w=16, h=16, },
        ...
        boss1={
            ...
            castbar={
                ...
                baralpha=1, bgcolor={ r=0, g=0, b=0, a=0.5, },
                spellx=0, spelly=0, spellw=90, spellh=10,
                ...
                timefontsize=10, timejustifyH="RIGHT", timejustifyV="CENTER",
                timefontcolor={ r=1, g=1, b=1, a=1, },
                iconx=0, icony=0, iconw=10, iconh=10, iconalpha=1,
                spellfontflags="OUTLINE",
                timefontflags="OUTLINE",
            },
