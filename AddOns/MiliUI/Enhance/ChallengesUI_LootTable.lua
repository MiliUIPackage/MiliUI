...
-- 鑰石等級 → 軌道階級的對應與紋章數量沿用第1賽季
--
-- 各軌道每階裝等（範圍只給頭尾，中間靠軌道重疊補齊，見下）:
--   勇士 292 295 298 302 305 308
--   英雄 305 308 311 315 318 321
--   神話 318 321 324 328 331 334
--
-- 重疊關係（第1賽季資料驗證過）：某軌道的 5/6、6/6 分別等於下一軌道的
-- 1/6、2/6。S1 勇士 259/263 = 英雄 1/6、2/6，精兵 292/295 = 勇士 1/6、2/6。
-- 這鎖死了每條軌道的 1、2、5、6 階；3/6 與 4/6 沒有任何重疊可推，是把
-- 剩下的 10 ilvl 拆成 3/4/3 得到的（S2 每軌總跨距 16，S1 是 17）。
-- 若實測發現 3/6、4/6 差 1，改這裡的 298/302、311/315、324/328 即可。
--
-- 拾取 (endOfRun) 升級軌道:
--   M+0   = Champion 1/6 = 292    M+2,3 = Champion 2/6 = 295
--   M+4   = Champion 3/6 = 298    M+5   = Champion 4/6 = 302
--   M+6,7 = Hero 1/6 = 305        M+8,9 = Hero 2/6 = 308
--   M+10  = Hero 3/6 = 311
--
-- 寶庫 (greatVault) 升級軌道:
--   M+0   = Champion 4/6 = 302    M+2,3 = Hero 1/6 = 305
--   M+4,5 = Hero 2/6 = 308        M+6   = Hero 3/6 = 311
--   M+7,8,9 = Hero 4/6 = 315      M+10  = Myth 1/6 = 318
--
-- 紋章掉落：
...
--         紋章類型, 紋章數量, 紋章品質 }
local LOOT_DATA = {
    { "傳奇",    292, "勇士1/6", "champion",  302, "勇士4/6", "champion",  "勇士", 10, "champion" },
    { "傳奇 +2", 295, "勇士2/6", "champion",  305, "英雄1/6", "hero",      "勇士", 12, "champion" },
    { "傳奇 +3", 295, "勇士2/6", "champion",  305, "英雄1/6", "hero",      "勇士", 14, "champion" },
    { "傳奇 +4", 298, "勇士3/6", "champion",  308, "英雄2/6", "hero",      "英雄", 12, "hero" },
    { "傳奇 +5", 302, "勇士4/6", "champion",  308, "英雄2/6", "hero",      "英雄", 14, "hero" },
    { "傳奇 +6", 305, "英雄1/6", "hero",      311, "英雄3/6", "hero",      "英雄", 16, "hero" },
    { "傳奇 +7", 305, "英雄1/6", "hero",      315, "英雄4/6", "hero",      "英雄", 18, "hero" },
    { "傳奇 +8", 308, "英雄2/6", "hero",      315, "英雄4/6", "hero",      "英雄", 20, "hero" },
    { "傳奇 +9", 308, "英雄2/6", "hero",      315, "英雄4/6", "hero",      "神話", 10, "mythic" },
    { "傳奇 +10",311, "英雄3/6", "hero",      318, "神話1/6", "mythic",    "神話", 12, "mythic" },
    { "傳奇 +11",311, "英雄3/6", "hero",      318, "神話1/6", "mythic",    "神話", 14, "mythic" },
    { "傳奇 +12",311, "英雄3/6", "hero",      318, "神話1/6", "mythic",    "神話", 16, "mythic" },
}
