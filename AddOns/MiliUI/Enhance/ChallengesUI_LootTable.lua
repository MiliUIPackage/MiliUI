...
local LOOT_DATA = {
    ...
    { "傳奇 +9", 263, "英雄2/6", "hero",      269, "英雄4/6", "hero",      "傳奇", 10, "mythic" },
    { "傳奇 +10",266, "英雄3/6", "hero",      272, "傳奇1/6", "mythic",    "傳奇", 12, "mythic" },
    { "傳奇 +11",266, "英雄3/6", "hero",      272, "傳奇1/6", "mythic",    "傳奇", 14, "mythic" },
    { "傳奇 +12",266, "英雄3/6", "hero",      272, "傳奇1/6", "mythic",    "傳奇", 16, "mythic" },
}
