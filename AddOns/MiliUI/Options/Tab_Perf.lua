...
local function Init()
    ...
    lagCB:SetScript("OnEnter", function()
        ...
        GameTooltip:AddLine(" ")
        GameTooltip:AddLine("順便記錄每分鐘的 Lua 堆下界：記憶體大不大要看斜率不是數值，"
            .. "/miliui lag heap 看有沒有洩漏。", 0.8, 0.8, 0.8, true)
        GameTooltip:AddLine(" ")
        GameTooltip:AddLine("/miliui lag 看記錄｜lag heap 記憶體趨勢｜lag <毫秒> 改門檻｜lag clear 清空", 0.5, 0.7, 1)
        GameTooltip:Show()
    end)
