...
if not oldversion or oldversion < 3 then
    ...
    local function fixupZones()
        ...
        worldMapData[0] = { 76153.14, 50748.62, 65008.24, 23827.51 }    --Eastern Kingdoms
        worldMapData[1] = { 77803.77, 51854.98, 13157.6, 28030.61 }     --Kalimdor
        worldMapData[571] = { 71773.64, 50054.05, 36205.94, 12366.81 }  --Northrend
        worldMapData[870] = { 67710.54, 45118.08, 33565.89, 38020.67 }  --Pandaria
        worldMapData[1220] = { 82758.64, 55151.28, 52943.46, 24484.72 } --Broken isles
        worldMapData[1642] = { 77933.3, 51988.91, 44262.36, 32835.1 }   --Zandalar
        worldMapData[1643] = { 76060.47, 50696.96, 55384.8, 25774.35 }  --Kultiras
    end
