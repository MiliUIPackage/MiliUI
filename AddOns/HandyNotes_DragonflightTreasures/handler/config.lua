            ...
            args = {
                ...
                default_icon = {
                    ...
                    values = {
                        ...
                        VignetteLootElite = CreateAtlasMarkup("VignetteLootElite", 20, 20) .. " 精英寶箱",
        ...
        display = {
            ...
            args = {
                ...
                achievedfound = {
                    type = "toggle",
                    name = "成就達成視為已完成",
                    desc = "每日任務會重複出現，並且和成就綁定的地點，視為成就的。",
                    order = 21,
                },
                collectablefound = {
                    type = "toggle",
                    name = "收集過視為已完成",
                    desc = "帳號共用的物品，像是坐騎、寵物和玩具，曾經收集過就視為已取得。",
                    order = 22,
                },
                questfound = {
                    type = "toggle",
                    name = "任務記錄視為已完成",
                    desc = "很多東西都有隱藏任務，會記錄你曾在今天、這週或什麼時候獲得過，以及是否可以再次取得。",
                    order = 23,
                },
                upcoming = {
                    type = "toggle",
                    name = "顯示無法到達的",
                    desc = "你目前還不能去的地方 (需要滿等、開啟任務...等) 也要顯示路徑，會用紅色來表示。",
                    order = 25,
                },
                show_npcs = {
                    type = "toggle",
                    name = "顯示 NPC",
                    desc = "顯示要擊殺的稀有怪，通常會掉落物品或有成就。",
                    order = 30,
                },
                show_treasure = {
                    type = "toggle",
                ...
                tooltip_questid = {
                    type = "toggle",
                    name = "顯示任務 ID",
                    desc = "顯示地點相關任務的內部 ID，回報問題時會很方便。",
                    order = 40,
                },
                unhide = {
                    type = "execute",
                    name = "重置被隱藏的地點",
                    desc = "顯示所有被你手動點右鍵選擇 \"隱藏\" 的地點。",
                    func = function()
