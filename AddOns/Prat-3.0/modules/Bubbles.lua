...
Prat:AddModuleToLoad(function()
  ...
  L:AddLocale("ruRU",
  {
	...
	transparent_desc = "Скрыть фон и границы у всплывающих сообщений (требуется /reload для отмены опции)", -- Needs review
	transparent_name = "Прозрачные всплывающие сообщения", -- Needs review
}
