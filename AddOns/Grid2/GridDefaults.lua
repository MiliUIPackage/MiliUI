...
local function MakeDefaultsCommon()
	...
	Grid2:DbSetValue( "indicators",  "health", {type = "bar", level = 2, location= Location("CENTER"), orientation="HORIZONTAL", texture = "TukTex", color1 = {r=0,g=0,b=0,a=1}})
	...
	Grid2:DbSetValue( "indicators",  "icon-center", {type = "icon", level = 8, location = Location("CENTER"), size = 14, fontSize = 10,fontFlags="OUTLINE",})
	Grid2:DbSetMap( "icon-center", "death", 155)
	Grid2:DbSetMap( "icon-center", "ready-check", 150)

	Grid2:DbSetValue( "indicators",  "icon-right", {type = "icon", level = 8, location = Location("RIGHT",2), size = 12, fontSize = 10,fontFlags="OUTLINE",})
	Grid2:DbSetValue( "indicators",  "icon-left", {type = "icon", level = 8, location = Location("LEFT",-2), size = 12, fontSize = 10,fontFlags="OUTLINE",})
	Grid2:DbSetMap( "icon-left", "raid-icon-player", 155)

	Grid2:DbSetValue( "indicators",  "text-up", {type = "text", level = 7, location = Location("TOP",0,-8) , textlength = 6, fontSize = 10,fontFlags="OUTLINE", })
	...
	Grid2:DbSetValue( "indicators",  "text-down", {type = "text", level = 6, location = Location("BOTTOM",0,4) , textlength = 6, fontSize = 11,fontFlags="OUTLINE" })
...
do
	...
	if class=="SHAMAN" then MakeDefaultsClass= function()
		...
		Grid2:DbSetValue( "indicators",  "corner-top-left", {type = "text", level = 9, location = Location("TOPLEFT"), size = 5, duration=true, fontFlags="OUTLINE", fontSize=10,})
		Grid2:DbSetMap( "corner-top-left", "buff-Riptide-mine", 99)
		Grid2:DbSetValue( "indicators",  "side-top", {type = "text", level = 9, location= Location("TOP"), size = 5, duration=true, fontFlags="OUTLINE", fontSize=10,})
		Grid2:DbSetMap( "side-top", "buff-Earthliving", 89)
		Grid2:DbSetValue( "indicators",  "corner-top-right", {type = "text", level = 9, location= Location("TOPRIGHT"), size = 5, duration=true, fontFlags="OUTLINE", fontSize=10,})
		...
		Grid2:DbSetValue( "indicators",  "corner-top-left", {type = "text", level = 9, location = Location("TOPLEFT"), textlength = 12, fontSize = 10, font = defaultFont, duration = true, fontFlags="OUTLINE", })
		...
		Grid2:DbSetValue( "indicators",  "side-top", {type = "text", level = 9, location = Location("TOP"), textlength = 12, fontSize = 10, font = defaultFont, duration = true, fontFlags="OUTLINE", })
		...
		Grid2:DbSetValue( "indicators",  "corner-top-right", {type = "text", level = 9, location = Location("TOPRIGHT"), textlength = 12, fontSize = 10, font = defaultFont, duration = true, fontFlags="OUTLINE", })
		...
		Grid2:DbSetValue( "indicators",  "corner-bottom-right", {type = "text", level = 9, location = Location("BOTTOMRIGHT"), size = 5, duration=true, fontFlags="OUTLINE", fontSize=10,})
		...
		Grid2:DbSetValue( "indicators",  "corner-bottom-left", {type = "text", level = 5, location = Location("BOTTOMLEFT"), size = 5, color1 = {r=1,g=1,b=1,a=1}, fontSize = 10, font = defaultFont, duration = true, fontFlags="OUTLINE",})
		...
		Grid2:DbSetValue( "indicators",  "corner-bottom-right", {type = "text", level = 8, location = Location("BOTTOMRIGHT"), size = 12, fontSize = 10, font = defaultFont, duration = true, fontFlags="OUTLINE",})
		...
		Grid2:DbSetValue( "indicators",  "side-bottom", {type = "text", level = 9, location = Location("BOTTOM"), size = 5, duration=true, fontFlags="OUTLINE", fontSize=10,})
