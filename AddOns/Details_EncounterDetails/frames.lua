...
--~emotes
	...
	local row_on_mouse_up = function(self)
		...
		local reportFunc = function()
			...
			EncounterDetails:SendReportLines ({Loc ["Details! Encounter Emote at "] .. timeString, "\"" .. text .. "\""})
		end
...
Report_DamageButton.textsize = 13
...
Report_HealingButton.textsize = 13
...
for i = 1, 20 do
	...
	line:Hide()
	local name = line:CreateFontString("$parentName", "overlay", "GameFontNormal")
	_detalhes.gump:SetFontSize(name, 13)
	name:SetPoint("left", line, "left", 2, 0)
	
	local done = line:CreateFontString("$parentDone", "overlay", "GameFontNormal")
	_detalhes.gump:SetFontSize(done, 13)
	done:SetPoint("right", line, "right", -2, 0)
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	-- ~interrupt
		...
		interrupt_total_string.textsize = 13		
	...
	-- ~dispel
		...
		dispell_total_string.textsize = 13
