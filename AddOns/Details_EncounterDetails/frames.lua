do
	...
	Details.EncounterDetailsTempWindow = function(encounterDetails)
		...
		local buildOptionsPanel = function()
			...
			local on_show_menu = {
				{value = 1, label = "團隊副本內", onclick = onShowIconCallback, desc = "Only show the icon while inside a raid."},
				{value = 2, label = "在隊伍中", onclick = onShowIconCallback, desc = "Only show the icon while in group."},
				{value = 3, label = "首領戰之後", onclick = onShowIconCallback, desc = "Show the icon after a raid boss encounter."},
				{value = 4, label = "總是", onclick = onShowIconCallback, desc = "Always show the icon."},
				{value = 5, label = "自動", onclick = onShowIconCallback, desc = "The plugin decides when the icon needs to be shown."},
			}
		...
		--raid name
		detailsFramework:NewLabel(headerFrame, headerFrame, nil, "raidNameLabel", "Unknown Raid", "GameFontHighlight")
