...
local L = AceLocale:NewLocale("HandyNotes_Silvermoon", "enUS", true, true)
...
L["config_plugin_desc"] = "Displays the NPC and POI locations in Silvermoon on the world map and minimap."
