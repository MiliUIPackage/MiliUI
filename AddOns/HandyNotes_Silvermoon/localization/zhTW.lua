local L = LibStub("AceLocale-3.0"):NewLocale("HandyNotes_Silvermoon", "zhTW", false, true)
...
L["config_craftingorders"] = "製造訂單"
L["config_craftingorders_desc"] = "顯示製造訂單的NPC位置。"
L["config_easy_waypoints"] = "快速導航"
L["config_easy_waypoints_desc"] = "簡化建立路線導航的方法，只要點一下滑鼠右鍵便能設定導航目的地，CTRL + 右鍵點擊會有更多選項。"
L["config_flightmaster"] = "飛行管理員"
L["config_flightmaster_desc"] = "顯示飛行管理員位置。"
...
L["config_plugin_desc"] = "顯示多恩諾加的各個NPC以及地點的地圖標記。"
L["config_plugin_name"] = "銀月城"
L["config_portal"] = "傳送門"
...
L["config_rostrum"] = "生化轉化台"
L["config_rostrum_desc"] = "顯示生化轉化台的位置。"
...
L["handler_context_menu_addon_name"] = "HandyNotes: 銀月城"
