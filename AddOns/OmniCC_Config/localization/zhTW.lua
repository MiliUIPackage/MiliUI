...
L.ColorAndScaleDesc = "調整顏色和縮放設定以適應不同的冷卻狀態"
L.CooldownText = "冷卻文字"
L.CooldownOpacity = '冷卻透明度'
L.CooldownOpacityDesc = '調整冷卻透明度'
L.CreateTheme = "建立主題"
L.Display = DISPLAY
...
L.FinishEffect = "冷卻完成效果"
L.FinishEffectDesc = "調整冷卻結束時觸發的效果"
L.FinishEffects = "冷卻完成效果"
L.FontFace = "字體"
L.FontOutline = "文字外框"
L.FontSize = "文字大小"
...
L.Outline_NONE = NONE
L.Outline_OUTLINE = "細"
L.Outline_OUTLINEMONOCHROME = "無消除鋸齒"
L.Outline_THICKOUTLINE = "粗"
L.Preview = PREVIEW
L.RuleAdd = "新增規則"
L.RuleAddDesc = "建立一個新規則"
L.RuleEnable = ENABLE
L.RuleEnableDesc = "切換此規則。 如果停用了規則，則冷卻時間將跳過對其進行檢查。"
L.RulePatterns = "模式"
L.RulePatternsDesc = "此規則應該套用於的 UI 元素的名稱或名稱的一部分。 每個模式應在單獨的行中輸入。"
L.RulePriority = "優先級"
...
L.State_days = "至少 1 天"
L.State_hours = "還有幾小時"
L.State_minutes = "不到 1 小時"
L.State_seconds = "不到 1 分鐘"
L.State_soon = "即將到期"
...
L.Themes = "主題"
L.ThemesDesc = "主題是冷卻時間外觀設定的集合。 主題可以與規則結合使用，以更改 UI 特定部分上的冷卻時間"
L.Typography = "文字樣式"
L.TypographyDesc = "調整冷卻文字的外觀，例如使用哪種字體"
L.VerticalOffset = "垂直位置偏移"
L.TimerOffset = "時間偏移 (MS)"
L.TimerOffsetDesc = "將冷卻時間所顯示的文字減去一段時間。舉例來說，可以讓冷卻文字提早結束，有足夠的緩衝時間讓你準備施放下個技能。"
