...
local _, addon = ...
local baseLocale = {
    ["A binding that belongs to the 'default' binding-set will always be active on your unit frames, unless you override it with another binding."] = "預設組別, 設置將對所有框體有效, 除非有其他組別的相同的按鍵設置",
    ...
    ["Clique binding configuration"] = "Clique 設置",
    ["Clique: 'default' binding-set"] = "組別: 預設",
