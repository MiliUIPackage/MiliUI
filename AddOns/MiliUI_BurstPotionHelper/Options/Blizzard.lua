...
header:SetText(ns.PREFIX_COLOR .. L["SETTINGS_TITLE"] .. "|r")
...
local category = Settings.RegisterCanvasLayoutCategory(panel, L["SETTINGS_TITLE"])
category.ID = L["SETTINGS_TITLE"]
