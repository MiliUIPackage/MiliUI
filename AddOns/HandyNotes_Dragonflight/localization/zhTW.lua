...
L['options_icons_scout_pack_desc'] = '顯示遠征隊斥侯背包的位置'
...
L['brackenhide_rare_note'] = '這些稀有以10分鐘計時按固定輪次 {npc:197344} > {npc:197353} > {npc:197354} > {npc:197356} 出現。'
...
L['gnoll_fiend_flail_note'] = '{item:199066} 可以在遠征隊斥侯背包和挖過的土中找到。'
...
L['pt_ench_faintly_enchanted_remains_note'] = '點選 |cFFFFFD00缺魔水晶簇|r 來召喚並殺掉怪物. 然後拾取出現的水晶'
L['pt_ench_forgotten_arcane_tome_note'] = '在墓地入口右邊的地上'
L['pt_jewel_crystalline_overgrowth_note'] = '在小池塘邊'
L['pt_jewel_harmonic_crystal_harmonizer_note'] = '點擊箱子獲得增益，然後點擊3個水晶。'
...
L['elder_poa_note'] = '交付{item:200071} 來提升|cFFFFFD00伊斯凱拉巨牙海民|r的名望。'
...
L['hunter_of_the_deep_note'] = '單擊武器架並射擊魚直到稀有出現。'
L['scaleseeker_mezeri_note'] = '向 {npc:193224} 提供一個 {item:194681}，她會揭示稀有。'
L['shade_of_grief_note'] = '點選 {npc:193166} 來召喚稀有.'
L['windscale_the_stormborn_note'] = '殺死對 {npc:192357} 引導法術的 {npc:192367}.'
L['zarizz_note'] = '點選並對著4個 {npc:193169} 使用' .. ns.color.Orange('/鄙視、/hiss') .. '來召喚稀有.'

L['gold_swong_coin_note'] = '和 {npc:191608} 一起在山洞內, 且在她的右側。'
L['nokhud_warspear_note'] = '{item:194540} 可以在遠征隊斥侯背包和挖過的土中找到。'
...
L['pt_smith_ancient_spear_shards_note'] = '在|cFFFFFD00拉札薩爾之境|r西側洞穴。'
...
L['hunt_instructor_basku_note'] = '兌換{item:200093} 來提升|cFFFFFD00莫魯克半人馬|r的名望。'

-------------------------------------------------------------------------------
--------------------------------- THALDRASZUS ---------------------------------
-------------------------------------------------------------------------------

L['ancient_protector_note'] = '殺掉附近的 {npc:193244} 來取得 {item:197708}. 組合5個 {item:197708} 來產生 {item:197733}. 並且使用它來啟動附近的泰坦反應爐'
...
L['cracked_hourglass_note'] = '{item:199068} 可以在遠征隊斥侯背包和挖過的土中找到.'
...
L['sorotis_note'] = '兌換{item:199906} 來提升|cFFFFFD00沃卓肯協調者|r的名望。'
...
L['pt_alch_well_insulated_mug_note'] = '在 |cFFFFFD00龍禍要塞|r 一些精英怪物之間。'
...
L['cataloger_jakes_note'] = '兌換{item:192055} 來提升|cFFFFFD00龍鱗遠征隊|r的名望。'
