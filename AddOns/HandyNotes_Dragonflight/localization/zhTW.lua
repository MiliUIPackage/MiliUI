...
在獲得 {item:199203} 後，{npc:196214} 將提供一個上繳任務，獎勵 {item:193373}。
要完成任務，將需要以下物品（可以按任何順序獲得這些物品）：
]]
L['phoenix_wishwing_talisman'] = [[
%s {item:199203}

這是位於 {location:阿蘭卡峰林} 的 {npc:88045} {dot:Gold} 出售。如果 {npc:88045} 不在，完成任務 {quest:35010} 就能見到他。
需要以下物品才能購買：]]
L['phoenix_wishwing_phoenix_ember'] = '%s {item:199099}\n從 {location:火焰之地時光漫游} 的 {npc:52530} 掉落'
L['phoenix_wishwing_sacred_ash'] = '%s {item:199097}\n可以在 {object:烹鍋} 中找到，位於 {location:阿蘭卡峰林} 附近。'
L['phoenix_wishwing_inert_ash'] = '%s {item:199092}\n位於 {location:安戈洛環形山} {dot:Gray} 中心的 {npc:6520} 少量掉落。這些與 {npc:6521} 共享重生點（但不會掉落），因此請確保將兩者都擊殺。'
L['phoenix_wishwing_smoldering_ash'] = [[
%s {item:199080}

在 {location:巨龍群島} 刷各種 {npc:鳳凰} {dot:Yellow}，例如 {npc:181764} 或 {npc:195448}。
這些大多位 於{location:覺醒海岸} 的 {location:黑曜堡壘} 周圍。
]]
L['phoenix_wishwing_ash_feather'] = [[
%s {item:202062}

要查看 {object:羽毛}，需要從 {location:覺醒海岸} 的 {location:黑曜王座} 的 {npc:189207} {dot:Green} 處購買 {item:199177}。
使用這條項鏈並撿起位於 {location:燃燒高地} 和 {location:熔渣沼澤} 中的 {item:202062} {dot:Red}，它們在 {location:黑曜王座} 周圍的區域。
]]
L['phoenix_wishwing_info'] = '這是位於 {location:巨龍群島} 的 {location:覺醒海岸} 的 {item:193373} 收藏品的一部分。'
