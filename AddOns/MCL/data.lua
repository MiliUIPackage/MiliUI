...
MCLcore.mountList[1] = {
	...
	categories = {
		Achievement = {
			name = "Achievement",
			mounts = {186654, 186637, 184183, 182596, 186653, 184166, 186655, 187673, 187675, 190170, 217612},
		},
		Vendor = {
			name = "Vendor",
			mounts = {180748},
...
MCLcore.mountList[5] = {
	...
	categories = {
		...
		RareSpawn = {
			name = "Rare Spawn",
			mounts = {94229, 94230, 94231, 104269},
			mountID = {}
		},
		WorldBoss = {
			name = "World Boss",
...
MCLcore.mountList[14] = {
	...
	categories = {	
		...
		TimeWalking = {
			name = "Timewalking",
			mounts = {129923, 129922, 87775, 167894, 167895, 133543, 188674, 187595, 231374, 224398, 224399,234730,232624,205208,234721,234716,234740,238739,245694,245695},
			mountID = {}
		},
		Lunar = {
			name = "Lunar Festival",
...
MCLcore.mountList[15] = {
	...
	categories = {	
		BlizzardStore = {
			name = "Blizzard Store",
			mounts = {54811, 69846, 78924, 97989, 107951, 112326, 122469, 147901, 156564, 160589, 166775, 166774, 166776, "m1290", "m1346", "m1291", "m1456", 246698, "m1531", 190581, 258423, 258477, 248088, 258425, 203727, "m1795", 212229, 228751, 229128, 219450, 224574, "m2237", 229418, 230184, 230200, 230201, 230185, 227362, 235344, 231297, 233285, 233284, 233282, 233283, 233286, 238943,238994, 238966, 221270, 212228, 225250, 206167, 239076, 246732, 242795, 247848, 243194},
		...
		WowClassic = {
			name = "WoW Classic",
			mounts = {248090, 258475, "m1679", 210008, 235286, 235287, "m2582"},
			mountID = {1444, 1602}
		},
		anniversary = {
			name = "WoW Anniversary Mounts",
			mounts = {172022, 186469, 208572, 228760, 229348, 223459, 223471},
			mountID = {}
		},
		Hearthstone = {
			name = "Hearthstone",
...
MCLcore.mountList[17] = {
	...
	categories = {	
		MythicPlus = {
			name = "Mythic +",
			mounts = {174836, 182717, 187525, 187682, 192557, 199412, 204798, 209060, 213438, 226357,  235549, 237141},
			mountID = {}
		},
		...
		Arena = {
			name = "Arena Mounts",
			mounts = {30609, 34092, 37676, 43516, 46708, 46171, 47840, 50435, 71339, 71954, 85785, 95041, 104325, 104326, 104327, 128277, 128281, 128282, 141843, 141844, 141845, 141846, 141847, 141848, 153493, 156879, 156880, 156881, 156884, 183937, 186177, 189507, 191290, 202086, 205233, 210345, "m1822", 223586, 229987},
			mountID = {}
		},
		DCAzerothChopper = {
			name = "Azeroth Choppers",
		...
		Promotion = {
			...
			mounts = {95341, 112327, 92724, 143631, 163127, 43599, 151618, 258430, 151617},
			mountID = {}
		},	
		RaidMounts = {
		...
		RemixMOP = {
			...
			mounts = {220766,220768,213582,213576,213584,213595,87784,213602,213603,213605,213606,213607,213604,213608,213609,213628,213627,87786,87787,84753,213626,213624,213625,213623,213622,213621,218111,213600,213601,213598,213597,213596, 224374},	
                                ...
                                RemixLEGION = {
                                                name= "RemixLEGION",
                                                mounts = {253032, 253028, 253025, 253029, 253026, 253031, 252954, 253033, 253013, 253027, 253030, 250751, 250756, 250752, 250757, 251796, 251795, 250746, 250748, 250745, 250747, 250802, 250804, 250806, 250805, 250803, 250761, 250759, 250758, 250760, 250423, 250425, 250424, 250426, 250429, 250192, 250427, 250428, 239687, 239667, 239665, 250728, 250721, 250723}
		}
	}
}
...
MCLcore.mountList[19] = {
	...
	categories = {
		...
		Achievement = {
			name = "Achievement",
			mounts = {223266,224415,223267,223286,223158, "m2190", 231173, 248248, 250240, 247822, 237485, 242714},
		},
		Quest = {
			name = "Quest",
			mounts = {219391,224150, 246237, 242733, 242734, 238051, 246445, 242713},
		},
		Reputation = {
			name = "Reputation",
			mounts = {223571,221753,223505,222989,223317,223314,223274,223264,223276,223278,223279,238829,229936,229944,242729, 237484, 186640, 242728},
		},
		Vendor = {
			name = "Vendor",
		...
		UnderMine = {
			name = "Undermine",
			mounts = {229974, 229953, 229955,  229954, 229941, 229952, 229949, 229947, 233064, 229957, 229951, 229937, 229943}
		},
		Incursion = {
			name = "Incursion",
		...
		Delves = {
			name = "Delves",
			mounts = {229935, 229956,229948,229946,229950}
		}	
	}
}
