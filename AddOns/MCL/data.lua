...
core.mountList[13] = {
	...
	categories = {	
		...
		ViciousSaddle = {
			name = "邪氣鞍座",
			mounts = { 102533, 70910, 116778, 124540, 140348, 140354, 143649, 142235, 142437, 152869, 163124, 165020, 163121, 173713, 184013,184014, 186179, 70909, 102514, 116777, 124089, 140353, 140350, 143648, 142234, 142237, 152870, 163123, 163122, 173714, 186178, 187681, 187680, 187642, 187644, 201788, 201789, 205245, 205246},
			mountID = {}
		},
		Gladiator = {
			name = "角鬥士",
...
core.mountList[15] = {
	...
	categories = {	
		BlizzardStore = {
			name = "暴雪商城",
			mounts = {54811, 69846, 78924, 95341, 97989, 107951, 112326, 122469, 147901, 156564, 160589, 166775, 166774, 166776, "m1266", "m1267", "m1290", "m1346", "m1291", "m1456", "m1330", "m1531", "m1581", "m1312", "m1662", 76755, "m1594", "m1583"},
...
core.mountList[17] = {
	...
	categories = {	
		MythicPlus = {
			name = "傳奇 +",
			mounts = {182717, 187525, 174836, 187682, 192557, 199412},
			mountID = {}
		},
...
core.mountList[18] = {
	...
	categories = {
		DragonRiding = {
			name = "飛龍騎術",
			mounts = {194034, 194705, 194521, 194549, 204361}
		},
		Achievement = {
			name = "成就",
			mounts = {192806, 192791, 192784, 205205, 204798, 208152},
		},
		Treasures = {
			name = "寶藏",
			mounts = {201440, 198825, 192777, 192779,205204},
		},
		Quest = {
			name = "任務",
			mounts = {192799, 198870, 206567, 206566, "m1545"},
		},
		Reputation = {		
			name = "聲望",
			mounts = {192762, 198872, 192761, 192764, 200118, 201426, 201425, 205155, 205209, 205207},
		},
		Zone = {
			name = "區域",
			mounts = {192601, 198873, 198871, 192775, 201454, 192800, 204382, 192785, 192790, 192772, 191838, 205203, 205197},
		},
		TradingPost = {
			name = "貿易站",
		...
		Vendor = {
			name = "商人",
			mounts = {206673, 206680, 206676, 206678, 206674, 206679, 206675}
		}
	}
}
