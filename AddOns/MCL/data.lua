...
core.mountList[15] = {
	...
	categories = {	
		BlizzardStore = {
			name = "暴雪商城",
			mounts = {54811, 69846, 78924, 95341, 97989, 107951, 112326, 122469, 147901, 156564, 160589, 166775, 166774, 166776, "m1266", "m1267", "m1290", "m1346", "m1291", "m1456", "m1330", "m1531", "m1581", "m1312", "m1662", 76755, "m1594", "m1583", "m1797", 203727 },
...
core.mountList[17] = {
	...
	categories = {	
		MythicPlus = {
			name = "傳奇 +",
			mounts = {182717, 187525, 174836, 187682, 192557, 199412, 204798},
			mountID = {}
		},
		...
		Arena = {
			name = "競技場坐騎",
			mounts = {30609, 34092, 37676, 43516, 46708, 46171, 47840, 50435, 71339, 71954, 85785, 95041, 104325, 104326, 104327, 128277, 128281, 128282, 141843, 141844, 141845, 141846, 141847, 141848, 153493, 156879, 156880, 156881, 156884, 183937, 186177, 189507, 191290, 202086},
			mountID = {}
		},
		DCAzerothChopper = {
			name = "艾澤拉斯機車",
...
core.mountList[18] = {
	...
	categories = {
		...
		Achievement = {
			name = "成就",
			mounts = {192806, 192791, 192784, 205205, 208152, 210060, 209060},
		},
		Treasures = {
			name = "寶藏",
		...
		Zone = {
			name = "區域",
			mounts = {192601, 198873, 198871, 192775, 201454, 192800, 204382, 192785, 192790, 192772, 191838, 205203, 205197,210775, 210769, 210058, 210057, 209947, 209950},
		},
		TradingPost = {
			name = "貿易站",
			mounts = {190231, 190168, 190539, 190767, 190613, 206156, 137576, 208598, 211084, 211074, 210919},
		},
		Secret = {
			name = "秘密",
			mounts = {192786}
