...
core.mountList[16] = {
	...
	categories = {	
		...
		TradingPost = {
			name = "貿易站",
			mounts = {190231, 190168, 190539, 190767, 190613, 206156, 137576, 208598, 211074, 210919, 212227, 212630, 212920, 192766, 226041, 226040, 226044, 226042, 226506, 223449, 223469, 187674, 233019,233020,233023,233354},
		},		
	}
}
core.mountList[17] = {
	...
	categories = {	
		...
		Brawl = {
			name = "鬥陣俱樂部",
			mounts = {142403, 98405, 142403, 166724},
			mountID = {}
		},
		Arena = {
			name = "競技場坐騎",
