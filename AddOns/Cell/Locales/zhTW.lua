...
L["PARTY_TARGETS_PANE_TIPS"] = "目標按鈕完全跟著隊伍框走：順序、職責排序、外觀與指示器都一樣。左鍵點一下就選取那個單位。隊員沒有目標時那一顆不會出現。"
L["PARTY_TARGETS_SIDE_TIPS"] = "目標按鈕貼在隊伍按鈕的哪一邊。會跟著隊伍框轉向：隊伍框排成橫的時候，「左」＝上方、「右」＝下方。"
