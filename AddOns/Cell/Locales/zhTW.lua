...
L["Border Color"] = "邊框顏色"
L["Boss Name"] = "首領名稱"
L["Boss/Role Debuffs"] = "首領／職責減益"
L["Important Debuffs"] = "重要減益"
L["Priority Debuffs"] = "優先減益"
L["Raid-wide Debuffs"] = "團隊減益"
L["Dispellable"] = "可驅散"
L["Short Debuffs"] = "短時效減益"
L["Duration Limit"] = "持續時間上限"
L["Max Seconds"] = "最長秒數"
L["shortDebuffsTips"] = "暴雪沒有歸進上面任何一類、\n持續時間不超過設定秒數的 NPC 減益（例如炸彈標記）。\n排在最前面，最多 1 個。\n減益指示器也會照常顯示。"
L["durationLimitTips"] = "持續時間超過設定秒數、或沒有持續時間的\n首領／職責減益與優先減益，不再顯示在這裡。\n群體控制與可驅散減益不受限制。\n開啟時，減益指示器會改為顯示所有首領／職責與優先減益。"
...
L["Click-Casting Hints"] = "滑鼠施法提示"
L["CLICK_CASTING_HINTS_TIPS"] = "把滑鼠點擊施法設定的法術排成一列顯示在畫面上，附上按鍵與冷卻。預設附著在單位框架旁邊；取消附著後可以解鎖自由拖動。"
L["CLICK_CASTING_HINTS_JUMP_TIPS"] = "點一下前往「工具 > 滑鼠施法提示」，可以把下面這些設定顯示成畫面上的一列圖示。"
L["Snap to Cell"] = "附著在團隊框架上"
L["Settings For"] = "設定對象"
L["Frame Distance"] = "與框架距離"
L["ATTACH_SIDE_TIPS"] = "提示列貼在單位框架的哪一邊。起點跟著版面錨點的那一角，中間遇到 Cell 的選單方塊或戰復計時就自動往後讓開。"
L["Show Spell Tooltip"] = "顯示滑鼠提示訊息"
L["SHOW_SPELL_TOOLTIP_TIPS"] = "滑鼠移到圖示上會顯示該技能的說明。開啟時這排圖示會吃到滑鼠。"
L["Show Keybind"] = "顯示快捷鍵"
L["Duration Threshold"] = "剩幾秒顯示"
L["Keybind Position"] = "快捷鍵位置"
L["Restore Defaults"] = "恢復預設"
L["RESTORE_DEFAULTS_CONFIRM"] = "把這個工具的設定全部改回套組預設？\n你自己填的鍵名與擺放位置會消失。"
L["Duration Position"] = "倒數位置"
L["Duration"] = "持續時間"
L["Left Button"] = "左鍵"
L["Right Button"] = "右鍵"
L["Middle Button"] = "中鍵"
L["SHOW_KEYBIND_TIPS"] = "在每個圖示上標出按鍵組合"
L["KEY_LABEL_TIPS"] = "滑鼠鍵留空就畫圖示。只顯示「法術」類型的綁定。"
L["Snapped"] = "[已附著]"
L["SNAP_TO_CELL_TIPS"] = "提示列附著在 Cell 上：位置是從單位框架現在的位置算出來的，框架一動它就跟著走。取消勾選就改成自由擺放，用綠色方塊拖到任何地方。"
L["Close"] = "關閉"
...
L["excludeImportant"] = "排除重要減益"
L["bossBadge"] = "首領技能驚嘆號"
L["bossBadgeTips"] = "「首領／職責減益」這一類的圖示，|左上角會加一個黑邊的黃色小驚嘆號。"
L["dispelBadge"] = "可驅散加號"
L["dispelBadgeTips"] = "你目前專精能驅散的減益，|圖示右上角會加一個黑邊的白色「＋」。|這裡顯示的每一類減益都適用。"
L["Dispels"] = "驅散"
...
L["PARTY_TARGETS_PANE_TIPS"] = "在每位隊員旁邊顯示他的目標，只畫血量與團隊標記。副本裡依怪的類型上色，副本外依陣營。沒有目標時那一顆不出現。"
L["PARTY_TARGETS_SIDE_TIPS"] = "目標按鈕貼在隊伍按鈕的哪一邊。有開隊伍寵物時，寵物會自動排到另一邊，所以這裡等於在選「誰靠右」。會跟著隊伍框轉向：隊伍框排成橫的時候，「左」＝上方、「右」＝下方。"
L["PARTY_TARGETS_TIPS"] = "在每位隊員的框架旁邊，顯示那個人正在打的目標。"
L["PARTY_TARGETS_WIDTH_TIPS"] = "0 ＝ 跟主框一樣寬。高度一律跟著主框。"
L["PENDING"] = "等候"
L["Percentage"] = "百分比"
L["Pet"] = "寵物"
L["PET"] = "寵物"
...
L["Show major damage cooldowns, so you can see who is bursting."] = "顯示主要的輸出爆發技，讓你看得出誰正在爆發。"
