...
L["CLICK_CASTING_HINTS_TIPS"] = "把鼠标点击施法设置的法术排成一列显示在画面上，附上按键与冷却。默认附着在单位框体旁边；取消附着后可以解锁自由拖动。"
L["CLICK_CASTING_HINTS_JUMP_TIPS"] = "点一下前往「工具 > 鼠标施法提示」，可以把下面这些设置显示成画面上的一列图标。"
L["Snap to Cell"] = "附着在团队框体上"
L["Snapped"] = "[已附着]"
L["SNAP_TO_CELL_TIPS"] = "提示条附着在 Cell 上：位置是按小队/团队框体现在的位置算出来的，框体一动它就跟着走。取消勾选就改成自由摆放，用绿色方块拖到任何地方。"
L["Settings For"] = "设置对象"
L["Frame Distance"] = "与框体距离"
L["ATTACH_SIDE_TIPS"] = "提示条贴在单位框体的哪一边。起点跟着布局锚点的那一角，中间遇到 Cell 的菜单方块或战复计时就自动往后让开。"
L["auto"] = "自动"
...
L["PARTY_TARGETS_SIDE_TIPS"] = "目标按钮贴在队伍按钮的哪一边。有开队伍宠物时，宠物会自动排到另一边，所以这里等于在选「谁靠右」。会跟着队伍框转向：队伍框排成横的时候，「左」＝上方、「右」＝下方。"
L["PARTY_TARGETS_WIDTH_TIPS"] = "0 ＝ 跟主框一样宽。高度一律跟着主框。"
L["PARTY_TARGETS_PANE_TIPS"] = "在每位队友旁边显示他的目标，只画血量与团队标记。副本里依怪的类型上色，副本外依阵营。没有目标时那一颗不出现。"
L["Profiles"] = "配置"
...
L["Dispellable"] = "可驱散"
L["Short Debuffs"] = "短时效减益"
L["Duration Limit"] = "持续时间上限"
L["Max Seconds"] = "最长秒数"
L["shortDebuffsTips"] = "暴雪没有归入上面任何一类、\n持续时间不超过所设秒数的 NPC 减益（例如炸弹标记）。\n排在最前面，最多 1 个。\n减益指示器也会照常显示。"
L["durationLimitTips"] = "持续时间超过所设秒数、或没有持续时间的\n首领/职责减益与优先减益，不再显示在这里。\n群体控制与可驱散减益不受限制。\n开启后，减益指示器会改为显示所有首领/职责与优先减益。"
L["Actions"] = "动作"
L["Consumables"] = "消耗品"
...
L["bossBadge"] = "首领技能感叹号"
L["bossBadgeTips"] = "“首领/职责减益”这一类的图标，|左上角会加一个黑边的黄色小感叹号。"
L["dispelBadge"] = "可驱散加号"
L["dispelBadgeTips"] = "你当前专精能驱散的减益，|图标右上角会加一个黑边的白色“＋”。|这里显示的每一类减益都适用。"
...
L["Auras"] = "光环"
L["Comm"] = "通讯"
L["DEBUG_COMBAT_MARK"] = "战"
L["%d lines skipped (over the per-second limit)"] = "略过 %d 行（超过每秒上限）"
L["—— Above: log from before the last reload ——"] = "—— 以上是上次 reload 前的记录 ——"
L["toggle the debug console"] = "开关调试控制台"
