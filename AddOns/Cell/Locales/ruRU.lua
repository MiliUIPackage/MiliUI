...
L["Click-Casting Hints"] = "Подсказки привязок клавиш"
L["Close"] = "Закрыть"
...
L["Important Debuffs"] = "Важные дебаффы"
L["Boss/Role Debuffs"] = "Дебаффы босса/роли"
L["Priority Debuffs"] = "Приоритетные дебаффы"
L["Raid-wide Debuffs"] = "Рейдовые дебаффы"
L["Dispellable"] = "Рассеиваемые"
L["Short Debuffs"] = "Короткие дебаффы"
L["Duration Limit"] = "Лимит длительности"
L["Max Seconds"] = "Макс. секунд"
L["shortDebuffsTips"] = "Дебаффы от НИП, которые Blizzard не отнесла ни к одной категории выше\nи которые длятся не дольше заданного числа секунд (например, метки бомб).\nПоказываются первыми, не более одной иконки.\nИндикатор дебаффов тоже продолжает их показывать."
L["durationLimitTips"] = "Дебаффы босса/роли и приоритетные дебаффы длиннее заданного числа секунд\nили без длительности здесь больше не показываются.\nЭффекты контроля и рассеиваемые дебаффы никогда не ограничиваются.\nКогда включено, индикатор дебаффов показывает все дебаффы босса/роли и приоритетные."
L["Current"] = "Текущий(я) "
...
L["excludeImportant"] = "Скрывать дебаффы, показанные как важные"
L["bossBadge"] = "Отмечать дебаффы босса знаком «!»"
L["bossBadgeTips"] = "На каждой иконке дебаффов босса/роли|в левом верхнем углу появляется маленький жёлтый «!» с чёрной обводкой."
L["dispelBadge"] = "Отмечать рассеиваемые дебаффы знаком «+»"
L["dispelBadgeTips"] = "Дебаффы, которые может рассеять ваша текущая специализация,|получают маленький белый «+» с чёрной обводкой в правом верхнем углу.|Работает для всех категорий, показанных здесь."
L["Dispels"] = "Диспеллы"
...
L["Hide Raid Manager"] = "Скрыть менеджер рейда"
...
L["Show Spell Tooltip"] = "Показывать подсказку заклинания"
...
L["Use Game Font"] = "Использовать шрифт игры"
