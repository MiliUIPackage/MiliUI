...
L["Short Debuffs"] = "Affaiblissements courts"
L["Duration Limit"] = "Limite de durée"
L["Max Seconds"] = "Secondes max."
L["shortDebuffsTips"] = "Affaiblissements de PNJ que Blizzard ne classe dans aucune catégorie ci-dessus\net qui durent au plus le nombre de secondes défini (marques de bombe, etc.).\nAffichés en premier, une icône au maximum.\nL'indicateur d'affaiblissements continue aussi de les afficher."
L["durationLimitTips"] = "Les affaiblissements de boss/rôle et prioritaires qui durent plus que le nombre de secondes défini,\nou sans durée, ne sont plus affichés ici.\nLes contrôles des foules et les affaiblissements dissipables ne sont jamais limités.\nActivé, l'indicateur d'affaiblissements affiche tous les affaiblissements de boss/rôle et prioritaires."
L["Current"] = "Actuel"
...
L["bossBadgeTips"] = "Chaque icône d'affaiblissement de boss/rôle affiche|un petit « ! » jaune bordé de noir en haut à gauche."
L["dispelBadge"] = "Marquer les affaiblissements dissipables d'un « + »"
L["dispelBadgeTips"] = "Les affaiblissements que votre spécialisation actuelle peut dissiper|affichent un petit « + » blanc bordé de noir en haut à droite.|S'applique à toutes les catégories affichées ici."
--[[Translation missing --]]
--[[ L["Dispels"] = "Dispels"--]]
...
L["auto"] = "Automatique"
L["Settings For"] = "Réglages pour"
L["Frame Distance"] = "Dist. aux cadres"
L["ATTACH_SIDE_TIPS"] = "De quel côté des cadres la barre se place. Elle démarre au coin d'où la disposition grandit et contourne le bloc de menu de Cell et le minuteur de résurrection."
