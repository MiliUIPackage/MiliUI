...
L["Click-Casting Hints"] = "클릭 시전 도움말"
L["Close"] = "닫기"
L["Code Snippets"] = "코드 스니펫"
L["Color"] = "색상"
L["Color By"] = "색상별"
L["Color by Remaining Time"] = "남은 시간에 따라 색상 표시"
...
L["Important Debuffs"] = "중요 디버프"
L["Boss/Role Debuffs"] = "우두머리/역할 디버프"
L["Priority Debuffs"] = "우선 디버프"
L["Raid-wide Debuffs"] = "공격대 전체 디버프"
L["Dispellable"] = "해제 가능"
L["Short Debuffs"] = "짧은 디버프"
L["Duration Limit"] = "지속시간 제한"
L["Max Seconds"] = "최대 초"
L["shortDebuffsTips"] = "블리자드가 위의 어떤 분류에도 넣지 않았고\n설정한 초 이하로 지속되는 NPC 디버프 (폭탄 표시 등).\n가장 앞에 최대 1개 표시됩니다.\n디버프 표시기에도 그대로 표시됩니다."
L["durationLimitTips"] = "설정한 초보다 오래 지속되거나 지속시간이 없는\n우두머리/역할 디버프와 우선 디버프는 여기에 표시되지 않습니다.\n군중제어기와 해제 가능한 디버프는 제한되지 않습니다.\n켜면 디버프 표시기가 모든 우두머리/역할 디버프와 우선 디버프를 표시합니다."
L["Current"] = "현재"
...
L["excludeImportant"] = "중요 디버프로 표시되는 디버프 숨기기"
L["bossBadge"] = "우두머리 디버프에 ! 표시"
L["bossBadgeTips"] = "우두머리/역할 디버프 아이콘마다|왼쪽 위에 검은 테두리의 작은 노란색 ! 표시를 붙입니다."
L["dispelBadge"] = "해제 가능한 디버프에 + 표시"
L["dispelBadgeTips"] = "현재 전문화로 해제할 수 있는 디버프는|오른쪽 위에 검은 테두리의 작은 흰색 + 표시가 붙습니다.|여기 표시되는 모든 분류에 적용됩니다."
L["Dispels"] = "해제"
...
L["Show Spell Tooltip"] = "주문 도움말 표시"
L["Show Solo"] = "솔로잉시 표시"
