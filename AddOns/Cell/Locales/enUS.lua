...
select(2, ...).L = setmetatable({
    ...
    ["Side"] = "Side",
    ["Reaction"] = "Reaction",
    ["IN_INSTANCES"] = "In dungeons and raids",
    ["tapped"] = "Tapped",
    ["hostile"] = "Hostile",
    ...
    ["PARTY_TARGETS_PANE_TIPS"] = "The target buttons follow the party frame: same order, same role sorting, same appearance. Left-click targets the unit, as on any other Cell frame. A member with no target has no button. They draw health and nothing else -- name, health, shield and the raid marker; no threat, no auras, no cooldowns, no power bar -- and colour the bar by reaction the way a nameplate does.",
