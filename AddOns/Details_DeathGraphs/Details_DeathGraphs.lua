...
advancedDeathLogs.tutorialTextSize = 13
advancedDeathLogs.tutorialWidgetsAlpha = 0.6
advancedDeathLogs.defaultTextSize = 14
	...
	if (event == "ADDON_LOADED") then
		...
		if (AddonName == "Details_DeathGraphs") then
			if (Details) then
				...
				local install, saveddata = _G.Details:InstallPlugin("TOOLBAR", "進階死亡紀錄", "Interface\\AddOns\\Details_DeathGraphs\\icon", adlObject, "DETAILS_PLUGIN_DEATH_GRAPHICS", MINIMAL_DETAILS_VERSION_REQUIRED, "Details! Team", adlObject.version_string, defaults)
