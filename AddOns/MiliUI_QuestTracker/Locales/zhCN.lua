...
L["This is the switch that hides the tracker during a Mythic+ run. WarpDeplete has its own \"hide the objective tracker\" option, off by default in this package — keep only one of the two on, or they will fight over the same fade."] = "M+ 期间藏列表就是这一条。WarpDeplete 也有自己的“隐藏任务追踪器”选项，套组里默认关；两边只能开一边，否则会抢同一个淡出。"
L["While folded"] = "折叠期间"
