...
local function BuildDefaults()
    return {
        ...
        automation = {
            ...
            --
            -- 大半是「至暗之夜」那組週任 —— 每一條都會秒接失敗。⚠ 不是只有那一組：
            -- 93598「征戰使節」同樣每次都失敗，卻不屬於那組，所以別拿「開頭是不是
            -- 至暗之夜」當收錄判準，判準只有一個：實測秒接接不到。
            -- 依 ID 排序方便比對與去重；名稱查 wowhead 的 hreflang zh-TW
            -- （⚠ 那邊的 slug 用「-」是網址編碼的關係，遊戲內是全形冒號，這裡照遊戲）。
            --   2026-08-30 第一批：93890 93910 93912 98232
            --   2026-09-05 第二批：93769 93913 95843
            --   2026-09-20 第三批：93598 93909 95842 96727
            slowQuests = {
                [93598] = true,   -- 征戰使節
                [93769] = true,   -- 至暗之夜：房屋系統
                [93890] = true,   -- 至暗之夜：豐足
                [93909] = true,   -- 至暗之夜：探究
                [93910] = true,   -- 至暗之夜：狩獵
                [93912] = true,   -- 至暗之夜：團隊副本
                [93913] = true,   -- 至暗之夜：世界首領
                [95842] = true,   -- 至暗之夜：虛無襲擊
                [95843] = true,   -- 至暗之夜：儀式地點
                [96727] = true,   -- 至暗之夜：異界決戰場
