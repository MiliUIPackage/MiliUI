...
header:SetText(ns.PREFIX_COLOR .. L["MiliUI Aura Enhance"] .. "|r")
...
instructions:SetText("|cffffffff" .. L["Use /maura to open options"] .. "|r")
...
local category = Settings.RegisterCanvasLayoutCategory(panel, L["MiliUI Aura Enhance"])
category.ID = L["MiliUI Aura Enhance"]
