...
L["Icon spacing"] = "图标间隔"
L["Spacing between the aura icons. This value takes over from the icon padding in Edit Mode's buff and debuff frame settings."] = "光环图标彼此的间距。这里的值会盖过编辑模式里增益／减益框的「图标间距」。"
