...
addon.L = {
	...
	["|cffFFE4E1[TinyTooltip]|r|cff00FFFF variables has been imported successfully. |r"] = "|cffFFE4E1[滑鼠提示增強]|r|cff00FFFF 設定檔匯入成功。|r",
	["|cffFFE4E1[TinyTooltip]|r|cffFF3333 unvalidated variables. |r"] = "|cffFFE4E1[滑鼠提示增強]|r|cffFF3333 不是有效的設定檔內容。|r",
