...
L["CHANNEL_SFX_DESC"] = "使用音效音量控制。嗜血音乐会跟随音效滑杆调整，若音效关闭或音量过低可能听不到。"
L["PREVIEW"] = "试听"
L["STOP_PREVIEW"] = "停止"
L["TRACK_ENABLED"] = "启用"
...
L["RESET_REMINDER_POSITION_DESC"] = "将提醒讯息移回倒数条上方"
...
L["REMINDER_TEST_DESC"] = "预览提醒效果（包含音效和语音）"
L["ADDON_TITLE_REMINDER"] = "嗜血/英勇提醒消息"
L["REMINDER_EDITMODE_TEXT"] = "嗜血可用！"
L["REMINDER_TTS"] = "启用语音朗读 (TTS)"
L["REMINDER_TTS_DESC"] = "出现提醒时，自动用文字转语音念出来"
L["REMINDER_TTS_VOICE"] = "TTS 语音声线"
L["REMINDER_TTS_VOICE_DESC"] = "选择朗读提醒文字的声音"
L["SELECT_SOUND"] = "选择音效"
