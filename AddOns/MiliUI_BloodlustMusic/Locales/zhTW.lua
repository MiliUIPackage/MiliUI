...
L["CHANNEL_SFX_DESC"] = "使用音效音量控制。嗜血音樂會跟隨音效滑桿調整，若音效關閉或音量過低可能聽不到。"
L["PREVIEW"] = "試聽"
L["STOP_PREVIEW"] = "停止"
L["TRACK_ENABLED"] = "啟用"
...
L["REMINDER_TEST_DESC"] = "預覽提醒效果（包含音效和語音）"
L["ADDON_TITLE_REMINDER"] = "嗜血/英勇提醒訊息"
L["REMINDER_EDITMODE_TEXT"] = "嗜血可用！"
L["REMINDER_TTS"] = "啟用語音朗讀 (TTS)"
L["REMINDER_TTS_DESC"] = "出現提醒時，自動用語音唸出文字"
L["REMINDER_TTS_VOICE"] = "TTS 語音聲線"
L["REMINDER_TTS_VOICE_DESC"] = "選擇朗讀提醒文字的聲音"
L["SELECT_SOUND"] = "選擇音效"
