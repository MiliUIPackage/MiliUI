...
L["SET_DBM_VOICE_DIALOG"] = "將 DBM 語音改成對話聲道"
L["SET_DBM_VOICE_DIALOG_DESC"] = "將 DBM 的警告語音頻道改為對話聲道，避免與嗜血音樂搶占主聲道"
L["MSG_DBM_VOICE_DIALOG_SET"] = "|cff00ff00嗜血音樂:|r 已將 DBM 語音頻道改為對話聲道"
L["MSG_DBM_NOT_LOADED"] = "|cffff0000嗜血音樂:|r DBM 尚未載入"
L["PREVIEW"] = "試聽"
L["STOP_PREVIEW"] = "停止"
L["TRACK_ENABLED"] = "啟用"
L["TRACK_ADD"] = "新增曲目"
L["TRACK_EDIT"] = "編輯曲目"
L["TRACK_EDIT_SHORT"] = "編輯"
L["TRACK_NAME"] = "顯示名稱"
L["TRACK_FILENAME"] = "檔案名稱"
L["TRACK_FILENAME_HINT"] = "將音樂檔 (.mp3 / .ogg) 放到資料夾：\nInterface\\AddOns\\MiliUI_BloodlustMusic\\Media\\\n然後在此只輸入檔名（例如 my_song.mp3）。按試聽驗證檔案是否可讀取。"
L["ADD_TRACK_HINT"] = "新增自訂曲目"
L["TRACK_DELETE_CONFIRM"] = "確定要刪除曲目「%s」嗎？"
L["MSG_PREVIEW_FAIL"] = "|cffff0000嗜血音樂:|r 播放失敗 — 請確認檔案是否存在於 Media 資料夾（新增檔案後可能需要 /reload 重新載入）。"
L["MSG_TRACK_NEED_FILENAME"] = "|cffff0000嗜血音樂:|r 請輸入檔案名稱。"
...
L["TAB_TRACKS"]       = "曲目"
L["TAB_ABOUT"]        = "關於"
L["TRACKS_DESC"]      = "勾選哪些曲目可以被播放。內建曲目只能停用，自己加的曲目可以編輯與刪除。"
L["CHANNEL_VOLUME"]   = "聲道音量"
L["SECTION_POSITION"] = "位置"
L["BAR_DRAG_HINT"]    = "倒數條在編輯模式（Esc > 編輯模式）裡拖曳。"
L["REMINDER_DRAG_HINT"] = "提醒訊息在編輯模式（Esc > 編輯模式）裡拖曳。"
L["VERSION_FORMAT"]   = "版本：%s"
L["OPEN_HINT"]        = "輸入 /blm 開啟設定"
L["BTN_OPEN_OPTIONS"] = "開啟設定"
L["ABOUT_SLASH"]      = "指令：|cffffd200/blm|r 開啟設定，|cffffd200/blm test|r 試播一首並顯示倒數條，|cffffd200/blm stop|r 停止播放。"
