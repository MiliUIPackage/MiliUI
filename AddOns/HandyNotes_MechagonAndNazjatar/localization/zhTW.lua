...
L["drill_rig"] = "需要鑽探機 ";
L["foul_manifest_note"] = "連接外圍電塔到水中電塔的電路，然後到旁邊山坡上找到開關通電就會出現。";
...
L["options_toggle_mech_chest"] = "機械箱"
L["options_toggle_mech_chest_desc"] = "顯示機械箱的位置。有10個獨特的箱子可以每天拾取一次，每個箱子有4-5個出現位置。 位置按顏色分組。"
L["options_toggle_locked_chest"] = "上鎖箱"
...
L["naz_intro_note"] = "完成入門任務串，解鎖納沙塔爾上的稀有、寶藏和世界任務。"
