...
--
-- ⚠ 跟 EUI 的差別（唯一一個我覺得比它好的架構決定）：
--   EUI 的 CreateDMWindow 是**單一 2300 行函式**，已經頂到 Lua 5.1 的 60 個
--   upvalue 上限——所以它的註解到處在寫「這個 helper 要從 ns 繞回來拿」。
--   這裡改成：工廠只負責建出 W（frame 樹＋池），實際的繪製／拖曳／展開／首頁
