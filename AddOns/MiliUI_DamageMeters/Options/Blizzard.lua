...
header:SetText(ns.PREFIX_COLOR .. L["MiliUI Damage Meters"] .. "|r")
...
instructions:SetText("|cffffffff" .. L["Use /mdm to open options"] .. "|r")
...
local category = Settings.RegisterCanvasLayoutCategory(panel, L["MiliUI Damage Meters"])
category.ID = L["MiliUI Damage Meters"]
