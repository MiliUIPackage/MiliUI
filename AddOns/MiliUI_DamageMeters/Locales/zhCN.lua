...
L["Heal"] = "治疗"
L["Melee"] = "近战"
L["Click to switch segments"] = "点击切换分段"
L["Smart display: Current in combat, Overall a few seconds after combat ends."] = "智能显示：战斗中看当前，脱战几秒后自动切到总计。"
L["Smart display: stays on Current in a raid."] = "智能显示：团队里一直看当前。"
L["Smart display is paused while you look at a past segment. Switch back to Current or Overall to resume."] = "正在看过去的分段，智能显示暂停；切回当前或总计就会恢复。"
L["Unknown"] = "未知"

-- 发布（Meter/Publish.lua）
L["Publish: %s - %s"] = "发布：%s － %s"
L["Party"] = "队伍"
L["Raid"] = "团队"
L["Instance"] = "副本队伍"
L["Guild"] = "公会"
...
L["%s - %s"] = "%s － %s"
L["(no data)"] = "（没有数据）"
L["Nothing to publish."] = "没有可以发布的数据。"
...
L["In combat this window shows Current; a few seconds after combat ends it switches to Overall. In a raid it stays on Current instead, since the overall there spans the whole night across many bosses. While you are reviewing a specific past segment it stays hands-off — it resumes when you switch back to Current or Overall yourself, or when you turn this option on again."] =
    "战斗中显示「当前」，脱离战斗几秒后自动切到「总计」（留一下让你看完最后的数字）。在团队里则一路保持「当前」，因为那里的总计是跨好几个首领的一整晚。翻看某个特定分段时它不会插手 —— 等你自己切回「当前」或「总计」，或重新打开这个选项，才恢复主动切换。"
