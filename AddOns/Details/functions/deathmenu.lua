...
--disable text
detailsOnDeathMenu.disableLabel = Details.gump:CreateLabel (detailsOnDeathMenu, Loc ["you can disable this at /details > Raid Tools"], 12)

detailsOnDeathMenu.warningLabel = Details.gump:CreateLabel (detailsOnDeathMenu, "", 14)
...
detailsOnDeathMenu.breakdownButton.CoolTip = {
	...
	BuildFunc = function()
		...
		GameCooltip2:AddLine (Loc ["- Interrupts and Dispells"])
