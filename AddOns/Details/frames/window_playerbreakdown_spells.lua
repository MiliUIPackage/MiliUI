	...
	if (mainAttribute == DETAILS_ATTRIBUTE_DAMAGE) then --this should run within the damage class ~damage
		...
		if (emporwerSpell) then
			...
			if (level1AverageDamage ~= "0") then
				blockLine2.leftText:SetText("等級1平均: " .. level1AverageDamage .. " (" .. (empowerAmountPerLevel[1] or 0) .. ")")
			end

			if (level2AverageDamage ~= "0") then
				blockLine2.centerText:SetText("等級2平均: " .. level2AverageDamage .. " (" .. (empowerAmountPerLevel[2] or 0) .. ")")
			end

			if (level3AverageDamage ~= "0") then
				blockLine2.rightText:SetText("等級3平均: " .. level3AverageDamage .. " (" .. (empowerAmountPerLevel[3] or 0) .. ")")
			end

			if (level4AverageDamage ~= "0") then
				blockLine3.leftText:SetText("等級4平均: " .. level4AverageDamage .. " (" .. (empowerAmountPerLevel[4] or 0) .. ")")
			end

			if (level5AverageDamage ~= "0") then
				blockLine3.rightText:SetText("等級5平均: " .. level5AverageDamage .. " (" .. (empowerAmountPerLevel[5] or 0) .. ")")
			end
		end
