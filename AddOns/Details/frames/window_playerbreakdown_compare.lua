...
local on_enter = function(self)
    ...
    frame1.tooltip:SetPoint("bottomleft", bar1[2], "topleft", -22, 5)
    frame2.tooltip:SetPoint("bottomleft", bar2[2], "topleft", -22, 5)
    frame3.tooltip:SetPoint("bottomleft", bar3[2], "topleft", -22, 5)
...
local compare_create = function(tab, frame)
    ...
    local create_bar = function(name, parent, index, main, is_target)
        ...
        local font = SharedMedia:Fetch ("font", "Arial Narrow")
        bar.righttext2:SetFont(font, 13)
...
--------------------------------------------
    ...
    noPLayersToShow:SetText("沒有更多玩家可比對 (使用相同職業/專精)")
