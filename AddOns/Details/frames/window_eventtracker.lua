...
function Details:OpenEventTrackerOptions (from_options_panel)
	...
	if (not _G.DetailsEventTrackerOptions) then
		...
		local f = DF:CreateSimplePanel(_G.UIParent, 700, 400, Loc ["Details! Event Tracker Options"], "DetailsEventTrackerOptions")
			...
			for i = 1, total_lines do
				...
				if (ability) then
					...
					elseif (ability [ABILITYTABLE_SPELLTYPE] == SPELLTYPE_CROWDCONTROL) then
						...
						line.RightText:SetText(targetName or Loc ["unknown target"])
