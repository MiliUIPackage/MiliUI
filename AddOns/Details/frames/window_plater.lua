...
function Details.OpenPlaterIntegrationWindow()
    if (not DetailsPlaterIntegrationPanel or not DetailsPlaterIntegrationPanel.Initialized) then
        ...
        local platerDesc1 = DF:CreateLabel (titleBackground, Loc ["Add DPS and Damage information directly into the nameplate"], 12, "silver")
        local platerDesc2 = DF:CreateLabel (titleBackground, Loc ["See how much damage the enemy is taking in real time!"], 12, "silver")
