...
--> Skins Page page 2
	...
	--SKINS
		...
		local changemind = g:NewLabel (window, _, "$parentChangeMind55Label", "changemind55Label", Loc ["STRING_WELCOME_2"], "GameFontNormal", 13, "orange")
...
--> numeral system page 3
		...
		g:NewLabel (window, _, "$parentChangeMindNumeralLabel", "changemindNumeralLabel", Loc ["STRING_WELCOME_2"], "GameFontNormal", 13, "orange")
...
--> page 4
	...
	-- DPS effective or active
		...
		g:NewLabel (window, _, "$parentChangeMind2Label", "changemind2Label", Loc ["STRING_WELCOME_2"], "GameFontNormal", 13, "orange")
...
--> page 4
	...
	-- UPDATE SPEED
		...
		g:NewLabel (window, _, "$parentChangeMind4Label", "changemind4Label", Loc ["STRING_WELCOME_11"], "GameFontNormal", 13, "orange")
