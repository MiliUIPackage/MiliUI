...
DF:CreateTitleBar (panel, Loc ["Details! Custom Line Text Editor"])
...
local apply_button = DF:NewButton (panel, nil, "$parentApply", nil, 80, 20, function() panel.callback(panel.editbox:GetText()) end, nil, nil, nil, Loc ["Apply"], 1) --localize-me
