...
function Details:OpenForge()
    ...
    if (not DetailsForgePanel or not DetailsForgePanel.Initialized) then
        ...
        if (not Details:GetTutorialCVar ("FORGE_TUTORIAL") and false) then
            ...
            tutorialFrame.Title = Details.gump:CreateLabel (tutorialFrame, L["STRING_FORGE_TUTORIAL_TITLE"], 14, "orange")
            tutorialFrame.Desc = Details.gump:CreateLabel (tutorialFrame, L["STRING_FORGE_TUTORIAL_DESC"], 14)
            tutorialFrame.Desc.width = 370
            tutorialFrame.Example = Details.gump:CreateLabel (tutorialFrame, L["STRING_FORGE_TUTORIAL_VIDEO"], 14)
        ...
        local all_spells_module = {
            ...
            header = {
                ...
                {name = L["Ignore"], width = 50, type = "checkbox", func = spell_ignore_spell_func, icon = [[Interface\Glues\LOGIN\Glues-CheckBox-Check]], notext = true, iconalign = "center"},
        ...
        local allNpcsModule = {
            ...
            filters_widgets = function()
                if (not DetailsForgeEncounterNpcIDsFilterPanel) then
                    ...
                    local filterSpellNameLabel = npcIdFrame:CreateFontString (nil, "overlay", "GameFontHighlight")
