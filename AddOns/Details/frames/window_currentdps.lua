...
function Details:OpenCurrentRealDPSOptions(from_options_panel)
	...
	if (not DetailsCurrentRealDPSOptions) then
		...
		local f = DF:CreateSimplePanel (UIParent, 700, 400, Loc ["Details! The Current Real DPS Options"], "DetailsCurrentRealDPSOptions")
...
function Details:CreateCurrentDpsFrame(parent, name)
	...
	--> title bar
		...
		TitleString:SetText (Loc ["Dps on Last 5 Seconds"])
