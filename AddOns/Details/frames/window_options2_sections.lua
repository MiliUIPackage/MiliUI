...
do
    ...
    --update micro displays
        ...
        do --micro displays
            ...
            DF:NewLabel(sectionFrame, _, "$parentMicroDisplayWarningLabel", "MicroDisplayWarningLabel", Loc ["STRING_OPTIONS_MICRODISPLAYS_WARNING"], "GameFontHighlight", 10, "orange")
			...
			if (not DetailsAnnounceSelectCooldownIgnored) then
				...
				function f:CreateLabel()
					local L = {
						...
						text = DF:CreateLabel(f, "", 10, "white", "GameFontHighlight"),
                    }
...
do
	...
	--consilidade spells
        ...
        _detalhes:SetFontSize(sectionFrame.ConsolidadeSpellsLabel, 13)
