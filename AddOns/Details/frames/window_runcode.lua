...
function Details:InitializeRunCodeWindow()
    local DetailsRunCodePanel = DF:CreateSimplePanel (UIParent, 700, 480, Loc ["Details! Run Code"], "DetailsRunCodePanel")
...
function Details.OpenRunCodeWindow()
    if (not DetailsRunCodePanel or not DetailsRunCodePanel.Initialized) then
        ...
        local f = DetailsRunCodePanel or DF:CreateSimplePanel (UIParent, 700, 480, Loc ["Details! Run Code"], "DetailsRunCodePanel")
        ...
        local code_type_label = DF:CreateLabel (f, Loc ["Event:"], DF:GetTemplate ("font", "ORANGE_FONT_TEMPLATE"))
        ...
        local save_script_button = DF:CreateButton (f, save_script, 120, 20, Loc ["Save"], -1, nil, nil, nil, nil, nil, DF:GetTemplate ("button", "OPTIONS_BUTTON_TEMPLATE"), DF:GetTemplate ("font", "PLATER_BUTTON"))
        ...
        local cancel_script = function()
            ...
            Details:Msg (Loc ["Code cancelled!"])
            code_editor:ClearFocus()
        end
        
        local cancel_script_button = DF:CreateButton (f, cancel_script, 120, 20, Loc ["Cancel"], -1, nil, nil, nil, nil, nil, DF:GetTemplate ("button", "OPTIONS_BUTTON_TEMPLATE"), DF:GetTemplate ("font", "PLATER_BUTTON"))
        ...
        local run_script_button = DF:CreateButton (f, execute_script, 120, 20, Loc ["Test Code"], -1, nil, nil, nil, nil, nil, DF:GetTemplate ("button", "OPTIONS_BUTTON_TEMPLATE"), DF:GetTemplate ("font", "PLATER_BUTTON"))
