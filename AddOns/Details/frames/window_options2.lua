...
function Details.options.InitializeOptionsWindow(instance)
	...
	f.Frame = f
	f.__name = Loc ["STRING_INTERFACE_OPENOPTIONS"]
    ...
    local instances_string = DF:NewLabel(f, nil, "$parentInstanceDropdownLabel", "instancetext", Loc ["STRING_OPTIONS_EDITINSTANCE"], "GameFontNormal", 14)
    ...
    local editingGroupLabel = DF:NewLabel(f, nil, "$parentEditingGroupLabel", "editingGroupLabel", Loc ["Editing Group:"], "GameFontNormal", 14) --localize-me
