...
function Details222.OptionsPanel.InitializeOptionsWindow(instance)
    ...
    local instances_string = detailsFramework:NewLabel(footerFrame, nil, "$parentInstanceDropdownLabel", "instancetext", Loc ["STRING_OPTIONS_EDITINSTANCE"], "GameFontNormal", 14)
    ...
    local editingGroupLabel = detailsFramework:NewLabel(footerFrame, nil, "$parentEditingGroupLabel", "editingGroupLabel", "編輯群組:", "GameFontNormal", 14) --localize-me
    ...
    --search field
        ...
        local searchLabel = detailsFramework:CreateLabel(footerFrame, "搜尋:") --localize-me
