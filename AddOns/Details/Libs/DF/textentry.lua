...
--scripts and hooks
	...
	function TextEntryMetaFunctions:SetAsSearchBox()
		...
		local searchFontString = self:CreateFontString(nil, "OVERLAY", "GameFontHighlight")
...
function detailsFramework:NewTextEntry(parent, container, name, member, width, height, func, param1, param2, space, withLabel, entryTemplate, labelTemplate)
	...
	newTextEntryObject.editbox:SetFontObject("GameFontHighlight")

	--editbox label
	newTextEntryObject.editbox.label = newTextEntryObject.editbox:CreateFontString("$parent_Desc", "OVERLAY", "GameFontHighlight")
...
function detailsFramework:NewSpecialLuaEditorEntry(parent, width, height, member, name, nointent, showLineNumbers, bNoName)
	...
	scrollframe.editbox:SetFontObject("GameFontHighlight")
	...
	if (showLineNumbers) then
		...
		scrollframeNumberLines.editbox:SetFontObject("GameFontHighlight")
