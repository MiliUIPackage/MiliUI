...
L["STRING_OPTIONS_ALIGNED_TEXT_COLUMNS_OFFSET"] = "文字 %d 偏移"
L["STRING_OPTIONS_ALIGNED_TEXT_COLUMNS_OFFSET_DESC"] = "從右邊框偏移"
L["STRING_OPTIONS_ALIGNED_TEXT_COLUMNS_WARNING"] = "已啟用，不使用分隔符和括號"
...
L["Clear icon file / Restore default"] = "清除圖示檔案/恢復成預設值"
...
L["Overall Segment Boss Only"] = "整場戰鬥記錄只有首領"
L["Only add boss segments on the overall."] = "只有首領的戰鬥記錄才會計算到整場裡面。"
L["Merge Trash"] = "合併清理小怪"
L["Delete Merged Trash Segments"] = "刪除合併的清理小怪記錄"
L["After have the segment merged, if this option is enabled it'll delete those merged segments."] = "啟用時，合併了清理小怪之後，會刪除這些已合併的戰鬥記錄。"
...
L["- Interrupts and Dispells"] = "- 斷法和驅散"
...
L["diagnostic mode has been turned off."] = "診斷模式已關閉。"
L["diagnostic mode has been turned on."] = "診斷模式已開啟。"
L["log for characters has been wiped."] = "角色記錄已清空。"
L["diagnostic for character "] = "診斷角色 "
L[" turned on."] = " 已開啟。"
L["|cFF22FF22good|r"] = "|cFF22FF22好|r"
L["|cFFFF2222bad|r"] = "|cFFFF2222壞|r"
L[" seconds ago)"] = " 秒前)"
L[": |cFF22FF22okay|r"] = ": |cFF22FF22確定|r"
L["|cFFFFFF22not visible|r"] = "|cFFFFFF22無法顯示|r"
L["|cFFFFFF22isn't the current combat object|r"] = "|cFFFFFF22不是目前戰鬥物件|r"
L[" window segment: "] = " 視窗戰鬥記錄: "
L["|cFFFF2222last update registered is > than 3 seconds, is there actors to show?|r"] = "|cFFFF2222最近登錄的更新大於 3 秒，是否有顯示玩家?|r"
L["|cFFFFFF22not found|r"] = "|cFFFFFF22無法找到|r"
