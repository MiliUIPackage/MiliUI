...
addon.hiddenOptions = {
	...
	["nameplateShowFriendlyNPCs"] = { prettyName = "友方 NPC", description = "總是顯示友方 NPC的名條。", type = "boolean" },
	...
	["nameplateMinScaleDistance"] = { prettyName = "名條最小縮放距離", description = "The distance from the max distance that nameplates will reach their minimum scale.", type = "number" },
	["nameplateMaxScaleDistance"] = { prettyName = "名條最大縮放距離", description = "The distance from the camera that nameplates will reach their maximum scale", type = "number" },
    ...
    ["chatClassColorOverride"] = { prettyName = "停用職業顏色", description = "在聊天中取消使用職業著色", type = "boolean" },
	-- Sound
	...
	["TargetPriorityPvp"] = { prettyName = nil, description = "在pvp中，給予玩家和重要的PVP目標更高的優先級 (2 = 全部pvp目標, 3 = 只有玩家)", type = "boolean" },
	...
	["violenceLevel"] = { prettyName = "血腥等級", description = "設置遊戲的血腥等級", type = "number" },
	...
	["alwaysCompareItems"] = { prettyName = "永遠比對物品", description = "永遠顯示物品的比對提示", type = "boolean" },
	...
	["WorldTextScale"] = { prettyName = "傷害數字大小", description = "遊戲世界中的傷害數字、獲得經驗值、神兵之力點數...等等的縮放大小。", type = "number" },
	...
	["audioLocale"] = { description = "設置遊戲音頻內容的語言區域" },
