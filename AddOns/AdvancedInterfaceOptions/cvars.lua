...
addon.hiddenOptions = {
	...
	["ShowQuestUnitCircles"] = { prettyName = "任務單位環", description = "確定與任務相關的單位是否在地面上顯示指示器", type = "boolean" },
	...
	["cursorsizepreferred"] = { prettyName = "鼠標大小", description = "0 = 32x32, 1 = 48x48, 2 = 64x64, -1 = 自動偵測", type = "number" },
	...
	["graphicsDepthEffects"] = { description = "圖形設置的介面數值" },
	["graphicsEnvironmentDetail"] = {},
	["graphicsLightingQuality"] = { description = "圖形設置的介面數值" },
	["graphicsLiquidDetail"] = { description = "圖形設置的介面數值" },
	["graphicsOutlineMode"] = { description = "圖形設置的介面數值" },
	["graphicsParticleDensity"] = {},
	["graphicsProjectedTextures"] = { description = "圖形設置的介面數值" },
	["graphicsQuality"] = {},
	["graphicsSSAO"] = { description = "圖形設置的介面數值" },
	["graphicsShadowQuality"] = {},
	["graphicsSunshafts"] = { description = "圖形設置的介面數值" },
