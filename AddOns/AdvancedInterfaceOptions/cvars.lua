...
addon.hiddenOptions = {
  ...
  ["UnitNameHostleNPC"] = { prettyName = "敵對NPC", description = "Display names for hostile NPCs", type = "boolean" },
  ["UnitNameInteractiveNPC"] = { prettyName = "互動NPC", description = "Display names for interactive NPCs", type = "boolean" },
  -- Nameplates
  ...
  ["nameplateShowFriendlyNPCs"] = { prettyName = "友方NPC", description = "Always show friendly NPC's nameplates", type = "boolean" },
  ...
  ["nameplateOverlapH"] = { prettyName = "名條重疊 (水平)", description = "Percentage amount for horizontal overlap of nameplates", type = "number" },
  ["nameplateOverlapV"] = { prettyName = "名條重疊 (垂直)", description = "Percentage amount for vertical overlap of nameplates", type = "number" },
  ["nameplateMaxDistance"] = { prettyName = "名條視野距離", description = "The max distance to show nameplates.", type = "number" },
  ...
  ["nameplateLargerScale"] = { prettyName = "大型名條縮放", description = "An additional scale modifier for important monsters.", type = "number" },
  ...
  ["nameplateResourceOnTarget"] = { prettyName = "目標名條資源", description = "Nameplate class resource overlay mode. 0=self, 1=target", type = "number" },
  ["nameplateShowSelf"] = { prettyName = "顯示名條資源條", description = "Display class resource bar. 0=off 1=on", type = "number" },
  ["nameplateShowAll"] = { prettyName = "永遠顯示名條", description = "Show nameplates at all times.", type = "number" },
  ["nameplateMotion"] = { prettyName = "名條動作類型", description = "0 = Overlapping - 1 = Stacking", type = "number" },
  ...
  ["ShowClassColorInFriendlyNameplate"] = { prettyName = "友方名條職業著色", description = "Class color for friendly nameplates", type = "boolean" },
  ...
  ["ShowQuestUnitCircles"] = { prettyName = "任務單位圓圈", description = "Determines if units related to a quest display an indicator on the ground", type = "boolean" },
  ...
  ["autoLootRate"] = { prettyName = "自動拾取速率", description = "Rate in milliseconds to tick auto loot", type = "number" },
  ...
  ["chatClassColorOverride"] = { prettyName = "停用職業著色", description = "Disables Class Colors in Chat", type = "boolean" },
  -- Sound
  ...
  ["noBuffDebuffFilterOnTarget"] = { prettyName = "不過濾目標的減益", description = "Do not filter buffs or debuffs at all on targets", type = "boolean" },
  ...
  ["smoothUnitPhasingVehicleExtraTimeoutMs"] = {
    description = "Extra time to wait before releasing a vehicle, after it has smooth phased. This allows it's passengers to smooth phase as well.",
  },
  ["spellBookSort"] = {},
  ...
  ["uiScale"] = {},
  ["uiScaleMultiplier"] = {
    description = "A multiplier for the default UI scale. -1=determine based on system/monitor DPI, 0.5-2.0=multiplier to use when calculating UI scale. Only applied when useUIScale is 0.",
  },
