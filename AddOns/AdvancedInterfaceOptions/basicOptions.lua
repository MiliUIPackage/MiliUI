...
actionCamModeLabel:SetText('選擇動態鏡頭模式:')
...
SubText_Chat:SetText('這些選想允許你改變不在預設UI中的聊天設定')
...
SubText_NP:SetText('這些選項讓你可以變更名條的選項。')
...
SubText_C:SetText('這些選項可以讓你變更戰鬥的選項。')
