...
local L = {}
L["1 aura group disabled"] = "1 光环组已禁用" -- Needs review
L["2D"] = "2D"
L["3D"] = "3D"
L["A"] = "A"
...
L["Add"] = "增加"
L["Add aura"] = "添加光环" -- Needs review
L["Add Aura"] = "添加光环" -- Needs review
L["Add Indicator"] = "添加指示器" -- Needs review
L["Add link"] = "添加链接" -- Needs review
L["Add new indicator"] = "添加新指示器" -- Needs review
...
L["Aggro"] = "获得仇恨"
L["All aura groups enabled for unit."] = "此单位所有光环都已启用" -- Needs review
L["All Auras"] = "所有光环" -- Needs review
...
L["Allows you to enter a new aura group."] = "允许你输入一个新的光环组" -- Needs review
...
L["Alternate Spell Name"] = "另一个法术名称" -- Needs review
L["Alternatively friendly spell to use to check range."] = "交替使用友方法术来检查距离." -- Needs review
...
L["Any auras shown in this indicator will have their total stack displayed."] = "在这个指示器里显示的光环将会显示它们总的叠加数" -- Needs review
L["Aquatic"] = "水栖"
L["Arena"] = "竞技场"
L["Arena Pet"] = "竞技场宠物"
L["Arenas"] = "竞技场"
L["Arena Spec"] = "竞技场规格" -- Needs review
L["Arena Target"] = "竞技场目标"
L["Arena Target of Target"] = "竞技场目标的目标" -- Needs review
L["Arena ToT"] = "竞技场ToT" -- Needs review
L["Are you sure you want to delete this aura?"] = "你确定要删除这个光环吗?" -- Needs review
L["Are you sure you want to delete this filter?"] = "你是否确定删除这个过滤器?"
L["Are you sure you want to delete this indicator?"] = "你确定要删除这个指示器吗?" -- Needs review
...
L["Aura group"] = "光环组" -- Needs review
L["Aura groups"] = "光环组" -- Needs review
L["Aura Groups"] = "光环组" -- Needs review
L["Aura indicators"] = "光环指示器" -- Needs review
L["Aura Indicators"] = "光环指示器" -- Needs review
L["Aura name"] = "光环名字"
L["Auras"] = "光环"
L["Auras matching a criteria will automatically show up in the indicator when enabled."] = "当启用后，满足条件的光环将自动显示在这个指示器中" -- Needs review
L["Aura types to filter"] = "要过滤的光环类型"
L["Automatic Auras"] = "自动光环" -- Needs review
L["B"] = "B"
L["Background"] = "背景"
...
L["Border color"] = "边框颜色"
L["Border coloring of stealable, curable and dispellable auras."] = "着色可偷取, 治愈和驱散的光环边框" -- Needs review
L["Border highlighting"] = "边框高亮"
L["Border thickness"] = "边框厚度"
L["Boss"] = "首领"
L["Boss Auras"] = "首领光环" -- Needs review
L["Boss Debuffs"] = "首领Debuffs" -- Needs review
L["Boss Target"] = "首领目标"
...
L["Channelling"] = "通道法术"
L["Checking this will show the indciator on hostile units."] = "选中此项将会在敌对单位上显示此指示器" -- Needs review
L["Checking this will show the indicator on friendly units."] = "选中此项将会在友好单位上显示此指示器" -- Needs review
...
L["Class Role"] = "职业角色" -- Needs review
L["Class (Smart)"] = "职业 (简洁)"
...
L["Cooldown rings for"] = "以下显示冷却动画" -- Needs review
L["Create"] = "创建"
...
L["Curable"] = "可治愈" -- Needs review
L["Curable Auras"] = "可治愈光环" -- Needs review
...
L["Current pet used by a battleground unit."] = "当前宠物使用一个战场单位" -- Needs review
...
L["Current target of a battleground unit."] = "战场单位的当前目标" -- Needs review
L["Current target of target of a battleground unit."] = "战场单位当前目标的目标" -- Needs review
...
L["Dark"] = "深色"
L["%d auras in group"] = "%d 在组里" -- Needs review
L["Dead"] = "死亡"
L["Debuffs"] = "Debuff"
...
L["Delete link"] = "删除链接" -- Needs review
L["Descending"] = "降序"
L["Disable Auras by Class"] = "禁用职业光环" -- Needs review
L["Disabled"] = "禁用"
L["Disabled for %s."] = "关于 %s 的已禁用" -- Needs review
...
L["Dismissable Totem bars"] = "图腾召唤条" -- Needs review
L["Dispellable/Stealable"] = "可驱散/偷取" -- Needs review
...
L["Due to the nature of fake units, cast bars for %s are not super efficient and can take at most 0.10 seconds to notice a change in cast."] = "由于伪造单位的性质,  %s 的施法条不是很高效, 提示施法的变化最短只能采集到0.10秒." -- Needs review
L["Edge size"] = "边角大小"
L["Editing %s"] = "正在编辑 %s"
L["Edit tag"] = "编辑标签"
L["Elite"] = "精英"
...
L["Enabled for %s."] = "关于 %s 的已启用" -- Needs review
L["Enabled in %s"] = "在 %s 中启用"
L["Enabled Units"] = "单位已启用" -- Needs review
L["Enable for friendlies"] = "为友好单位启用" -- Needs review
L["Enable for hostiles"] = "为敌对单位启用" -- Needs review
L["Enable frequent updates"] = "启用频繁刷新"
L["Enable indicator"] = "启用指示器"
L["Enable Indicators"] = "启用指示器" -- Needs review
L["Enable %s"] = "启用 %s"
...
L["Energy"] = "能量"
L["Enlarge auras for"] = "放大以下光环" -- Needs review
L["Error"] = "错误"
L["Events"] = "事件"
...
L["For configuring aura indicators on unit frames."] = "在单位框架上配置相关光环指示器" -- Needs review
...
L["Ghost"] = "灵魂"
L["Global"] = "全局"
L["Global configurating will let you mass enable or disable aura groups for multiple units at once."] = "全局配置将会让你同时为多个单位启用或禁用光环组" -- Needs review
...
L["Hides the power bar unless the class has mana."] = "没有法力值属性则隐藏能量条" -- Needs review
...
L["If multiple auras are shown in the same indicator, the higher priority one is shown first."] = "如果多个光环在同一个指示器中，将首先显示高优先级的" -- Needs review
L["If name is entered, it must be exact as it is case sensitive. Alternatively, you can use spell id instead."] = "已输入的名字必须是准确的一字不差的. 或者, 你可以使用法术ID来代替." -- Needs review
...
L["If you don't, you will be unable to use any combo point features (Chi, Holy Power, Combo Points, Aura Points, etc) until you do so."] = "如果你不这样做, 你将不允许使用任何连击点功能 (真气, 神圣能量, 连击点, 等等) 直到你这样做为止." -- Needs review
L["Import"] = "导入"
...
L["Index"] = "索引"
L["Indicator color"] = "指示器颜色" -- Needs review
L["Indicator name"] = "指示器名称" -- Needs review
L["Indicators"] = "指示器"
L["Indicator this aura should be displayed in."] = "这个光环指示器要显示在" -- Needs review
L["In range alpha"] = "在距离范围内透明度"
L["Inset"] = "插入"
L["Inside Bottom Left"] = "内部下方靠左" -- Needs review
L["Inside Bottom Right"] = "内部下方靠右" -- Needs review
...
L["Instead of showing a solid color inside the indicator, the icon of the aura will be shown."] = "在这个指示器将显示光环的图标而不是单纯的颜色." -- Needs review
L["Interrupted"] = "已打断"
...
L["Light"] = "明亮"
L["Link"] = "链接" -- Needs review
L["Linked spells"] = "已关联法术" -- Needs review
L["Link from"] = "关联自" -- Needs review
L["Link to"] = "关联到" -- Needs review
L["Lock frames"] = "锁定框体"
L["Locks the unit frame positionings hiding the mover boxes."] = "锁定框体位置."
L["Low health"] = "低生命值"
L["M"] = "M"
L["Main Assist"] = "主助理"
L["Main Assists's are set by the Blizzard Main Assist system or mods that use it."] = "主助理的设置是有暴雪主助理系统或它的MOD实现." -- Needs review
...
L["Name of a friendly spell to check range."] = "要检测距离的友好法术名称" -- Needs review
L["Neutral"] = "中立"
L["Never (Disabled)"] = "从不 (禁用)"
L["New aura group"] = "新光环组" -- Needs review
L["New filter"] = "新的过滤器"
L["None"] = "无"
L["None (Disabled)"] = "None (禁用)" -- Needs review
L["NPCs only"] = "仅NPC"
L["Offline"] = "离线"
...
L["On Friendly Units"] = "在友好单位上" -- Needs review
L["On Hostile Units"] = "在敌对单位上" -- Needs review
L["Only active this aura inside an indicator if the group member does not have the aura."] = "如果在组成员中没有这个光环, 则只会在一个指示器里激活" -- Needs review
L["Only auras you specifically cast will be shown."] = "将只会显示你特别施放的光环" -- Needs review
L["Only show if missing"] = "只会显示缺少的" -- Needs review
L["Only show self cast auras"] = "只会显示自己施放的光环" -- Needs review
L["Only show when mana"] = "只在有法力值时显示" -- Needs review
L["On mouseover"] = "在鼠标悬停"
L["On rare mobs"] = "在稀有目标上" -- Needs review
L["On %s units"] = "在 %s 单位" -- Needs review
L["Order"] = "顺序"
...
L["PvP Flags"] = "PvP标志" -- Needs review
L["PVP:%s"] = "PVP：%s"
L["PVP timer"] = "PVP 计时器"
...
L["Range Checker"] = "距离检测" -- Needs review
...
L["Right text"] = "右边文字"
L["Right Top"] = "右边顶部"
L["Role the unit is playing."] = "单位所担任的职责" -- Needs review
L["Row growth"] = "行增长方向"
L["Row offset"] = "行坐标"
L["Rune bar"] = "符文条"
...
L["%s aura groups disabled"] = "%s 光环组已禁用" -- Needs review
L["Scale"] = "缩放"
...
L["Show any other auras"] = "显示任何其他光环" -- Needs review
L["Show as bar"] = "显示为计量条"
L["Show aura duration"] = "显示光环持续时间" -- Needs review
L["Show aura icon"] = "显示光环图标" -- Needs review
L["Show auras stack"] = "显示光环叠加" -- Needs review
L["Show background"] = "显示背景"
L["Show boss debuffs"] = "显示首领debuffs" -- Needs review
L["Show buffs before debuffs when sharing the same anchor point."] = "当公用一个相同的锚点定位时, Buff 将显示在 Debuff 之前."
L["Show castable on other auras"] = "显示其它可施放光环" -- Needs review
L["Show casted by boss"] = "显示Boss施放的" -- Needs review
L["Show cast name"] = "显示施法名字"
L["Show cast rank"] = "显示施法等级"
L["Show cast time"] = "显示施法事件"
L["Show curable debuffs"] = "显示可被治愈的debuffs" -- Needs review
L["Show curable/removable auras"] = "显示可治愈/消除的光环" -- Needs review
...
L["Show inside"] = "显示在内部" -- Needs review
...
L["Shows a cooldown wheel on the indicator with how much time is left on the aura."] = "在指示器上显示一个旋转的指针提示还有多长时间结束冷却" -- Needs review
...
L["Shows debuffs cast by a boss."] = "显示Boss施放的debuffs" -- Needs review
L["Shows debuffs that you can cure."] = "显示你能够治愈的debuffs" -- Needs review
...
L["Show your auras"] = "显示你的光环" -- Needs review
...
L["%s member"] = "%s 成员"
L["Solid color to use in the indicator, only used if you do not have use aura icon enabled."] = "在指示器中使用单纯颜色, 仅作用于你没有启用显示光环图标选项" -- Needs review
L["Sorting"] = "分类"
L["Sort method"] = "分类方式"
L["Sort order"] = "分类顺序"
L["Soul shards"] = "灵魂碎片"
...
L["Spell ID %s"] = "法术ID %s" -- Needs review
L["Spell Name"] = "法术名称" -- Needs review
L["Spell Name/ID"] = "法术名称/ID" -- Needs review
L["Spell you want to link to a primary aura, the casing must be exact."] = "输入一个你想链接到的主要光环, 这个通道必须准确" -- Needs review
...
L["Stealable/Curable/Dispellable"] = "可偷取/治愈/驱散" -- Needs review
...
L["Talent spec of your arena opponents."] = "你的竞技场对手的天赋技能." -- Needs review
L["Target"] = "目标"
...
有助于你了解假如一个目标有 回春 , 但你也想知道这个 回春 是不是你施放的.]=] -- Needs review
...
L["Unchecking this will completely disable aura indicators for %s."] = "不选择此项将会完全禁用 %s 的光环指示器" -- Needs review
...
L["Units that should have the aura groups settings changed below."] = "单位将要改变的光环组设置如下." -- Needs review
L["Units to change"] = "单位变化" -- Needs review
...
L["View"] = "查看"
L["Visibility"] = "可见性"
L["WARNING! ShadowedUF_Indicators has been deprecated as v4 and is now built in. Please delete ShadowedUF_Indicators, your configuration will be saved."] = "警告! ShadowedUF_Indicators 组件已于v4版时弃用, 并已内建. 请删除 ShadowedUF_Indicators, 你的的配置将会保存." -- Needs review
...
L["What group this aura belongs to, this is where you will find it when configuring."] = "这个光环属于什么组, 当你设置的时候你会在这里找到它." -- Needs review
L["What type of auras should be enlarged, use the scaled aura size option to change the size."] = "什么类型的光环将会放大, 使用缩放光环尺寸选项去改变大小." -- Needs review
...
L["When to show cooldown rings on auras"] = "何时在光环上显示冷却动画" -- Needs review
...
L["Whether auras you casted should be shown"] = "是否显示你施放的光环" -- Needs review
L["Whether to show any auras casted by the boss"] = "是否要显示由Boss施放的任何光环" -- Needs review
L["Whether to show any debuffs you can remove, cure or steal."] = "是否要显示任何你可以消除, 治愈或偷取的debuffs." -- Needs review
L["Whether to show auras that do not fall into the above categories."] = "是否要显示不属于上述类别的光环." -- Needs review
L["Whether to show buffs that you cannot cast."] = "是否要显示你无法施放的buffs." -- Needs review
L["Whitelist"] = "白名单"
...
L["You can disable aura filters and groups for units here. For example, you could set an aura group that shows DPS debuffs to only show on the target."] = "在这里你可以禁用光环过滤器和组. 例如, 你可以设置一个光环组只显示目标身上的debuffs" -- Needs review
...
L["You can link auras together using this, for example you can link Mark of the Wild to Gift of the Wild so if the player has Mark of the Wild but not Gift of the Wild, it will still show Mark of the Wild as if they had Gift of the Wild."] = "你可以连接到一起使用这个光环, 例如你能链接 野性印记 到 野性赐福 ,那么如果玩家有 野性印记 但没有 野性赐福, 它仍然会把 野性印记 显示为就像拥有 野性赐福 一样." -- Needs review
...
L["You can override what aura is enabled on a per-class basis, note that if the aura is disabled through the main listing, then your class settings here will not matter."] = "在每个职业上你可以覆盖已启用的光环设置, 提醒, 如果光环是通过主列表选项禁用的, 那么在这里你的职业设置不受影响." -- Needs review
...
L["You must restart Shadowed Unit Frames."] = "你必须重启Shadowed Unit Frames." -- Needs review
...
L["Your aura color"] = "你的光环颜色" -- Needs review
L["Your Auras"] = "你的光环" -- Needs review
