...
local L = {}
L["1 aura group disabled"] = "1組光環禁用" -- Needs review
L["2D"] = "2D"
L["3D"] = "3D"
L["A"] = "A"
...
L["Absolute damage absorption value on the unit, if 10,000 damage will be absorbed, it will show 10,000."] = "在單位上顯示傷害吸收的絕對值，如果10000的傷害被吸收，將會顯示為10000。" -- Needs review
L["Absolute heal absorb value, if 16,000 healing will be absorbed, it will show 16,000."] = "治療量吸收絕對值, 如果16000的治療量被吸收, 顯示為16000." -- Needs review
L["Absolute incoming heal value, if 10,000 healing is incoming it will show 10,000."] = "顯示完整的治療量，如10,000治療量則顯示為10,000。"
L["Add"] = "新增"
L["Add aura"] = "添加光環" -- Needs review
L["Add Aura"] = "添加光環" -- Needs review
L["Add Indicator"] = "添加標記" -- Needs review
L["Add link"] = "添加連結" -- Needs review
L["Add new indicator"] = "添加新標記" -- Needs review
L["Add new tag"] = "新增新標籤"
...
L["Adds a bar indicating how much time is left on your Rune of Power."] = "新增狀態條在你的符文能量剩餘多少時間。" -- Needs review
...
L["Adds a bar inside the health bar indicating how much healing will be absorbed and not applied to the player."] = "在生命條裡增加一條用於顯示有多少治療量被吸收而沒有作用於玩家身上." -- Needs review
...
L["Adds a Stagger bar for Brewmaster Monks."] = "為釀酒武僧增加一個醉仙緩勁條(Stagger bar)" -- Needs review
...
L["Aggro"] = "獲得仇恨"
L["All aura groups enabled for unit."] = "啟用此單位所有光環" -- Needs review
L["All Auras"] = "所有光環" -- Needs review
L["Allows you to anchor the aura group to another, you can then choose where it will be anchored using the position.|n|nUse this if you want to duplicate the default ui style where buffs and debuffs are separate groups."] = "允許你定位錨點光環組到另一個, 然後可以選擇要使用的錨點位置.|n|n你可以使用這個來複製那些在Buff和Debuff在不同分組的默認UI樣式." -- Needs review
L["Allows you to disable the totem by right clicking it.|n|nWarning: Inner bars for this unit will not resize in combat if you enable this."] = "允許你通過右擊它禁用圖騰.|n|n警告：本單位內的項目條將不會在戰鬥中調整，如果你啟用這個功能。" -- Needs review
L["Allows you to enter a new aura group."] = "允許你建立一個新的光環組" -- Needs review
...
L["Alternate Spell Name"] = "備用的法術名稱" -- Needs review
L["Alternatively friendly spell to use to check range."] = "另外的友方法術用來檢查範圍。" -- Needs review
L["Alt. Power"] = "特殊能量" -- Needs review
...
L["Amount of power missing,  if none is missing nothing is shown. Uses a short format, -13850 is shown as 13.8k, values below 10000 are formatted as is."] = "缺損能量值的總數，如果沒有損失則不顯示。使用簡化格式-13850顯示為-13.8k，低於10000的能量值則不簡化。" -- Needs review
L["Anchor point"] = "定位處"
L["Anchor to"] = "定位到"
L["Anchor to another frame"] = "定位到其他框架"
L["Anchor to buffs"] = "定位到增益"
L["Anchor to debuffs"] = "定位到減益"
L["Ancient Kings bar"] = "遠古諸王條(聖能條)Ancient Kings bar" -- Needs review
L["Any auras shown in this indicator will have their total stack displayed."] = "在這個標記裡顯示的光環將會顯示它們總的疊加數" -- Needs review
L["Aquatic"] = "水棲"
L["Arcane Charges"] = "祕法充能"
L["Arena"] = "競技場"
L["Arena Pet"] = "競技場寵物"
L["Arenas"] = "競技場"
L["Arena Spec"] = "競技場專精" -- Needs review
L["Arena Target"] = "競技場目標"
L["Arena Target of Target"] = "競技場目標的目標" -- Needs review
L["Arena ToT"] = "競技場 ToT" -- Needs review
L["Are you sure you want to delete this aura?"] = "你確定要刪除這光環?" -- Needs review
L["Are you sure you want to delete this filter?"] = "你確定你要刪除這個篩選?"
L["Are you sure you want to delete this indicator?"] = "你確定要刪除這標記?" -- Needs review
...
L["Aura filters"] = "光環篩選"
L["Aura Filters"] = "光環過濾器" -- Needs review
L["Aura group"] = "光環組" -- Needs review
L["Aura groups"] = "光環組" -- Needs review
L["Aura Groups"] = "光環組" -- Needs review
L["Aura indicators"] = "光環標記" -- Needs review
L["Aura Indicators"] = "光環標記" -- Needs review
L["Aura name"] = "光環名稱"
L["Auras"] = "光環"
L["Auras matching a criteria will automatically show up in the indicator when enabled."] = "當啟用後，滿足條件的光環將自動顯示在這個標記中" -- Needs review
L["Aura types to filter"] = "篩選光環類型"
L["Automatic Auras"] = "自動光環" -- Needs review
L["B"] = "B"
L["Background"] = "背景"
L["Background alpha"] = "背景透明度"
L["Background/border"] = "背景/邊框"
L["Background color"] = "背景着色"
L["Bag indicator for master looters."] = "拾取分配者的背包標記。" -- Needs review
L["Bar alpha"] = "計量調透明度"
L["Bar color to use to show how much healing someone is about to receive."] = "條顏色用來顯示某人收到了多少的治療。" -- Needs review
L["Bars"] = "計量條"
L["Bar spacing"] = "計量條間隔"
L["Bars with an order higher or lower than the full size options will use the entire unit frame width.|n|nBar orders between those two numbers are shown next to the portrait."] = "項目條順序高於或低於全尺寸選項會使用整個單位框架的寬度. |n|n條顯示在兩個數字之間的頭像旁." -- Needs review
L["Bar texture"] = "背景材質"
L["Battleground"] = "戰場"
L["Battleground Pet"] = "戰場寵物"
L["Battlegrounds"] = "戰場"
L["Battleground Target"] = "戰場目標"
L["Battleground Target of Target"] = "戰場目標的目標" -- Needs review
L["Bear"] = "巨熊"
L["BG"] = "戰場" -- Needs review
L["BG Pet"] = "戰場寵物" -- Needs review
L["BG Target"] = "戰場目標" -- Needs review
L["BG ToT"] = "戰場 ToT" -- Needs review
L["Blacklist"] = "黑名單"
...
L["Border color"] = "邊框顏色"
L["Border coloring of stealable, curable and dispellable auras."] = "著色可偷取、可治愈和可驅散的可處理光環邊框" -- Needs review
L["Border highlighting"] = "邊框高亮"
L["Border thickness"] = "邊框厚度"
L["Boss"] = "首領"
L["Boss Auras"] = "首領光環" -- Needs review
L["Boss Debuffs"] = "首領減益(Debuff)" -- Needs review
L["Boss Target"] = "首領目標"
L["Boss Target of Target"] = "首領目標的目標" -- Needs review
L["Boss ToT"] = "首領 ToT" -- Needs review
...
L["Bottom Left"] = "底部左邊"
L["Bottom Right"] = "底部右邊"
L["buff frames"] = "增益效果" -- Needs review
L["Buffs"] = "增益"
L["C"] = "C"
...
L["Changes this widget into a bar, you will be able to change the height and ordering like you can change health and power bars."] = "變更這個小設定到計量條，你可以像修改生命條和能量值那樣修改高度和排列。" -- Needs review
L["Channelling"] = "引導性"
L["Checking this will show the indciator on hostile units."] = "顯示敵對單位標記" -- Needs review
L["Checking this will show the indicator on friendly units."] = "此項將會檢查並在友好單位上顯示標記" -- Needs review
L["Chi"] = "氣"
...
L["Class Role"] = "職業角色類型" -- Needs review
L["Class (Smart)"] = "職業 (智能)"
L["Class Specific"] = "職業限定"
L["Class Timer"] = "職業計時器" -- Needs review
L["Clip"] = "內間距"
L["Close color"] = "關閉着色"
...
L["Color to use to show how much healing will e absorbed."] = "用顏色顯示多少治療量會被吸收" -- Needs review
...
L["Cooldown rings for"] = "冷卻動畫作用於" -- Needs review
L["Create"] = "建立"
...
L["Crown indicator for group leader or assistants."] = "為團長或團隊助理顯示一個皇冠標記。" -- Needs review
L["Curable"] = "可治療的" -- Needs review
L["Curable Auras"] = "可治療光環" -- Needs review
L["Cur/Max HP (Absolute)"] = "當前/最大生命值(完整)"
L["Cur/Max HP (Short)"] = "當前/最大生命值(簡化)"
L["Cur/Max HP (Smart)"] = "當前/最大生命值(智能)"
L["Cur/Max power (Absolute)"] = "當前/最大能量值(完整)" -- Needs review
L["Cur/Max power (Druid)"] = "當前/最大能量值(德魯伊)" -- Needs review
L["Cur/Max Power (Short)"] = "當前/最大能量值(簡化)" -- Needs review
L["Cur/Max PP (Smart)"] = "當前/最大能量值(智能)" -- Needs review
...
L["Current and maximum power, formatted as [curpp]/[maxpp]."] = "當前和最大能量值，格式為[curhp]/[maxhp]。" -- Needs review
...
L["Current pet used by a battleground unit."] = "當前寵物框架將應用到戰場單位" -- Needs review
L["Current power (Absolute)"] = "當前能量值(完整)" -- Needs review
L["Current power (Druid)"] = "當前能量值(德魯伊)" -- Needs review
L["Current power (Druid/Absolute)"] = "當前能量值(德魯伊/完整)" -- Needs review
L["Current Power (Short)"] = "當前能量值(簡化)" -- Needs review
L["Current power, uses a short format, 12750 is formatted as 12.7k, values below 10000 are formatted as is."] = "當前能量值，使用簡化格式12750顯示為12.7k，低於10000的能量值則不簡化。" -- Needs review
L["Current target of a battleground unit."] = "戰場單位的當前目標" -- Needs review
L["Current target of target of a battleground unit."] = "戰場單位的當前目標的目標" -- Needs review
L["Damage absorption (Absolute)"] = "吸收傷害(絕對值)" -- Needs review
L["Damage absorption/Name"] = "吸收傷害/名字" -- Needs review
L["Damage absorption (Short)"] = "吸收傷害(縮寫)" -- Needs review
L["Dark"] = "暗色"
L["%d auras in group"] = "%d 組光環" -- Needs review
L["Dead"] = "死亡"
L["Debuffs"] = "減益"
...
L["Delete link"] = "刪除連結" -- Needs review
L["Descending"] = "遞減"
L["Disable Auras by Class"] = "禁用職業光環" -- Needs review
L["Disabled"] = "已停用"
L["Disabled for %s."] = "已禁用%s" -- Needs review
...
L["Dismissable Totem bars"] = "可解除(Dismissable)圖騰列" -- Needs review
L["Dispellable/Stealable"] = "可驅散/可偷取" -- Needs review
L["Display"] = "顯示" -- Needs review
L["DND"] = "勿擾"
L["DND:%s"] = "勿擾:%s"
...
L["Due to the nature of fake units, cast bars for %s are not super efficient and can take at most 0.10 seconds to notice a change in cast."] = "由於假單位的性質，%s的施法條不是超級有效率，最多只能注意到0.10秒施法的改變。" -- Needs review
L["Edge size"] = "邊緣大小"
L["Editing %s"] = "正在編輯%s"
L["Edit tag"] = "編輯標籤"
L["Elite"] = "精英"
...
L["Enabled for %s."] = "啟用於 %s" -- Needs review
L["Enabled in %s"] = "在%s已啟用"
L["Enabled Units"] = "啟用單位" -- Needs review
L["Enable for friendlies"] = "啟用於友方單位" -- Needs review
L["Enable for hostiles"] = "啟用於敵方單位" -- Needs review
L["Enable frequent updates"] = "啟用刷新頻率"
L["Enable indicator"] = "啟用標記"
L["Enable Indicators"] = "啟用標記" -- Needs review
L["Enable %s"] = "啟用%s"
...
L["Energy"] = "能量"
L["Enlarge auras for"] = "放大光環於" -- Needs review
L["Error"] = "錯誤"
L["Events"] = "事件"
...
L["Focus Target"] = "專注目標"
L["Font"] = "字型"
L["Food"] = "食物" -- Needs review
L["Forces a static color to be used for the background of all bars"] = "為所有計量條的背景使用固定顏色"
L["For configuring aura indicators on unit frames."] = "在單位框架上配置相關光環標記" -- Needs review
...
L["Ghost"] = "靈魂"
L["Global"] = "總體"
L["Global configurating will let you mass enable or disable aura groups for multiple units at once."] = "全局設定將會讓你同時為大量單位啟用或禁用光環組" -- Needs review
...
L["Has Aggro"] = "引起仇恨"
L["Heal absorb"] = "吸收治療" -- Needs review
L["Heal Absorb (Absolute)"] = "吸收治療(完整值)" -- Needs review
L["Heal absorbs"] = "吸收治療" -- Needs review
L["Heal Absorb (Short)"] = "吸收治療(縮寫)" -- Needs review
L["Healing absorb"] = "吸收治療" -- Needs review
L["Health"] = "生命值"
L["Health bar"] = "生命條"
...
L["Height"] = "高"
L["Help"] = "說明" -- Needs review
L["Hide bar when empty"] = "當計量條為空時隱藏"
L["Hide Blizzard"] = "隱藏遊戲內建框架" -- Needs review
...
L["Hides the power bar unless the class has mana."] = "隱藏能量條除非此職業有法力。" -- Needs review
...
L["High health"] = "高生命值"
L["Highlight"] = "高亮"
L["Highlight units that are "] = "高亮單位是" -- Needs review
L["Highlight units that are debuffed with something you can cure."] = "高亮你可以消除減益的單位。"
L["Highlight units that are rare."] = "高亮稀有單位。" -- Needs review
...
L["How many seconds a totem has left before disappearing."] = "在圖騰消失前還剩幾秒。" -- Needs review
L["How many seconds before a rune recharges."] = "在符文充能前還有幾秒。" -- Needs review
L["How many seconds between updates.|n[WARNING] By setting the frequency to 0 it will update every single frame redraw, if you want to disable frequent updating uncheck it don't set this to 0."] = "需要多少秒更新。|n[警告]通過設定頻率為0，它會更新重繪每個幀頻，如果你想禁止頻密的更新，取消這選項並且不要設置為0。" -- Needs review
...
L["Icon Size"] = "圖示尺寸"
L["If multiple auras are shown in the same indicator, the higher priority one is shown first."] = "如果同時多個光環顯示在一個標記中，將顯示優先度的第一的" -- Needs review
L["If name is entered, it must be exact as it is case sensitive. Alternatively, you can use spell id instead."] = "如果已名字輸入的必須是準確到一字不差(如果使用法術英文名稱更必需大階小階都符合)。或者你可以使用法術ID來代替。" -- Needs review
L["If the unit has a damage absorption shield on them, it will show the absolute absorb value, otherwise the units name."] = "如果單位擁有傷害吸收護盾，它會顯示吸收的絕對值，否則顯示單位名稱。" -- Needs review
...
L["If you don't, you will be unable to use any combo point features (Chi, Holy Power, Combo Points, Aura Points, etc) until you do so."] = "如果你不這樣做，你將無法使用任何連擊點數功能 (氣、聖能、連擊點、光環點..等等) 直到你這樣做。" -- Needs review
L["Import"] = "匯入"
...
L["Index"] = "索引"
L["Indicator color"] = "標記顏色" -- Needs review
L["Indicator name"] = "標記名稱" -- Needs review
L["Indicators"] = "標記"
L["Indicator this aura should be displayed in."] = "這個光環標記要顯示在" -- Needs review
L["In range alpha"] = "在距離內的透明度"
L["Insanity"] = "瘋狂"
L["Inset"] = "插入"
L["Inside Bottom Left"] = "内部靠左下方" -- Needs review
L["Inside Bottom Right"] = "内部靠右下方" -- Needs review
...
L["Instead of showing a solid color inside the indicator, the icon of the aura will be shown."] = "這個標記將顯示光環的圖標而不是單純的顏色。" -- Needs review
L["Interrupted"] = "已中斷"
...
L["Leader / Assist"] = "團長/助理" -- Needs review
L["Left"] = "左邊"
L["Left Bottom"] = "左邊底部"
L["Left Center"] = "左邊居中"
L["Left text"] = "左邊文字"
...
L["Light"] = "亮度"
L["Link"] = "連結" -- Needs review
L["Linked spells"] = "已連結法術" -- Needs review
L["Link from"] = "連結從" -- Needs review
L["Link to"] = "連結至" -- Needs review
L["Lock frames"] = "鎖定框架"
...
L["Maelstrom"] = "氣旋"
L["Main Assist"] = "主助攻"
L["Main Assists's are set by the Blizzard Main Assist system or mods that use it."] = "主助攻的設置是由暴雪主助理系統或由修改自它來實現。" -- Needs review
L["Main Assist Target"] = "主助攻目標"
L["Main Assist Target of Target"] = "主助攻目標的目標" -- Needs review
L["Main Tank"] = "主坦克"
L["Main Tank's are set through the Raid frames, or through selecting the Tank role."] = "主坦克設定是通過團隊介面，或者通過選擇坦克角色設定。" -- Needs review
L["Main Tank Target"] = "主坦克目標"
L["Main Tank Target of Target"] = "主坦克目標的目標" -- Needs review
L["Male"] = "男性"
L["Mana"] = "法力"
L["Manage Aura Filters"] = "管理光環篩選" -- Needs review
L["Management"] = "管理"
L["Manual position"] = "手動位置"
L["Master Looter"] = "隊長分配"
L["MA ToT"] = "主助攻 ToT" -- Needs review
L["Max columns"] = "最大列數量"
...
L["Max power (Absolute)"] = "最大能量值(完整)" -- Needs review
L["Max power (Short)"] = "最大能量值(簡化)" -- Needs review
L["Max power, uses a short format, 16000 is formatted as 16k, values below 10000 are formatted as is."] = "最大能量值，使用簡化格式16000顯示為16k，低於10000的能量值則不簡化。" -- Needs review
L["Max rows"] = "最大行數"
L["Medium"] = "中"
L["Minion"] = "爪牙" -- Needs review
L["Miscellaneous"] = "雜項"
L["Missing HP (Short)"] = "生命損失值(簡化)"
L["Missing power (Short)"] = "能量損失值(簡化)" -- Needs review
L["Monochrome Outline"] = "單色描邊" -- Needs review
L["Moonkin"] = "梟獸"
...
L["Name of a friendly spell to check range."] = "友方法術的名稱以檢查距離。" -- Needs review
L["Neutral"] = "中立"
L["Never (Disabled)"] = "從不(停用)"
L["New aura group"] = "新的光環組" -- Needs review
L["New filter"] = "新篩選"
L["None"] = "無"
L["None (Disabled)"] = "無 (停用)" -- Needs review
L["NPCs only"] = "僅NPC"
L["Offline"] = "離線"
...
L["On elite mobs"] = "在精英目標上" -- Needs review
L["On Friendly Units"] = "在友方單位" -- Needs review
L["On Hostile Units"] = "在敵方單位" -- Needs review
L["Only active this aura inside an indicator if the group member does not have the aura."] = "標記只有在該隊員沒有此光環情況下生效" -- Needs review
L["Only auras you specifically cast will be shown."] = "只顯示你特定的施放光環。" -- Needs review
L["Only show if missing"] = "只會顯示缺少的" -- Needs review
L["Only show self cast auras"] = "只顯示自己施放的光環" -- Needs review
L["Only show when mana"] = "只在有法力時才顯示" -- Needs review
L["On mouseover"] = "在鼠標懸停"
L["On rare mobs"] = "在稀有目標上" -- Needs review
L["On %s units"] = "在%s單位" -- Needs review
L["Order"] = "排列"
...
L["Party Pet"] = "隊伍寵物"
L["Party Target"] = "隊伍目標"
L["Party Target of Target"] = "隊伍目標的目標" -- Needs review
L["Party ToT"] = "隊伍ToT" -- Needs review
L["Percentage of width the portrait should use."] = "頭像使用的寬度百分比。"
L["Percentage value of how far outside the unit frame the absorbed health bar can go. 130% means it will go 30% outside the frame, 100% means it will not go outside."] = "允許治療吸收條跑出單位框架的百分率。130%表示會跑出單位框架30％，100％表示不會跑出框架。" -- Needs review
L["Percentage value of how far outside the unit frame the incoming absorb bar can go. 130% means it will go 30% outside the frame, 100% means it will not go outside."] = "百分比數值顯示超多少頭像框架的吸收傷害條。 130%就是說會超出框架的30%。 100%就是說不會超出。" -- Needs review
...
L["Percent power"] = "百分比能量值" -- Needs review
L["Per column"] = "每欄"
L["Per row"] = "每行"
L["Pet"] = "寵物"
L["Pet Battle"] = "寵物戰鬥"
L["Pet Target"] = "寵物目標"
L["Player"] = "玩家"
L["player alt. power"] = "玩家特殊能量" -- Needs review
...
L["Position"] = "位置"
L["Positioning"] = "定位" -- Needs review
L["Power"] = "綜合能量" -- Needs review
L["Power bar"] = "綜合能量條" -- Needs review
L["Power Type"] = "能量類型"
...
L["Returns current power as a percentage."] = "顯示當前能量值百分比。" -- Needs review
...
L["Returns the color code for the units threat situation in general: Red for Aggro, Orange for High threat and Yellow to watch out.|nThis cannot be used on target of target or focus target types of units."] = "顯示單位的仇恨值的顏色代碼:紅色成為仇恨目標, 橘紅色為高仇恨, 黃色為小心仇恨.|n這個不能被用作目標的目標或焦點的目標等類型單位." -- Needs review
...
L["Right text"] = "右邊文字"
L["Right Top"] = "右邊頂部"
L["Role the unit is playing."] = "單位扮演的角色。" -- Needs review
L["Row growth"] = "行增長方向"
L["Row offset"] = "行坐標"
L["Rune bar"] = "符文條"
...
L["Runes"] = "符文"
L["Rune Timer"] = "符文計時器" -- Needs review
L["Runic Power"] = "符能"
...
L["%s aura groups disabled"] = "%s 光環組禁用" -- Needs review
L["Scale"] = "比例"
L["Scaled aura size"] = "縮放光環尺寸" -- Needs review
...
L["Select the units that you want to modify, any settings changed will change every unit you selected. If you want to anchor or change raid/party unit specific settings you will need to do that through their options.|n|nShift click a unit to select all/unselect all."] = "選擇你想要更改的單位, 任何設置的改變都會改變你已選擇的單位. 如果你想要錨點定位或修改團隊/小隊單位的特定設置你需要通過他們的選項的實現.|n|nShift +點擊一個單位來選擇全部或反選全部." -- Needs review
L["Separate raid frames"] = "獨立團隊框架"
L["Set Filter Zones"] = "設置篩選區" -- Needs review
L["Sex"] = "性別"
L["%s frames"] = "%s框架"
L["Shadow Orbs"] = "暗影寶珠"
L["Shaman mana bar"] = "薩滿法力條"
L["Short classification"] = "簡化職業類別"
L["Short classifications, R for Rare, R+ for Rare Elite, + for Elite, B for Boss or M for Minion nothing is shown if they aren't any of those."] = "怪物分類簡稱，稀有為R,稀有精英為R +,精英為+,首領為B,爪牙為M,不包含在這些當中的什麼都不顯示。" -- Needs review
L["Short elite indicator"] = "簡化精英標記"
L["Shorten damage absorption, if 13,000 damage will e absorbed, it will show 13k."] = "縮寫傷害吸收，如果13,000的傷害被吸收，將會顯示為13K。" -- Needs review
L["Shorten heal absorb value, if 17,000 healing will be absorbed, it will show 17k."] = "簡化治療吸收值，如果17000的治療量被吸收，則顯示為17K。" -- Needs review
L["Shorten incoming heal value, if 13,000 healing is incoming it will show 13k."] = "縮寫治療量，如13,000治療量顯示為13k。" -- Needs review
...
L["Show any other auras"] = "顯示任何其他光環" -- Needs review
L["Show as bar"] = "計量條中顯示"
L["Show aura duration"] = "顯示光環持續時間" -- Needs review
L["Show aura icon"] = "顯示光環圖示" -- Needs review
L["Show auras stack"] = "顯示光環疊加" -- Needs review
L["Show background"] = "顯示背景"
L["Show boss debuffs"] = "顯示Boss Debuff (減益)" -- Needs review
L["Show buffs before debuffs when sharing the same anchor point."] = "當定位在相同錨點時，增益顯示在減益前面。"
L["Show castable on other auras"] = "顯示可施放的其他光環" -- Needs review
L["Show casted by boss"] = "顯示boss的施法" -- Needs review
L["Show cast name"] = "顯示施法名稱"
L["Show cast rank"] = "顯示施法等級"
L["Show cast time"] = "顯示施法時間"
L["Show curable debuffs"] = "顯示可被治療的Debuffs (減益)" -- Needs review
L["Show curable/removable auras"] = "顯示可治療/可驅散的光環" -- Needs review
L["Show Heal Absorbs"] = "顯示治療吸收值" -- Needs review
L["Show icon durations"] = "顯示圖示持續時間" -- Needs review
L["Show incoming absorbs"] = "顯示受到的吸收" -- Needs review
L["Show incoming heals"] = "顯示受到的治療"
L["Show inside"] = "顯示在內部" -- Needs review
L["Show party as raid"] = "團隊中顯示隊伍"
L["Show player in party"] = "隊伍中顯示玩家"
L["Shows a bar for alternate power info (used in some encounters)"] = "顯示替代的能量條資訊(在某些遭遇中使用)" -- Needs review
L["Shows a cooldown wheel on the indicator with how much time is left on the aura."] = "於標記上顯示冷卻輪提示還有多長時間光環結束冷卻" -- Needs review
...
L["Shows current and maximum power in absolute form, 18000 power will be showed as 18000 power."] = "顯示完整當前和最大能量值，18000的能量值顯示為18000。" -- Needs review
...
L["Shows current power value in absolute form, 15000 power will be displayed as 1500 still."] = "顯示完整當前能量值，15000的能量值顯示為15000。" -- Needs review
L["Shows debuffs cast by a boss."] = "顯示由Boss施放的Debuff(減益)" -- Needs review
L["Shows debuffs that you can cure."] = "顯示你能夠治愈的Debuff(減益)" -- Needs review
L["Shows how long an unit has been AFK or DND."] = "顯示單位暫離或勿擾多久。"
L["Shows how long an unit has been offline."] = "顯示單位離線多久。"
L["Shows how long until your PVP flag drops, will not show if the flag is manually on or you are in a hostile zone.|n|nThis will only work for yourself, you cannot use it to see the time left on your party or raid."] = "顯示PVP標記消失的時間, 不會在手動開啟PVP或在一個敵對區域中顯示.|n|n這個僅對你自身有效, 你不能使用他來查看你的小隊或團隊的PVP標記消失時間." -- Needs review
L["Shows maximum health in absolute form, 14000 health is showed as 14000 health."] = "顯示完整最大生命值，14000生命值顯示為14000。"
L["Shows maximum power in absolute form, 13000 power is showed as 13000 power."] = "顯示完整最大能量值，143000能量值顯示為13000。" -- Needs review
...
L["Shows the absolute staggered damage, if 16,000 damage is staggered, shows 16,000."] = "顯示醉拳化解傷害的絕對值，如果化解了16000的傷害，顯示為16000。" -- Needs review
L["Shows the current staggered damage, if 12,000 damage is staggered, shows 12k."] = "顯示醉拳當前化解的傷害，如果化解了12000的傷害，顯示為12k 。" -- Needs review
...
L["Show your auras"] = "顯示你的光環" -- Needs review
...
L["%s member"] = "%s成員"
L["Solid color to use in the indicator, only used if you do not have use aura icon enabled."] = "使用純色標記，僅作用於你沒有啟用顯示光環圖示選項" -- Needs review
L["Sorting"] = "分類"
L["Sort method"] = "分類方式"
L["Sort order"] = "分類排列"
L["Soul shards"] = "靈魂碎片"
...
L["Spell Name"] = "法術名稱"
L["Spell Name/ID"] = "法術 名稱/ID" -- Needs review
L["Spell you want to link to a primary aura, the casing must be exact."] = "法術將會要連結到主光環，必須準確無誤" -- Needs review
L["Splits raid frames into individual frames for each raid group instead of one single frame.|nNOTE! You cannot drag each group frame individualy, but how they grow is set through the column and row growth options."] = "為每個團隊隊伍分割團隊框體到單獨的框體.|n請注意! 你不能拖曳單獨的每個隊伍框體, 但可以通過在行和列增長選項中設置他們的增長方向." -- Needs review
L["%s (%s): %s/%s (%.2f%% done)"] = "%s (%s): %s/%s (%.2f%% 已完成)"
L["Stagger"] = "醉仙緩勁" -- Needs review
L["Stagger bar"] = "醉仙緩勁條" -- Needs review
L["Stagger bar color when the staggered amount is <30% of your HP."] = "當你的生命值<30%時,醉仙緩勁條的顏色" -- Needs review
L["Stagger bar color when the staggered amount is >30% of your HP."] = "當你的生命值>30%時,醉仙緩勁條的顏色" -- Needs review
L["Stagger bar color when the staggered amount is >70% of your HP."] = "當你的生命值>70%時,醉仙緩勁條的顏色" -- Needs review
L["Stagger (Monk)"] = "醉仙緩勁 (武僧)" -- Needs review
L["Stagger (Monk/Absolute)"] = "醉仙緩勁 (武僧/絕對值)" -- Needs review
L["Static"] = "休息"
L["Statue"] = "雕像"
L["Statue bar"] = "雕像條"
L["Status"] = "狀態"
L["Status indicator, shows if the unit is currently in combat. For the player it will also show if you are rested."] = "狀態標記，如果單位目前戰鬥中時顯示。如果你已重置也會被顯示。" -- Needs review
L["Stealable/Curable/Dispellable"] = "可偷取/可治療/可驅散" -- Needs review
...
L["Talent spec of your arena opponents."] = "競技場上你的對手專精配置" -- Needs review
L["Target"] = "目標"
...
L["The unit frames you see are examples, they are not perfect and do not show all the data they normally would.|n|nYou can hide them by locking them through /shadowuf or clicking the button below."] = "你看到的頭像僅是例子, 他們不是那麼完美並且不會顯示應該顯示的所有數據.|n|n你可以通過命令行/shadowuf或點擊下面的按鈕鎖定來隱藏他們." -- Needs review
...
有助於你了解如一個目標有回春術，但你也想知道這個回春術是不是你施放的。]=] -- Needs review
...
L["This is a good guide on how to get started with programming in Lua, while you do not need to read the entire thing it is a helpful for understanding the basics of Lua syntax and API's."] = "這是一份如何開始 Lua 程式設計的很好的指南，只是你並不需要閱讀所有部分，它有助於理解 Lua 的語法和 API 的基礎知識。" -- Needs review
...
L["Tile size"] = "標題大小"
L["Timer Text"] = "計時器文字" -- Needs review
L["Top"] = "頂部"
L["Top Center"] = "頂部居中"
L["Top Left"] = "頂部靠左"
L["Top Right"] = "頂部靠右"
...
L["Totem bar"] = "圖騰條"
L["Totem Timer"] = "圖騰計時器" -- Needs review
L["Travel"] = "旅行"
L["Tree"] = "樹"
L["Turns this widget into a bar that can be resized and ordered just like health and power bars."] = "改變這個計量條組件的比重，可以調整排列就像生命條和能量值一樣。" -- Needs review
L["Unattackable hostile"] = "不可攻擊的敵對單位"
L["Unchecking this will completely disable aura indicators for %s."] = "不選擇此項光環標記將會完全禁用於%s" -- Needs review
L["Unit color code on aggro"] = "獲得仇恨的單位顏色代碼"
L["Unit colored situation"] = "單位着色情況"
L["Unit Configuration"] = "單位設置" -- Needs review
L["Unit faction"] = "單位陣營"
L["Unit name"] = "單位名稱"
...
L["Units classification, Rare, Rare Elite, Elite, Boss or Minion nothing is shown if they aren't any of those."] = "單位分類：稀有,稀有精英,精英,首領或爪牙,不包含在這些當中的什麼都不顯示。" -- Needs review
L["Unit server"] = "單位伺服器"
...
L["Units that should have the aura groups settings changed below."] = "單位光環組設定將會如下更變。" -- Needs review
L["Units to change"] = "改變單位" -- Needs review
L["Unknown"] = "未知"
L["Unlink frames"] = "脫離框架"
L["Up"] = "上"
L["Update interval"] = "刷新間隔"
L["Uses the icon of the totem being shown instead of a status bar."] = "使用圖騰圖標顯示代替狀態條。" -- Needs review
...
L["View"] = "查看"
L["Visibility"] = "可見性"
L["WARNING! ShadowedUF_Indicators has been deprecated as v4 and is now built in. Please delete ShadowedUF_Indicators, your configuration will be saved."] = "警告!ShadowedUF_Indicators組件已於V4版時停用，並已內建。請刪除ShadowedUF_Indicators，你的設定將會繼續保留。" -- Needs review
...
L["What group this aura belongs to, this is where you will find it when configuring."] = "這個光環是屬於什麼組，當你設置的時候你會在這裡找到它" -- Needs review
L["What type of auras should be enlarged, use the scaled aura size option to change the size."] = "什麼類型的光環應放大，使用縮放光環尺寸選項來改變大小。" -- Needs review
...
L["When to show cooldown rings on auras"] = "何時在光環上顯示冷卻動態" -- Needs review
...
L["Whether auras you casted should be shown"] = "無論是否你已施放的光環都會顯示" -- Needs review
L["Whether to show any auras casted by the boss"] = "是否要顯示由Boss施放的任何光環" -- Needs review
L["Whether to show any debuffs you can remove, cure or steal."] = "是否要顯示任何你可以驅散，治療或偷取的Debuff(減益)。" -- Needs review
L["Whether to show auras that do not fall into the above categories."] = "是否顯示不屬於上述類別的光環。" -- Needs review
L["Whether to show buffs that you cannot cast."] = "是否要顯示你無法施放的buff(增益)。" -- Needs review
L["Whitelist"] = "白名單"
...
L["Widget Size"] = "模組(Widget)大小" -- Needs review
L["Width"] = "寬"
...
L["You can disable aura filters and groups for units here. For example, you could set an aura group that shows DPS debuffs to only show on the target."] = "在這裡你可以禁用光環篩選器和光環組。例如，您可以設置顯示目標光環組只顯示 DPS 的 Debuff(減益)。" -- Needs review
L["You can find more information on creating your own custom tags in the \"Help\" tab above."] = "在上面的 \"說明\" 標籤頁中可以找到更多關於建立自訂標籤的資訊。" -- Needs review
L["You can find more information on creating your own custom tags in the \"Help\" tab above.|nSUF will attempt to automatically detect what events your tag will need, so you do not generally need to fill out the events field."] = "在上面的 \"說明\" 標籤頁中可以找到更多關於建立你自己的自訂標籤的資訊。|nSUF 將會嘗試自動去偵測你的標籤會需要哪些事件，所以通常不用填寫事件欄位。" -- Needs review
...
L["You can override what aura is enabled on a per-class basis, note that if the aura is disabled through the main listing, then your class settings here will not matter."] = "您可以覆蓋每個職業上已啟用的光環設置，注意!，如果光環是通過主列表選項禁用的，那麼在這裡你的職業設置亦不受影響。" -- Needs review
...
L["You must restart Shadowed Unit Frames."] = "你必須重新啟動 Shadowed Unit Frames。" -- Needs review
...
L["Your aura color"] = "你的光環顏色" -- Needs review
L["Your Auras"] = "你的光環" -- Needs review
