...
L["Amount of power missing,  if none is missing nothing is shown. Uses a short format, -13850 is shown as 13.8k, values below 10000 are formatted as is."] = "Значение убывания энергии, если энергия полная, ничего не отображается. Используется формат сокращения, -13850 отображается как 13.8k, значения ниже 10000 не форматируются." -- Needs review
...
L["Hiding and showing various aspects of the default UI such as the player buff frames."] = "Скрывает и показывает различные аспекты стандартного интерфейса, такие как фрейм баффов игрока." -- Needs review
L["High"] = "Высокий"
...
L["If the unit has a damage absorption shield on them, it will show the absolute absorb value, otherwise the units name."] = "Если на юнита наложен щит поглощения урона, то будет показываться абсолютное значение, в противном случае - имя юнита" -- Needs review
...
L["Inset"] = "Вставить"
L["Inside Center"] = "Внутри в центре" -- Needs review
L["Inside Center Left"] = "Внутри от центра влево" -- Needs review
L["Inside Center Right"] = "Внутри от центра вправо" -- Needs review
L["Inside Top Left"] = "Внутри вверху слева"
L["Inside Top Right"] = "Внутри верху справа"
L["Instead of showing a solid color inside the indicator, the icon of the aura will be shown."] = "Вместо отображения сплошного цвета внутри индикатора будет отображаться значок ауры." -- Needs review
...
L["Show cast time"] = "Показать время применения" -- Needs review
