	...
	local defaults={
		...
		player={
			...
			hpbar={
                ...
                barcolormethod="class", bgcolormethod="classreaction", bgalpha=0,
                baralpha = 0.8,
                framelevel = 4,
                inc = true,
                border=  "Square Outline",
		...
		targettarget={
			...
			hpbar={
                x=0, y=0, w=120, h=20,
                barcolormethod="classreaction", bgcolormethod="classreactiondark", bgalpha=1,
                bartexture = "TukTex",
                border=  "Square Outline",
                bordercolor = {r=0, g=0, b=0, a=1, },
            },
		...
		focus={
			frame={ x=450, y=-170, w=120, h=30, },
			portrait={ x=0, y=0, w=24, h=24, show3d=nil, hide=true, },
			hpbar={ 
                x=0, y=0, w=120, h=20, barcolormethod="hpgreen", bgcolormethod="hpgreendark", bgalpha=1, 
                bartexture = "TukTex",
                border=  "Square Outline",
                bordercolor = {r=0, g=0, b=0, a=1, },
            },
			...
			text1={ 
				pattern="[name]", 
				x=0, y=0, w=120, h=12, 
                fontsize=12, justifyH="CENTER", justifyV="TOP", shadowx=-1, shadowy=-1,
                fontflags="OUTLINE",      
			},
			text2={ 
				hide=true, pattern="[level] [class:creaturetype]", 
		...
		focustarget={
			frame={ x=575, y=-170, w=50, h=12, },
			portrait={ x=0, y=0, w=12, h=12, hide=true, },
			hpbar={ 
				x=0, y=0, w=50, h=9, 
                barcolormethod="hpgreen", bgcolormethod="hpgreendark", bgalpha=1, 
                bartexture = "TukTex",
                border=  "Square Outline",
                bordercolor = {r=0, g=0, b=0, a=1, },
			},
			...
			text1={ hide=true, pattern="[name]", x=12, y=0, w=24, h=12, },
			text2={ 
				pattern="[perchp]%", 
				x=0, y=0, w=50, h=12, 
                fontsize=10, justifyH="CENTER", justifyV="CENTER",
		...
		pet={
			...
			hpbar={
                x=0, y=0, w=120, h=40,
                baralpha=0.8,
                barcolormethod="classreaction", bgcolormethod="classreactiondark", bgalpha=0,
                bartexture = "TukTex",
                border=  "Square Outline",
                bordercolor = {r=0, g=0, b=0, a=1, },
                framelevel = 4,
            ...
            mpbar={
                x=0, y=-40, w=120, h=10,
                barcolormethod="class", bgcolormethod="classreactiondark", bgalpha=1,
                bartexture = "TukTex",
                border=  "Square Outline",
                bordercolor = {r=0, g=0, b=0, a=1, },
            },
			text1={ 
				pattern="[name]", 
				x=3, y=-3, w=120, h=12, 
				fontsize=13, justifyH="LEFT", justifyV="TOP", shadowx=-1, shadowy=-1,
                framelevel = 5,
                fontflags="OUTLINE",                                
			},
			text2={ 
			...
			text3={ 
				pattern="[perchp]%", 
				x=0, y=15, w=120, h=40, 
				fontsize=12, justifyH="RIGHT", justifyV="BOTTOM", 
                framelevel = 5,
                fontflags="OUTLINE",                                
			},
			text4={ 
				pattern="[curmp]/[maxmp]", 
				x=0, y=0, w=120, h=50, 
				fontsize=10, justifyH="CENTER", justifyV="BOTTOM", 
                framelevel = 11,
                fontflags="OUTLINE",                                
			},
			text5={
                pattern="[curhp]/[maxhp]",
                x=-1, y=2, w=120, h=40, fontsize=10, justifyH="RIGHT", justifyV="BOTTOM",
                framelevel = 5,
                fontflags="OUTLINE",                                
                fontcolor = {r=0.851, g=0.851, b=0.851, a=1, },
            },
			text6={ 
				pattern="[gray_if_dead:死亡]",
				x=0, y=-2, w=120, h=40,
				fontsize=10, justifyH="CENTER", justifyV="BOTTOM",
                framelevel = 5,
                fontflags="OUTLINE",                      
			...
			buffgroup={
                x=0, y=-52, w=20, h=20, count=12, rows=2, cols=6,
            },
			debuffgroup={ 
                x=0, y=5, w=20, h=20, count=12, rows=2, cols=6,
                growth = "LRBT"
			...
			pettime={
                x=0, y=-2, w=120, h=10, fontsize=10, shadowx=0, shadowy=0,
                fontflags="OUTLINE",
			    justifyH = "RIGHT",
                fontcolor = {a=1, b=0.518, g=0.373, r=1},
            },
		},
		party1={ 
			...
			hpbar={
                ...
                barcolormethod="classdark", bgcolormethod="class", bgalpha=1,
                bartexture = "TukTex",
                border=  "Square Outline",
                bordercolor = {r=0, g=0, b=0, a=1, },
			},
			...
			text3={ 
				pattern="[perchp]%", 
				x=0, y=-1, w=250, h=20, 
                fontsize=14, justifyH="RIGHT", justifyV="CENTER", 
                fontflags="OUTLINE",                                
                framelevel = 5,
			},
			text4={ 
			...
			text5={
                pattern="[percmp]%", x=0, y=-22, w=250, h=10, fontsize=10, justifyH="RIGHT", justifyV="BOTTOM",
                fontflags="OUTLINE",                                
                framelevel = 5,
            },
			text6={ 
				pattern="[gray_if_oor:超出距離][gray_if_dead:死亡][gray_if_ghost:鬼魂][gray_if_offline:離線]",
				x=0, y=-15, w=250, h=10,
                fontsize=10, justifyH="CENTER", justifyV="CENTER",
                fontflags="OUTLINE",                                
                framelevel = 7,
		...
		party2={ frame={ x=16, y=-120, }, },
		party3={ frame={ x=16, y=-210, }, },
		party4={ frame={ x=16, y=-300, }, },
		pettarget={ 
			frame={ hide=true, x=188, y=-88, w=120, h=30, },
			portrait={ x=0, y=0, w=12, h=12, hide=true, },
			hpbar={ 
				x=0, y=0, w=120, h=20, 
                barcolormethod="classreactiondark", bgcolormethod="classreaction", bgalpha=1, 
                border="Square Outline", 
                bordercolor = {r=0,g=0,b=0,a=1,},
			},
			mpbar={ 
		...
		party2target={ frame={ x=280, y=-120, }, },
		party3target={ frame={ x=280, y=-210, }, },
		party4target={ frame={ x=280, y=-300, }, },
		partypet1={ 
