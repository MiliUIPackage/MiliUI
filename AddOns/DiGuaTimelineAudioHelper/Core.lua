...
function GenerateAllSpecsCodeBlock(unitTarget)
    ...
    C_Timer.After(0.5, function()
        ...
        print(" -> 副本訊息(副本名/ID):", instName, instanceID)
        ...
        local spellTargetCodeStr = rawTargetName and "            and UnitSpellTargetName(unitTarget) -- 法術有目標" or "            and not UnitSpellTargetName(unitTarget) -- 法術没目標"
        ...
        print("            and UnitClassification(unitTarget) == \"" .. classification .. "\" -- 分類")
        print("            and UnitAffectingCombat(unitTarget) == " .. tostring(inCombat) .. " -- 是否在戰鬥中")
        
        if className ~= "NONE" then
            print("            and select(2, UnitClass(unitTarget)) == \"" .. className .. "\" -- 職業")
        end
...
frame:SetScript("OnEvent", function(self, event, ...)
    ...
    elseif event == "UNIT_SPELLCAST_START" then
        ...
        if isAttackableNameplate -- 可怖尖啸
            ...
            and not UnitSpellTargetName(unitTarget) then
            PlaySoundFile(MEDIA_PATH .. "ZhunBeiAOE.ogg", DiGuaTimelineAudioHelper.audioChannel)
            CustomEncounterBar(132372, 28, "準備AOE") end
            ...
            if select(8, GetInstanceInfo()) == 2915 then -- 节点希纳斯
                ...
                if actualLevel == NEXT_PLAYER_LEVEL and unitPowerType == 0 and sex == 2 and currentEncounterID == 0 then
                    ...
                    if targetName then
                        ...
                        CustomEncounterBar(135934, 21, "躲開頭前")
                    end                        
                    return
                end
            end                
            ...
            if UNIT_COMBAT_START_TIMES[unitTarget] == nil then
                if select(8, GetInstanceInfo()) == 2915 then -- 节点希纳斯
                    ...
                    if actualLevel == NEXT_PLAYER_LEVEL and unitPowerType == 0 and sex == 2 and currentEncounterID == 0 then
                        ...
                        CustomEncounterBar(135934, 18, "躲開頭前") -- 荧光闪耀
