...
local SHOW_RULES = {
    ...
    {
        name = "釘鎚風暴 虛空光束 瘋狂尖嘯",
        instanceIDs = { [2923] = true },  -- 虛空之痕競技場
        bossProgress = { [1] = true },   -- 2 號 Boss 還沒打
        maxDuration = 7,                -- 這條規則只關心「總時長 ≦7 秒」的短 debuff
    },

    {
        name = "虛無噴發 釘鎚風暴 虛空光束 瘋狂尖嘯",
        instanceIDs = { [2923] = true },  -- 虛空之痕競技場
        bossProgress = { [2] = true },   -- 2 號 Boss 還沒打
        maxDuration = 7,                -- 這條規則只關心「總時長 ≦7 秒」的短 debuff
    },
