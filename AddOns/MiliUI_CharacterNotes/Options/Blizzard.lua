...
header:SetText(ns.PREFIX_COLOR .. L["MiliUI Character Notes"] .. "|r")
...
instructions:SetText("|cffffffff" .. L["Use /mnote to open the notebook"] .. "|r")
...
local category = Settings.RegisterCanvasLayoutCategory(panel, L["MiliUI Character Notes"])
category.ID = L["MiliUI Character Notes"]
