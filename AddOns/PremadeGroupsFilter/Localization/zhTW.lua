...
L["settings.missingRoles.title"] = "顯示缺少角色類型"
L["settings.missingRoles.tooltip"] = "在預組隊伍列表中顯示每個空位的角色職責圖示。"
...
L["settings.rioRatingColors.tooltip"] = "如果已載入Raider.IO插件，則使用Raider.IO的配色方案進行傳奇+評分。"
