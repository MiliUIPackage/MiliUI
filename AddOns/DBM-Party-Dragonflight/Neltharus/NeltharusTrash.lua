...
mod:SetRevision("20230630121306")
...
local timerMagmaFistCD						= mod:NewCDTimer(25.4, 372311, nil, nil, nil, 3)
local timerBrutalStrikeCD					= mod:NewCDTimer(15.7, 378847, nil, "Tank|Healer", nil, 3)
