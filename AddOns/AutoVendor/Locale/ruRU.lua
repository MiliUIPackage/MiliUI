...
L['Sell low level description'] = 'Sell soulbound items below a certain level (see below). Useful when farming old content. Only works when player is level 100 or above.'
