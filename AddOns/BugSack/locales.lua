...
elseif locale == "zhTW" then
	...
	L.minimapHint = "|cffeda55f點擊|r開啟BugSack最後錯誤訊息。|cffeda55fShift-點擊|r重新載入使用者介面。 |cffeda55f右鍵點擊|r 開啟選項。"
	...
	L["altWipeDesc"] = "允許ALT鍵點擊小地圖圖示清除所有儲存的錯誤。 "
	L["Auto popup"] = "自動彈出"
	...
	L["Minimap icon alt-click wipe"] = "小地圖圖示ALT鍵點擊清除"
	...
	L["Quick tips"] = "快速提示"
	L["quickTipsDesc"] = "|cff44ff44雙擊|r來過濾錯誤報告。完成搜索結果後，通過選擇底部的標籤頁返回。|cff44ff44左鍵點擊|r並且拖拉來移動視窗。|cff44ff44右鍵點擊|r來關閉此袋並開啟BugSack的界面選項。"
	L["Wipe saved bugs"] = "清除儲存的錯誤"
	L["wipeDesc"] = "清除資料庫中所有儲存的錯誤。"
	L["X-Large"] = "超大"
	L["You have no bugs, yay!"] = "你沒有發生錯誤。\\^o^//"
	L["You've received %d bugs from %s."] = "從 %s 收到%d個錯誤。"
	L.useMaster = "使用'主要'聲音頻道"
	L.useMasterDesc = "在“主要”聲音頻道上播放所選的錯誤音效而不是預設頻道。"
	L["BugSack"] = "錯誤訊息"
	L.addonCompartment = "插件集存圖示"
	L.addonCompartment_desc = "在'插件集存'中建立BugSack的選單入口。"
end
