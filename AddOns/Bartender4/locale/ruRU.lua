...
L["Hide this bar when a override bar is active."] = "Скрыть эту панель, когда переопределенная панель активна."
...
L["Hide with Override Bar"] = "Скрыть с переопределенной панелью"
...
L["Its simple! Just check the Keyring option in the BagBars configuration menu, and it'll appear next to your bags."] = "Это просто! Просто проверьте параметр Keyring в меню конфигурации BagBars, и он появится рядом с сумками."
...
L["Mouse-Over Casting"] = "Применение заклинания наведением мышки"
L["Mouse-Over casting can be limited to be only active when a modifier key is being held down. You can configure the modifier in the global \"Bar\" Options."] = "Применение заклинания наведением мышки может быть ограничено, чтобы активироваться, только когда клавиша-модификатор удерживается нажатой. Вы можете настроить модификатор в глобальных настройках панели."
L["Mouse-Over Casting Modifier"] = "Модификатор Применения заклинания наведением мышки"
...
L["Rows"] = "Строки"
L["Scale"] = "Масштаб"
L["Select a modifier for Mouse-Over Casting"] = "Выберите модификатор для Применения заклинания наведением мышки"
