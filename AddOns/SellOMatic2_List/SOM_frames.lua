...
function fram:CreateAddWindow()
	...
	addFrame.SaveButton = CreateFrame("Button",nil,addFrame,"OptionsButtonTemplate");
	addFrame.SaveButton:SetPoint("CENTER",addFrame,"BOTTOM",0,55);
	addFrame.SaveButton:SetHeight(20)
	addFrame.SaveButton:SetWidth(150)
	addFrame.SaveButton:SetText(L["Save all inventory"])
	addFrame.SaveButton:SetScript("OnClick", function()
		SellOMatic:SaveInventory()
	end)
