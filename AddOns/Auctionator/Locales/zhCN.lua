...
L["CONFIG_SHOPPING_LIST_EXCLUDE_RESULTS_FOR_SPEED"] = "忽略不在当前搜索页面的结果"
L["CONFIG_SHOPPING_LIST_EXCLUDE_RESULTS_FOR_SPEED_TOOLTIP_HEADER"] = "速度排除结果"
L["CONFIG_SHOPPING_LIST_EXCLUDE_RESULTS_FOR_SPEED_TOOLTIP_TEXT"] = "忽略不在第一页上的结果可能会导致不出现一些昂贵的物品。价格历史和搜索记录的数据将不准确"
