...
-- New Vars
--- Globals
AUCTIONATOR_SELL_TAB_TEXT = "賣出"
AUCTIONATOR_AUCTION_DURATION = "預設拍賣時間"
AUCTIONATOR_DEFAULT_AUCTIONATOR_TAB = "預設拍賣場標籤頁面"
AUCTIONATOR_MINIMUM_QUALITY_LEVEL = "最低品質等級:"
AUCTIONATOR_MEMORY_USAGE = "拍賣小幫手記憶體使用量"
AUCTIONATOR_ITEMS_IN_THE_DATABASE = "資料庫中的物品:"
AUCTIONATOR_DELETE_HISTORICAL_PRICES = "啟動時刪除歷史價格，超過:"
AUCTIONATOR_DELETE_HISTORICAL_PRICES_DAYS = "天"
AUCTIONATOR_CLEAR_SCANNING_HISTORY_BTN = "清空掃描歷史記錄"
AUCTIONATOR_CLEAR_POSTING_HISTORY_BTN = "清空張貼歷史記錄"
AUCTIONATOR_CLEAR_STACKING_PREFERENCES_BTN = "清空堆疊偏好設定"
AUCTIONATOR_CLEAR_SHOPPING_LISTS_BTN = "清空購物清單"
AUCTIONATOR_SHOPPING_LISTS_OPTION_DESCRIPTION = "按住 CTRL 鍵點擊來選擇多個購物清單"
AUCTIONATOR_SHPLIST_IMPORTSAVEBTN = "匯入購物清單"
AUCTIONATOR_SHPLIST_SAVEBTN = "儲存"
AUCTIONATOR_SHPLIST_SELECTALLBTN = "全選"
AUCTIONATOR_SHPLIST_ALREADY_EXIST = "這些購物清單已經存在:"
AUCTIONATOR_SHPLIST_OKAY = "OKAY"
AUCTIONATOR_SHPLIST_NEW_NAME_TEXT = "輸入清單的新名稱"
AUCTIONATOR_AUTOR_TEXT = "作者:  Borjamacare (US)"
AUCTIONATOR_ITEM_NAME = "物品名稱"
AUCTIONATOR_ITEM_PRICE = "物品價格"
AUCTIONATOR_CURRENT_AUCTIONS = "目前拍賣"
AUCTIONATOR_SAVE_THIS_SHPLIST = "儲存這個購物清單"
AUCTIONATOR_LOWEST_PRICE = "最低價"
AUCTIONATOR_ITEM_NAME = "物品名稱"
AUCTIONATOR_NEW = "新的"
AUCTIONATOR_IMPORT = "匯入"
AUCTIONATOR_EXPORT = "匯出"
AUCTIONATOR_ARE_YOU_SURE = "是否確定?"
AUCTIONATOR_CLEAR_IT = "清空"
AUCTIONATOR_ADD_ITEM = "新增物品"
AUCTIONATOR_REMOVE_ITEM = "移除物品"
AUCTIONATOR_SEARCH_FOR_ALL_ITEMS = "搜尋所有物品"
AUCTIONATOR_MANAGE_SHOPPING_LISTS = "管理購物清單"
AUCTIONATOR_NEW_SHOPPING_LIST = "新增購物清單"
AUCTIONATOR_NEXT_SCAN_ALLOWED = "下次允許掃描:"
AUCTIONATOR_LAST_SCAN = "最近掃描:"
AUCTIONATOR_ITEMS_IN_DB = "資料庫中的物品:"
AUCTIONATOR_START_SCANNING = "開始掃描"
AUCTIONATOR_AUCTIONS_SCANNED = "已掃描拍賣:"
AUCTIONATOR_ITEMS_ADDED = "加入物品:"
AUCTIONATOR_ITEMS_UPDATED = "更新物品:"
AUCTIONATOR_ITEMS_IGNORED = "忽略物品:"
--- End Globals

AtrL["%A, %B %d at %I:%M %p"] = "%d/%m/%Y %H:%M" -- Date and Time. Refer to https://www.lua.org/pil/22.1.html
AtrL["Level"] = "等級"
AtrL["Options..."] = "設定選項..."
AtrL["Yes, cancel them"] = "取消拍賣"
AtrL["Delete"] = "刪除"
AtrL["Rename"] = "重新命名"
AtrL["Read the FAQ at"] = "閱讀常見問題與解答 FAQ"
...
AtrL["Time:"] = "時間:"
AtrL["auctions returned empty results (out of %d)"] = "件拍賣物品傳回空的結果 (總數 %d 件)"
AtrL["auctions returned null itemLinks (out of %d)"] = "件拍賣物品傳回空的物品連結 (總數 %d 件)"
AtrL["Blizzard server failed to return all items"] = "暴雪伺服器無法正確傳回所有物品"
AtrL["Disenchant data restored. Number of entries:"] = "分解資料已經恢復，數量為:"
AtrL["No data available to be restored."] = "沒有資料可供恢復。"
AtrL["out of"] = "/"
AtrL["Page %s of %s"] = "頁面 %s/%s"
...
AtrL["Vendor"] = "商人"
-- AtrL["Version"] = "版本"
AtrL["when ALT is held down"] = "按下 Alt 鍵時"
AtrL["when CONTROL is held down"] = "按下 Ctrl 鍵時"
AtrL["When SHIFT is down show"] = "按下 Shift 鍵時顯示..."
AtrL["when SHIFT is held down"] = "按下 Shift 鍵時"
...
AtrL["If you put a lot of time into constructing detailed shopping lists, this will require you to build them all over again."] = "如果你花了很多時間在建立詳細的購物清單，那麼你將會需要重新從頭再來一次。"
...
AtrL["Shopping list overwritten:"] = "已取代購物清單："
