...
AtrL["Show auction house prices in mailbox tooltips"]  = "在郵件提示中顯示拍賣場價格"
...
AtrL["About Auctionator"]="關於拍賣小幫手 Auctionator"
AtrL["About"] = "關於"
...
AtrL["If this option is checked, holding the Alt key down while clicking an item in your bags will switch to the Auctionator panel, place the item in the Auction Item area, and start the scan."]="若勾選此選項，在背包中按下Alt並點擊物品，會自動跳至拍賣小幫手的賣出頁面、擺放物品，並查詢當前價格"
...
AtrL["Options"] = "設定"
AtrL["Other"] = "其他"
AtrL["over %d gold"] = "超過 %3d 金"
AtrL["over %d silver"] = "超過 %3d 銀"
AtrL["over 1 gold"] = "超過 %3d 銅"
AtrL["Past"] = "過去"
...
AtrL["Entry must not be blank"] = "輸入不可以空白"
...
AtrL["Starting Price"] = "競標價"
AtrL["Stop Checking"] = "停止檢查"
AtrL["Subcategory"] = "副分類"
AtrL["Swedish translation courtesy of %s"] = "瑞典翻譯: %s"
AtrL["The latest information on Auctionator can be found at"] = "拍賣小幫手的最新資訊在:<br/>"
AtrL["There is a more recent version of Auctionator: VERSION"] = "有更新的拍賣小幫手版本:"
AtrL["Today"] = "今天"
