...
Skada.windowdefaults = {
	...
	buttons = {menu = true, reset = true, report = false, mode = false, segment = false},

	title = {textcolor = {r = 0.9, g = 0.9, b = 0.9, a = 1}, height = 20, font="Accidental Presidency", fontsize=13, texture="Armory", bordercolor = {r=0,g=0,b=0,a=1}, bordertexture="None", borderthickness=2, color = {r=0.3,g=0.3,b=0.3,a=0}, fontflags = ""},
	background = {
        height=200,
        texture="Solid",
