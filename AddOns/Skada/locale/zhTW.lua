------------------------------------------------------------------------------
-- Traditional Chinese localization --by andy52005 修改 by BNS
------------------------------------------------------------------------------
...
L["Autostop"] = "自動停止"
L["Autostop description"] = "當一半以上的團員死亡時自動停止當前區段。"
L["Average hit:"] = "平均值:"
L["Background"] = "背景"
...
L["Controls the way set names are displayed."] = "控制設定名稱的顯示方式。"
...
L["Damage taken"] = "承受傷害"
L["DamageTaken"] = "承受傷害"
L["Damage taken by spell"] = "4承受法術傷害"
...
L["Report"] = "報告"
L["Report description"] = "打開一個對話框，以各種方式報告數據給他人。"
...
L["Skada will |cFFFF0000NOT|r function properly until you delete the following AddOns:"] = "Skada將|cFFFF0000不會|r正常運作直到您刪除以下插件："
...
L["Use role icons where applicable."] = "使用角色類型圖示(如果適用)"
...
L["Friendly Fire"] = "8隊友誤傷"
L["Ignore class abilities"] = "忽略職業技能"
L["Ignore damage from other class abilities, such as Unholy Frenzy"] = "忽略其他職業技能的傷害，如邪惡狂熱"
L["Ignore defensive damage"] = "忽略防禦的傷害"
L["Ignore delayed damage from defensive abilities, such as Monk Stagger"] = "忽略因防禦技能而延後的傷害，如武僧的醉仙緩勁"
L["List of damaging spells"] = "傷害法術表列"
L["List of players damaged"] = "傷害玩家列表"
L["spells"] = "法術"
L["targets"] = "目標"
L["Average"] = "平均"
L["Avoidance and mitigation"] = "閃避和減傷"
L["incoming attack breakdown"] = "受到攻擊的分類"
