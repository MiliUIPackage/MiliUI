...
L["Auras_CustomFiltering_ConditionsMode"] = "Bedinungsmodus"
L["Auras_CustomFiltering_ConditionsMode_Desc"] = [=[Hier kannst du auswählen wie die ausgewählten Bedinungen miteinander verknüpft werden sollen. 
Wenn du "Irgendeine" auswählst, wird die Aura angezeigt sobald eine deiner ausgewählten Bedingungen erfüllt ist.
Wenn du "Alle" auswählst, wird die Aura nur angezeigt sobald alle ausgewählten Bedingen von der Aura erfüllt werden.]=]
