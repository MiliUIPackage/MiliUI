  ...
  local options = {
    ...
    args = {
      ...
      SetupConfig = {
        ...
        func = function()
          Exlist.SetupConfig()
          C_Timer.After(0.1, function() InterfaceOptionsFrame_Show() InterfaceOptionsFrame_Show() InterfaceOptionsFrame_OpenToCategory(L["World Quests"]) InterfaceOptionsFrame_OpenToCategory(L[name]) end)
