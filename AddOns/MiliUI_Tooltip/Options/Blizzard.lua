...
header:SetText("|cff4DD2FF" .. L["MiliUI Tooltip"] .. "|r")
...
instructions:SetText("|cffffffff" .. L["Use /mtip to open options"] .. "|r")
...
local category = Settings.RegisterCanvasLayoutCategory(panel, L["MiliUI Tooltip"])
category.ID = L["MiliUI Tooltip"]
