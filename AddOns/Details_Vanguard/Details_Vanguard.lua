	...
	if (event == "ADDON_LOADED") then
		...
		if (AddonName == "Details_Vanguard") then
			...
			if (_G._detalhes) then
				...
				local install, saveddata = _G._detalhes:InstallPlugin ("TANK", Loc ["Vanguard"], "Interface\\Icons\\INV_Shield_04", Vanguard, "DETAILS_PLUGIN_VANGUARD", MINIMAL_DETAILS_VERSION_REQUIRED, "Terciob", "v3.0", default_saved_table)
