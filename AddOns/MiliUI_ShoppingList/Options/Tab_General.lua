...
local CONTROLS = {
    ...
    { type = "text", label = L["Count the bank, the reagent bank and the warband bank as things you already have"] },
    ...
    { type = "text", label = L["Hide the reagents you already have enough of"] },
    { type = "toggle", key = "hideVendor", label = L["Hide what a vendor sells"] },
    { type = "text", label = L["Leave out reagents you can just buy from a merchant"] },
    ...
    { type = "text", label = L["Add recipes you track in the profession window to this list"] },
    ...
    { type = "text", label = L["Bring the list up beside the auction house window"] },
    { type = "toggle", key = "ahAutoSearch", label = L["Search on opening"] },
    { type = "text", label = L["Ask for prices on the whole list as soon as the list comes up"] },
    { type = "toggle", key = "confirmBuys", label = L["Ask me before buying"] },
    { type = "text", label = L["Show the price and wait for a click before any gold leaves your bags"] },
