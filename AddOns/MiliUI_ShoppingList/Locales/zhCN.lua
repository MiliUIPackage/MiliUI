...
L["Nothing here yet. Open a profession window or a crafting order and press \"Add to one-click buy list\"."] = "清单还是空的。打开专业窗口或制作订单，按「加入一键购买清单」。"
...
-- 製作頁與訂單頁的按鈕
L["Add to one-click buy list"] = "加入一键购买清单"
...
L["Recraft: %s"] = "重铸：%s"
L["Adds this recraft to the shopping list."] = "把这次重铸加进采购清单。"
L["Reagents the item already carries (sparks, embellishments) are left out."] = "装备身上原本就有的附加材料（火花、装饰等）不会算进去。"
