...
function DriftHelpers:SetupConfig()
    ...
    local objectivesTitle = " 任務追蹤清單"
    local objectivesDesc = "是否需要移動或縮放遊戲內建的任務追蹤清單。注意: 使用任務追蹤清單增強插件時請不要啟用此選項。"
    if (isClassic or isBCC) then
        objectivesTitle = " 任務追蹤清單"
        objectivesDesc = "是否需要移動或縮放遊戲內建的任務追蹤清單。注意: 使用任務追蹤清單增強插件時請不要啟用此選項。"
    end
