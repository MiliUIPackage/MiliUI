		...
		if LeaPlusLC["RestoreChatMessages"] == "On" and not LeaLockList["RestoreChatMessages"] then
			...
			historyFrame:SetScript("OnEvent", function(self, event)
				if event == "PLAYER_LOGOUT" then
					...
					if not realm then realm = "" end -- 暫時修正
	...
	local function eventHandler(self, event, arg1, arg2, ...)
		...
		if event == "ADDON_LOADED" then
			if arg1 == "Leatrix_Plus" then
				...
				LeaPlusLC:LoadVarChk("AutoSellJunk", "On")					-- Sell junk automatically
				...
				LeaPlusLC:LoadVarChk("AutoRepairGear", "On")				-- Repair automatically
				...
				-- Chat
				LeaPlusLC:LoadVarChk("UseEasyChatResizing", "On")			-- Use easy resizing
				...
				LeaPlusLC:LoadVarNum("LeaPlusQuestFontSize", 15, 10, 36)	-- Quest text slider
				...
				LeaPlusLC:LoadVarChk("CombineAddonButtons", "On")			-- Combine addon buttons
				...
				LeaPlusLC:LoadVarChk("TipBackSimple", "On")				-- Color backdrops
				...
				LeaPlusLC:LoadVarChk("TipNoHealthBar", "On")				-- Hide health bar
				LeaPlusLC:LoadVarNum("LeaPlusTipSize", 1.30, 0.50, 2.00)	-- Tooltip scale slider
