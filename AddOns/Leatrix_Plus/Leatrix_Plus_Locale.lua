...
L["If checked, minimap buttons for addons will be collected and placed in a frame which you can toggle by right-clicking the minimap.|n|nThis setting will help you declutter the minimap without the need to install a separate addon just to do that."] = "如果选中，插件的小地图按钮将被收集并放置在一个弹窗中，您可以通过右键单击小地图来切换该框架。这个设置将帮助您清理小地图, 而无需为此安装单独的插件。"
...
L["If checked, minimap buttons for addons will be collected and placed in a frame which you can toggle by right-clicking the minimap.|n|nThis setting will help you declutter the minimap without the need to install a separate addon just to do that."] = "勾選後，插件的小地圖按鈕會被收集並放置在一個框架中，你可以透過右鍵點擊小地圖來切換。n|n這個設定能幫助你清理小地圖，而不需要另外安裝插件。"
