...
L["Eversong Woods"] = "永歌森林"
L["Exclude all grey armor and weapons"] = "排除所有灰色盔甲和武器"
...
L["Exclude uncollected grey armor and weapons"] = "排除未收藏的灰色盔甲和武器"
...
L["If checked, grey armor and weapons that you have not collected the appearance from will not be sold.|n|nUse this setting if you plan to collect transmog appearances from grey armor and weapons."] = "勾選後，不會出售您尚未收集外觀的灰色盔甲和武器。|n|n如果您計劃從灰色盔甲和武器中收集塑形外觀，請使用此設置。"
L["If checked, grey armor and weapons will not be sold.|n|nUse this setting if you plan to sell grey armor and weapons in the auction house."] = "勾選後，不會出售灰色盔甲和武器。|n|n如果您打算在拍賣場出售灰色盔甲和武器，請使用此設置。"
