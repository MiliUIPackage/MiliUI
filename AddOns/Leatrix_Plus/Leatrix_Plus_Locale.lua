...
if LeaPlusDB and LeaPlusDB.UseEnglishLanguage and LeaPlusDB.UseEnglishLanguage == "On" then return end
...
L["Drag to set the square minimap border width."] = "拖动设定正方形小地图的边框宽度。"
...
L["Eversong Woods (Midnight)"] = "永歌森林（至暗之夜）"
...
L["Exclude Battle for Gilneas"] = "排除吉尔尼斯之战"
...
L["Exclude Isle of Conquest"] = "排除征服之岛"
L["Exclude Keeper Ta'hult's pet items"] = "排除饲养者塔·希尔特的宠物物品"
L["Exclude Silvershard Mines"] = "排除碎银矿脉"
L["Exclude Temple of Kotmogu"] = "排除寇魔古寺"
...
L["Great Sea (Dragon Isles)"] = "无尽之海（巨龙群岛）"
L["Great Sea (Khaz Algar)"] = "无尽之海（卡兹阿加）"
L["Grim Batol"] = "格瑞姆巴托"
...
L["If checked, a bag search box will be shown in the backpack frame."] = "如果选中此项，背包界面上将显示一个物品搜索框"
...
L["If checked, a power bar will be shown in the player frame when you are playing a shapeshifted druid."] = "勾选后，对于变形后的德鲁伊，在玩家头像下方显示法力条。"
...
L["If checked, status text will be shown in the druid power bar as long as status text is enabled in the game settings interface display panel."] = "如果选中此项，只要在游戏设置界面显示面板中启用状态文本，状态文本就会显示在德鲁伊法力条上。"
...
L["If checked, text used throughout the addon will be shown in English regardless of your game locale."] = "如果选中此项，整个插件中使用的文本将以英语显示，与您的游戏地区设置无关。"
...
L["If checked, the mount special animation checkbox will be unchecked by default."] = "勾选后，坐骑特殊动作（/mountspecial）的独立开关将默认关闭，以简化界面操作。"
...
L["If checked, the vendor price will be shown in item tooltips that the default UI does not cover.|n|nThis includes quest reward tooltips, equipped gear tooltips and tooltips for items linked in chat."] = "如果选中此项，将在默认界面未覆盖的物品鼠标提示框中显示商人售价。|n|n此功能包括：任务奖励物品鼠标提示、已装备物品的鼠标提示框，以及聊天窗口中链接物品的鼠标提示框。"
...
L["If checked, traveling merchant greetings and farewells will be muted.|n|nThis applies to Traveler's Tundra Mammoth and Grand Expedition Yak."] = "如果选中此项，将​​屏蔽坐骑上旅行商人的问候与告别语音​​。|n|n此功能适用于​​旅行者的苔原猛犸象​​与​​雄壮远足牦牛​​坐骑。"
...
L["If checked, you will not release automatically in Battle for Gilneas."] = "如果选中此项，你将不会在吉尔尼斯之战中自动释放尸体。"
L["If checked, you will not release automatically in Isle of Conquest."] = "如果选中此项，你将不会在征服之岛中自动释放尸体。"
L["If checked, you will not release automatically in Silvershard Mines."] = "如果选中此项，你将不会在碎银矿脉中自动释放尸体。"
L["If checked, you will not release automatically in Temple of Kotmogu."] = "如果选中此项，你将不会在寇魔古寺中自动释放尸体。"
...
L["Isle of Quel'Danas (Midnight)"] = "奎尔丹纳斯岛（至暗之夜）"
...
L["Midnight"] = "至暗之夜"
L["Minimap"] = "小地图"
L["MinimapButtonButton"] = "MBB小地图按钮组件"
L["Mining"] = "采矿"
L["Misc"] = "杂项"
...
L["Show druid power bar"] = "显示德鲁伊法力条"
L["Show druid power bar status text"] = "显示德鲁伊法力条状态文本"
...
L["Uncheck mount special animation checkbox"] = "取消坐骑特殊动作的独立开关"
...
L["A Matter of Time"] = "時間問題"
L["A New Life for Undeath"] = "不死族的新生"
L["A Shadowy Invitation"] = "暗影的邀請"
...
L["Automation"] = "自動化"
L["Available button names"] = "可用按鈕名稱"
L["Azj-Kahet"] = "阿茲-卡罕特"
L["Azjol-Nerub"] = "阿茲歐奈幽"
L["Azshara"] = "艾薩拉"
...
L["Cannot be used with Minimap button bag."] = "不能搭配Minimap button bag一起使用。"
...
L["Drag to set the square minimap border width."] = "拖曳以設定方形小地圖邊框寬度。"
...
L["If checked, Dundun (Loa of Abundance) will be quieter."] = "勾選後，敦敦(豐足羅亞)將被靜音。"
...
L["If checked, Loa Speaker Nanea (Devout of Nalorakk) will be quieter."] = "勾選後，羅亞語者娜妮 (納羅拉克虔信者) 將被靜音。"
...
L["If checked, minimap buttons for addons will be collected and placed in a bag which you can toggle by right-clicking the minimap.|n|nThis setting will help you declutter the minimap without the need to install a separate addon to do that."] = "勾選後，插件的小地圖按鈕會被收集並放入一個袋子裡，你可以透過右鍵點擊小地圖來切換。|n|n這個設定能幫助你清理小地圖，而不需要安裝額外的插件。"
...
L["If checked, the A Cultivator's Colors transform will be removed when applied."] = "勾選後，栽培者的制服（草藥學）專業裝備塑形將在生效時被自動移除。"
L["If checked, the A Looker's Charm transform will be removed when applied."] = "勾選後，美人的護符（附魔）專業裝備塑形將在生效時被自動移除。"
...
L["If checked, the An Eye For Shine transform will be removed when applied."] = "勾選後，閃耀之眼（珠寶加工）專業裝備塑形將在生效時被自動移除。"
...
L["If checked, the Artist's Duds transform will be removed when applied."] = "勾選後，藝術家的舊衣服（銘文）專業裝備塑形將在生效時被自動移除。"
L["If checked, the Atomic Recalibrator transform will be removed when applied."] = "勾選後，原子校準器的變換外型將在生效後移除。"
L["If checked, the Atomic Regoblinator transform will be removed when applied."] = "勾選後，原子重校器玩具的變形外觀將在生效後被自動移除。"
...
L["If checked, the Dressed To Kill transform will be removed when applied."] = "勾選後，屠戮裝束（剝皮）專業裝備塑形將在生效時被自動移除。"
...
L["If checked, the Fishing For Attention transform will be removed when applied."] = "勾選後，釣取關注（釣魚）專業裝備塑形將在生效時被自動移除。"
...
L["If checked, the Ready To Build transform will be removed when applied."] = "勾選後，工業級展示（工程學）專業裝備塑形將在生效時被自動移除。"
...
L["If checked, the Rockin' Mining Gear transform will be removed when applied."] = "勾選後，滾石礦工裝備（採礦）專業裝備塑形將在生效時被自動移除。"
...
L["If checked, the Sculpting Leather Finery transform will be removed when applied."] = "勾選後，正在塑造皮革服飾（製皮）專業裝備塑形將在生效時被自動移除。"
...
L["If checked, the Spark of Madness transform will be removed when applied."] = "勾選後，瘋狂火花（煉金術）專業裝備塑形將在生效時被自動移除。"
...
L["If checked, the Suited for Smithing transform will be removed when applied."] = "勾選後，穿戴用於鍛造的裝備（鍛造）專業裝備塑形將在生效時被自動移除。"
...
L["If checked, the What's Cookin', Good Lookin' transform will be removed when applied."] = "勾選後，（烹飪）專業裝備幻化將在生效時被自動移除。"
...
L["If checked, the Wrapped Up In Weaving transform will be removed when applied."] = "勾選後，沉浸於編織當中（裁縫）專業裝備塑形將在生效時被自動移除。"
...
L["If checked, Valeera (Midnight) will be quieter."] = "勾選後，瓦麗拉 (至暗之夜) 將被靜音。"
...
L["Iridikron and Vyranoth"] = "伊瑞迪柯隆與維蘭諾斯"
L["Iron Docks"] = "鋼鐵碼頭"
L["Ironforge"] = "鐵爐堡"
...
L["Isle of Quel'Danas (Midnight)"] = "奎爾達納斯之島 (至暗之夜)"
...
L["Midnight"] = "至暗之夜"
L["Minimap"] = "小地圖"
L["Minimap button bag"] = "小地圖按鈕袋"
L["MinimapButtonButton"] = "小地圖圖示按鈕"
L["Mining"] = "採礦"
L["Misc"] = "雜項"
...
L["Not completed."] = "未完成。"
L["Not minimap"] = "非小地圖"
L["Note that during instanced combat encounters, cooldown icons will not show and any active timers will be reset."] = "請注意，在副本遭遇戰中，冷卻圖示不會顯示，且所有有效的計時器都會被重置。"
...
L["Robbles Wobbly Staff"] = "羅布爾的鬆動法杖"
L["Rockets"] = "火箭"
L["Rookery"] = "培育所"
...
L["Show druid power bar status text"] = "顯示德魯伊能量條狀態文字"
...
L["Silithus"] = "希利蘇斯"
L["Silvermoon City (Midnight)"] = "銀月城 (至暗之夜)"
...
L["This is a list of available addon button names.  You can use this list to copy and paste button names that you want into the editor.|n|nThis listing is automatically generated and cannot be edited."] = "這是一份可用的插件按鈕名稱列表。你可以用這個清單複製並貼上你想要的按鈕名稱到編輯器中。|n|n 此列表為自動生成，無法編輯。"
L["This option is not currently available."] = "目前此選項尚不可用。"
L["This panel will close automatically if you enter combat."] = "此面板將在你進入戰鬥後自動關閉。"
L["This setting does not apply during instanced combat encounters."] = "此設定在副本遭遇戰中不適用。"
