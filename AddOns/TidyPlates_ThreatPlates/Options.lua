...
local function SetCVarTPTP(info, value)
  if InCombatLockdown() then
    t.Print(L["We're unable to change this while in combat"], true)
  else
      ...
      Clickarea = {
        ...
        args = {
          ...
          ShowArea = {
            ...
            type = "execute",
            order = 40,
            desc = L["Toggle a background showing the area of the clicable area."],
            func = function()
    ...
    args = {
      ...
      Appearance = {
        ...
        args = {
          ...
          HeaderGlow = { type = "header", order = 30, name = L["Highlight Glow"], },
          --          EnableGlow = {
          --            name = L["Glow"],
          --            type = "toggle",
          --            order = 41,
          ...
          HeaderThreat = { type = "header", order = 40, name = L["Threat Options"], },
          ThreatGlow = {
            name = L["Threat Glow"],
            order = 41,
            type = "toggle",
...
local function CreateCustomNameplatesGroup()
  ...
  for index, custom_style in pairs(db.uniqueSettings) do
    if type(index) == "number" and custom_style.Trigger and custom_style.Trigger.Name.Input ~= "<Enter name here>"  then -- 暫時修正
                ...
                Texture = {
                  ...
                  args = {
                    Style = {
                      ...
                      order = 10,
                      name = L["Icon Style"],
                      values = { default = L["Default"], stddragon = L["Blizzard Dragon"], skullandcross = L["Skull and Crossbones"] },
                      set = function(info, val)
                        SetThemeValue(info, val)
...
--            },
  ...
  local ClassOpts = {
    Style = {
      ...
      values = { default = L["Default"], transparent = L["Transparent"], crest = L["Crest"], clean = L["Clean"] },
      arg = { "classWidget", "theme" },
    },
  };
  for k_c, v_c in pairs(CLASS_SORT_ORDER) do
    ClassOpts["Prev" .. k_c] = {
      name = L[CLASS_SORT_ORDER[k_c]],
      type = "execute",
