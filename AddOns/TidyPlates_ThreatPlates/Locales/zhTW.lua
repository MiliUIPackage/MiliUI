...
L["Alternatively, you can also find us on the |cffffff78WoWUIDev Discord|r"] = "此外，還可以在 |cffffff78WoWUIDev Discord|r 找到我們。"
L["Always"] = "總是"
...
L["How do I change the Bartender4 Keybindings?"] = "如何更改 Bartender4 的按鍵綁定?"
L["Icon"] = "圖示"
L["Icon Height"] = "圖示高度"
L["Icon Mode"] = "圖示模式"
L["Icon Style"] = "圖示風格"
...
L["Interruptable"] = "可打斷"
L["Interrupted"] = "已打斷"
L["I've found a bug! Where do I report it?"] = "我遇到了 bug! 該到哪回報?"
L["Kinetic Bomb"] = "動能炸彈"
L["Label"] = "標籤文字"
...
L["On Target"] = "當前目標"
L["On the left"] = "左側"
L["Once open, simply hover the button you want to bind, and press the key you want to be bound to that button. The keyBound tooltip and on-screen status will inform you about already existing bindings to that button, and the success of your binding attempt."] = "打開後，只要用滑鼠指向你想要設定的按鈕，然後按下要綁定的鍵盤按鍵即可。按鍵綁定的滑鼠提示和畫面上的狀態都會告訴你該按鈕原本綁定的按鍵，以及新的按鍵設定成功。"
L["One"] = "一"
...
L["You can either click the KeyBound button in the options, or use the |cffffff78/kb|r chat command to open the keyBound control. Alternatively, you can also use the Blizzard Keybinding Interface."] = "按下選項中的按鍵綁定按鈕，或是輸入 |cffffff78/kb|r 都可以打開按鍵綁定控制面板。或者也可以使用遊戲內建的按鍵綁定介面。"
L["You can report bugs or give suggestions on the project page at |cffffff78https://www.wowace.com/projects/bartender4|r or on GitHub at |cffffff78https://github.com/Nevcairiel/Bartender4|r"] = "可以在專案頁面回報 bug 或提供建議，網址為 |cffffff78https://www.wowace.com/projects/bartender4|r 或在 GitHub |cffffff78https://github.com/Nevcairiel/Bartender4|r"
...
-- 自行加入
L["Please select a target unit to enable configuration mode."] = "請選擇一個目標來啟用設定模式。"
L["Low Color"] = "低血量顏色"
L["High Color"] = "高血量顏色"
L["Thin"] = "細"
L["By Class"] = "職業"
...
L["NPC Role"] = "NPC角色"
L["NPC Role, Guild"] = "NPC角色, 公會"
L["NPC Role, Guild, or Level"] = "NPC角色, 公會或等級"
L["Level"] = "等級"
L["Everything"] = "全部"
L["Classic"] = "經典"
L["Smooth"] = "平順"
L["Target and No Target"] = "目標和沒有目標"
L["Friendly & Neutral Units"] = "友方 & 中立單位"
L["Neutral Units & Minions & By Status"] = "中立單位 & 小怪 & 狀態"
L["Bar Style"] = "線條風格"
L["Display Locations"] = "顯示位置"
L["Show Aura Type"] = "顯示光環類型"
L["Buff"] = "增益效果"
L["Curse"] = "詛咒"
L["Disease"] = "疾病"
L["Magic"] = "魔法"
...
L["Normal"] = "普通"
L["Special"] = "特別"
L["Threat Options"] = "仇恨值選項"
L["Tidy Plates: Threat Plates"] = "血條"
L["Threat Plates"] = "血條"
L["m"] = "分"
L["World Boss"] = "世界首領"
L["Level "] = "等級 "
...
L[" (Rare)"] = " (稀有)"
L[" (Elite)"] = " (精英)"
L["No Automation"] = "不要自動顯示/隱藏"
L["Show during Combat, Hide when Combat ends"] = "戰鬥開始時顯示，戰鬥結束後隱藏"
L["Hide when Combat starts, Show when Combat ends"] = "戰鬥開始時隱藏，戰鬥結束後顯示"
L["Spell Coloring"] = "法術顏色"
L["Alignment"] = "對齊"
L["Changing these options may interfere with other nameplate addons or Blizzard default nameplates as console variables (CVars) are changed."] = "更改這些選項可能會影響其他血條插件或遊戲內建的名條，讓使用到遊戲控制參數 (CVars) 的設定一併變更。**調整前請先關閉 '血條距離微調' 插件**"
L["Movement Model"] = "血條排列類型"
L["Vertical Overlap"] = "垂直重疊/間距"
L["Thin Square"] = "細方框"
L["Skull and Crossbones"] = "骷髏和骨頭"
L["Auras"] = "光環"
L["Enable Auras Widget"] = "啟用光環套件"
L["Frame Order"] = "框架順序"
L["Healthbar, Auras"] = "血條, 光環"
...
L["Enable Fade-In"] = "啟用淡出"
L["Blizzard Dragon"] = "暴雪龍頭"
L["Show Unlimited Buffs"] = "顯示沒有時間限制的增益"
