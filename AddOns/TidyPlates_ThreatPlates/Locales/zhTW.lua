...
L["DPS switch detected, you are now in your |cffff0000dpsing / healing|r role."] = "偵測到切換成 DPS，現在是 |cffff0000輸出 / 治療|r 角色。"
L["No profile specified"] = "沒有指定設定檔"
L["Role toggle not supported because automatic role detection is enabled."] = "不支援切換角色，因為已經啟用自動偵測角色。"
L["Tank switch detected, you are now in your |cff00ff00tanking|r role."] = "偵測到切換成坦克，現在是 |cffff0000坦克|r 角色。"
L["Unknown profile: "] = "未知的設定檔: "
