...
L.ADDON_DESCRIPTION = "適用於《魔獸世界：至暗之夜》銀月城的 HandyNotes 插件。"
...
L.NODE_TIMEWAYS_TITLE = "時間之道"
L.NODE_TIMEWAYS_DESC = "進入時光漫遊戰役。"
L.NPC_LINDORMI = "林多米"

L.NODE_DELVERS_TITLE = "探究者總部"
L.NODE_DELVERS_DESC = "探究進度與豐碩探究。"
L.NPC_VALEERA_ASTRANDIS = "瓦麗拉‧桑古納爾與傳送師艾司川迪斯"
...
L.NPC_CONSORTIUM_CLERK = "工匠聯盟職員"

L.NODE_PROFESSIONS_AREA_TITLE = "專業技能區域"
L.NODE_PROFESSIONS_AREA_DESC = "學習並操練您的專業技能。"
