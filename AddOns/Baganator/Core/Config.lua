...
addonTable.Config.Defaults = {
  ...
  [addonTable.Config.Options.ICON_TOP_LEFT_CORNER_ARRAY] = {"item_level", "battle_pet_level", "keystone_level"},
  [addonTable.Config.Options.ICON_TOP_RIGHT_CORNER_ARRAY] = {"junk"},
  [addonTable.Config.Options.ICON_BOTTOM_LEFT_CORNER_ARRAY] = {"equipment_set", "appearancetooltip", "can_i_mog_it"},
  [addonTable.Config.Options.ICON_BOTTOM_RIGHT_CORNER_ARRAY] = {"quantity", "boa", "boe", "bou"},
