...
local settings = {
  ...
  ICON_TOP_LEFT_CORNER_ARRAY = {key = "icon_top_left_corner_array", default = {"item_level", "battle_pet_level", "keystone_level"}, refresh = {Refresh.ItemTextures, Refresh.ItemWidgets}},
  ICON_TOP_RIGHT_CORNER_ARRAY = {key = "icon_top_right_corner_array", default = {"junk"}, refresh = {Refresh.ItemTextures, Refresh.ItemWidgets}},
  ICON_BOTTOM_LEFT_CORNER_ARRAY = {key = "icon_bottom_left_corner_array", default = {"equipment_set", "appearancetooltip", "can_i_mog_it"}, refresh = {Refresh.ItemTextures, Refresh.ItemWidgets}},
  ICON_BOTTOM_RIGHT_CORNER_ARRAY = {key = "icon_bottom_right_corner_array", default = {"quantity", "boa", "boe", "bou"}, refresh = {Refresh.ItemTextures, Refresh.ItemWidgets}},
