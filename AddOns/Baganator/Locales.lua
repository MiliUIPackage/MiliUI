...
L["ADD"] = "添加"
L["ADD_FROM_ATT"] = "添加来自ATT"
L["ADD_FROM_ATT_MESSAGE"] = "使用 “All The Things ”弹出式迷你窗口中的物品添加到此分类中。"
L["ADD_FROM_ATT_POPUP_COMPLETE"] = "已添加 %s 物品（来自 %s 弹出窗口）"
L["ADD_ITEM"] = "添加物品"
