...
mod:SetRevision("20231024092123")
...
local timerTeethCD				= mod:NewCDCountTimer(26.7, 255434, nil, "Tank|Healer", nil, 5, nil, DBM_COMMON_L.TANK_ICON)--actual minimum timer not known
...
function mod:OnCombatStart(delay)
	...
	timerFearCD:Start(12.4-delay, 1)
